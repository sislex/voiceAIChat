...
прошлую неудачную правку (в промпте ещё и «Попытка N из M»). Хвост лога упавшего
шага — 2000 символов, а для шага-проверки 20 000 (`CiFixContext.isTestStep`,
`tryFix` берёт и строк лога больше): по сводке vitest причину не найти.
