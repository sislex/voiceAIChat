...
сервера; compose по умолчанию отправляет и Claude, и Codex в `runner-work`, а
`runner-personal` поднимается отдельным сервисом для личной авторизации и будущей
регистрации в UI. Новый код пока даёт админу только хранение, редактирование и
проверку доступности runner'ов.
