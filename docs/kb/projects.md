...
Сессии живут в памяти процесса: после перезапуска сервера панель показывает «остановлен»,
а сам dev-сервер на машине остаётся сиротой — это известная граница.
