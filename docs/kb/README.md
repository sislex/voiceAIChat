...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-29 | ⚠ 28 коммит(ов) в areas после сверки: dd1d2282 Merge remote-tracking branch 'origin/main' into work3 … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 864 коммит(ов) в areas после сверки: dd1d2282 Merge remote-tracking branch 'origin/main' into work3 … |
