...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-29 | ⚠ 10 коммит(ов) в areas после сверки: aba0df3c fix(protocol): технические коды ошибок переводятся один раз в транспорте … |
