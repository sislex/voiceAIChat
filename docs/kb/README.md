...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-19 | ⚠ 8 коммит(ов) в areas после сверки: 00ce915f fix(ui): preserve context settings subroutes … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 465 коммит(ов) в areas после сверки: 74f3c476 docs(kb): update after merge df2d5ecb-c5d5-4629-835c-754924f4ed62 … |
