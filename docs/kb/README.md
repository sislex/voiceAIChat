...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 151 коммит(ов) в areas после сверки: d2c36a8c fix(kanban): фильтры доски видно как элементы управления, цвета — на токенах … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 781 коммит(ов) в areas после сверки: d2c36a8c fix(kanban): фильтры доски видно как элементы управления, цвета — на токенах … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-20 | ⚠ 196 коммит(ов) в areas после сверки: d2c36a8c fix(kanban): фильтры доски видно как элементы управления, цвета — на токенах … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-28 | ⚠ 49 коммит(ов) в areas после сверки: d2c36a8c fix(kanban): фильтры доски видно как элементы управления, цвета — на токенах … |
