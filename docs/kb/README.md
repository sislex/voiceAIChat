...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-20 | ⚠ 121 коммит(ов) в areas после сверки: b865b51c feat(machines): уровень доступа участников к машине проекта — полный или только чтение (roadmap п.18) … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-28 | ⚠ 10 коммит(ов) в areas после сверки: b865b51c feat(machines): уровень доступа участников к машине проекта — полный или только чтение (roadmap п.18) … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 132 коммит(ов) в areas после сверки: 75c83ced feat(chat): finalize queued composer controls … |
| [features/feature-preview.md](features/feature-preview.md) | Feature-preview окружения задач | 2026-08-28 | ✓ |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 12 коммит(ов) в areas после сверки: b865b51c feat(machines): уровень доступа участников к машине проекта — полный или только чтение (roadmap п.18) … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 766 коммит(ов) в areas после сверки: 3a29bbe3 docs(kb): update after merge a1938c88-5bf9-41a3-be5b-844f54b20d83 … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-20 | ⚠ 185 коммит(ов) в areas после сверки: 75c83ced feat(chat): finalize queued composer controls … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-28 | ⚠ 30 коммит(ов) в areas после сверки: 75c83ced feat(chat): finalize queued composer controls … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-28 | ⚠ 7 коммит(ов) в areas после сверки: b865b51c feat(machines): уровень доступа участников к машине проекта — полный или только чтение (roadmap п.18) … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-28 | ⚠ 10 коммит(ов) в areas после сверки: 75c83ced feat(chat): finalize queued composer controls … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-27 | ⚠ 21 коммит(ов) в areas после сверки: 75c83ced feat(chat): finalize queued composer controls … |
...
| [stt-runner.md](stt-runner.md) | STT Runner: внутренний протокол, ресурсы и lifecycle | 2026-08-20 | ⚠ 71 коммит(ов) в areas после сверки: b865b51c feat(machines): уровень доступа участников к машине проекта — полный или только чтение (roadmap п.18) … |
