...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-08-19 | ⚠ 36 коммит(ов) в areas после сверки: ef300a9e fix(ui): keep web reader MCP host binding stable … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-24 | ⚠ 8 коммит(ов) в areas после сверки: ef300a9e fix(ui): keep web reader MCP host binding stable … |
...
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-08-19 | ⚠ 45 коммит(ов) в areas после сверки: ef300a9e fix(ui): keep web reader MCP host binding stable … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 574 коммит(ов) в areas после сверки: ef300a9e fix(ui): keep web reader MCP host binding stable … |
...
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-23 | ⚠ 33 коммит(ов) в areas после сверки: ef300a9e fix(ui): keep web reader MCP host binding stable … |
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-08-24 | ⚠ 7 коммит(ов) в areas после сверки: ef300a9e fix(ui): keep web reader MCP host binding stable … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-24 | ⚠ 9 коммит(ов) в areas после сверки: ef300a9e fix(ui): keep web reader MCP host binding stable … |
| [operations-app.md](operations-app.md) | Frontend-модуль Operations: граница, store и подключение | 2026-08-19 | ⚠ 23 коммит(ов) в areas после сверки: ef300a9e fix(ui): keep web reader MCP host binding stable … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-24 | ⚠ 8 коммит(ов) в areas после сверки: ef300a9e fix(ui): keep web reader MCP host binding stable … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-24 | ⚠ 1 коммит(ов) в areas после сверки: ef300a9e fix(ui): keep web reader MCP host binding stable |
