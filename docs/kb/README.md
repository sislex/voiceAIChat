...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-09 | ⚠ 35 коммит(ов) в areas после сверки: 26e7c040 feat(kanban): expose active filter chips … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1361 коммит(ов) в areas после сверки: 101b281e Expose active Kanban filter chips (#146) … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-11 | ⚠ 3 коммит(ов) в areas после сверки: 101b281e Expose active Kanban filter chips (#146) … |
