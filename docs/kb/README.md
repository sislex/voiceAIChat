...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-06 | ⚠ 12 коммит(ов) в areas после сверки: 1ee40df fix: authorize same-origin web preview … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 130 коммит(ов) в areas после сверки: a78b06a chatai-138: работа CI-рана … |
...
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-08 | ⚠ 3 коммит(ов) в areas после сверки: 1ee40df fix: authorize same-origin web preview … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-08 | ⚠ 3 коммит(ов) в areas после сверки: 1ee40df fix: authorize same-origin web preview … |
