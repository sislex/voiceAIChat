...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-01 | ⚠ 6 коммит(ов) в areas после сверки: 06abc2a fix(server): обратные кавычки в SQL-комментарии рвали шаблонный литерал схемы … |
...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-01 | ⚠ 16 коммит(ов) в areas после сверки: 06abc2a fix(server): обратные кавычки в SQL-комментарии рвали шаблонный литерал схемы … |
| [features/llm-runners.md](features/llm-runners.md) | Исполнители LLM: контейнеры с claude/codex CLI | 2026-08-02 | ✓ |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-01 | ⚠ 44 коммит(ов) в areas после сверки: 2141347 feat(server): гейт чтения файлов в remote-bash и отдельный счётчик отказов … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-01 | ⚠ 12 коммит(ов) в areas после сверки: 06abc2a fix(server): обратные кавычки в SQL-комментарии рвали шаблонный литерал схемы … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-02 | ✓ |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-01 | ⚠ 22 коммит(ов) в areas после сверки: 06abc2a fix(server): обратные кавычки в SQL-комментарии рвали шаблонный литерал схемы … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-02 | ⚠ 1 коммит(ов) в areas после сверки: 2141347 feat(server): гейт чтения файлов в remote-bash и отдельный счётчик отказов |
