...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-19 | ⚠ 3 коммит(ов) в areas после сверки: 4b6fa2c0 test: enforce modular frontend quality gates … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 452 коммит(ов) в areas после сверки: 4b6fa2c0 test: enforce modular frontend quality gates … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-18 | ⚠ 9 коммит(ов) в areas после сверки: 4b6fa2c0 test: enforce modular frontend quality gates … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-19 | ⚠ 1 коммит(ов) в areas после сверки: 4b6fa2c0 test: enforce modular frontend quality gates |
