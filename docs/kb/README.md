...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-09-09 | ⚠ 6 коммит(ов) в areas после сверки: 48012c1e fix(playwright-reader): сохранить параметры действий модели и загрузку файлов … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-09-09 | ⚠ 2 коммит(ов) в areas после сверки: 48012c1e fix(playwright-reader): сохранить параметры действий модели и загрузку файлов … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1293 коммит(ов) в areas после сверки: 48012c1e fix(playwright-reader): сохранить параметры действий модели и загрузку файлов … |
...
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 299 коммит(ов) в areas после сверки: 48012c1e fix(playwright-reader): сохранить параметры действий модели и загрузку файлов … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-08 | ⚠ 10 коммит(ов) в areas после сверки: 48012c1e fix(playwright-reader): сохранить параметры действий модели и загрузку файлов … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-09 | ⚠ 4 коммит(ов) в areas после сверки: 48012c1e fix(playwright-reader): сохранить параметры действий модели и загрузку файлов … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-09-09 | ⚠ 5 коммит(ов) в areas после сверки: 48012c1e fix(playwright-reader): сохранить параметры действий модели и загрузку файлов … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-09-09 | ⚠ 8 коммит(ов) в areas после сверки: 48012c1e fix(playwright-reader): сохранить параметры действий модели и загрузку файлов … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-09-09 | ⚠ 7 коммит(ов) в areas после сверки: 48012c1e fix(playwright-reader): сохранить параметры действий модели и загрузку файлов … |
...
| [testing-operations.md](testing-operations.md) | Разработка, тестирование, диагностика и эксплуатация | 2026-09-09 | ⚠ 5 коммит(ов) в areas после сверки: 48012c1e fix(playwright-reader): сохранить параметры действий модели и загрузку файлов … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-10 | ⚠ 2 коммит(ов) в areas после сверки: 48012c1e fix(playwright-reader): сохранить параметры действий модели и загрузку файлов … |
