...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-20 | ⚠ 291 коммит(ов) в areas после сверки: c310aba9 test(db): карантин тестов менеджеров на Postgres пройден; замок переходов задачи и подписки сессии до ожидания базы … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-06 | ⚠ 41 коммит(ов) в areas после сверки: c310aba9 test(db): карантин тестов менеджеров на Postgres пройден; замок переходов задачи и подписки сессии до ожидания базы … |
...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 100 коммит(ов) в areas после сверки: c310aba9 test(db): карантин тестов менеджеров на Postgres пройден; замок переходов задачи и подписки сессии до ожидания базы … |
...
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-09-04 | ⚠ 57 коммит(ов) в areas после сверки: c310aba9 test(db): карантин тестов менеджеров на Postgres пройден; замок переходов задачи и подписки сессии до ожидания базы … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1256 коммит(ов) в areas после сверки: c310aba9 test(db): карантин тестов менеджеров на Postgres пройден; замок переходов задачи и подписки сессии до ожидания базы … |
...
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-05 | ⚠ 67 коммит(ов) в areas после сверки: c310aba9 test(db): карантин тестов менеджеров на Postgres пройден; замок переходов задачи и подписки сессии до ожидания базы … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-09-08 | ✓ |
...
| [stt-runner.md](stt-runner.md) | STT Runner: внутренний протокол, ресурсы и lifecycle | 2026-08-20 | ⚠ 187 коммит(ов) в areas после сверки: c310aba9 test(db): карантин тестов менеджеров на Postgres пройден; замок переходов задачи и подписки сессии до ожидания базы … |
...
| [tts-runner.md](tts-runner.md) | TTS Runner: ресурсный API, движки и жизненный цикл WAV | 2026-08-26 | ⚠ 139 коммит(ов) в areas после сверки: c310aba9 test(db): карантин тестов менеджеров на Postgres пройден; замок переходов задачи и подписки сессии до ожидания базы … |
