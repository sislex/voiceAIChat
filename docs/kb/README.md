...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 155 коммит(ов) в areas после сверки: 211646e1 fix(admin): служебные маршруты не принимаются за логин, даты в русском формате … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 785 коммит(ов) в areas после сверки: 211646e1 fix(admin): служебные маршруты не принимаются за логин, даты в русском формате … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-29 | ⚠ 2 коммит(ов) в areas после сверки: 211646e1 fix(admin): служебные маршруты не принимаются за логин, даты в русском формате … |
