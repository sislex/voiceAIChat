...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-08-19 | ⚠ 185 коммит(ов) в areas после сверки: 46a58147 feat(ui): add sidebar project multiselect … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-29 | ⚠ 114 коммит(ов) в areas после сверки: 46a58147 feat(ui): add sidebar project multiselect … |
...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 113 коммит(ов) в areas после сверки: 46a58147 feat(ui): add sidebar project multiselect … |
...
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-08-30 | ⚠ 47 коммит(ов) в areas после сверки: 46a58147 feat(ui): add sidebar project multiselect … |
...
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-30 | ⚠ 72 коммит(ов) в areas после сверки: 46a58147 feat(ui): add sidebar project multiselect … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-29 | ⚠ 104 коммит(ов) в areas после сверки: 46a58147 feat(ui): add sidebar project multiselect … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-08-28 | ⚠ 121 коммит(ов) в areas после сверки: 46a58147 feat(ui): add sidebar project multiselect … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-28 | ⚠ 107 коммит(ов) в areas после сверки: 46a58147 feat(ui): add sidebar project multiselect … |
| [operations-app.md](operations-app.md) | Frontend-модуль Operations: граница, store и подключение | 2026-08-19 | ⚠ 138 коммит(ов) в areas после сверки: 46a58147 feat(ui): add sidebar project multiselect … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-31 | ⚠ 14 коммит(ов) в areas после сверки: 46a58147 feat(ui): add sidebar project multiselect … |
