...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-20 | ⚠ 10 коммит(ов) в areas после сверки: d897ce13 Merge task b99b76f8-7285-481a-82a6-cb7722c50791 … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-20 | ⚠ 6 коммит(ов) в areas после сверки: e2ec4fb0 feat: give task preparation read-only project access … |
