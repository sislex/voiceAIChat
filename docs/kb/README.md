...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-12 | ⚠ 15 коммит(ов) в areas после сверки: ee7869b feat: add kanban stage progress and eta … |
...
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-08-10 | ⚠ 24 коммит(ов) в areas после сверки: ee7869b feat: add kanban stage progress and eta … |
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-12 | ⚠ 3 коммит(ов) в areas после сверки: ee7869b feat: add kanban stage progress and eta … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 249 коммит(ов) в areas после сверки: ee7869b feat: add kanban stage progress and eta … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-12 | ⚠ 16 коммит(ов) в areas после сверки: ee7869b feat: add kanban stage progress and eta … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-12 | ⚠ 5 коммит(ов) в areas после сверки: ee7869b feat: add kanban stage progress and eta … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-11 | ⚠ 28 коммит(ов) в areas после сверки: ee7869b feat: add kanban stage progress and eta … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-08 | ⚠ 61 коммит(ов) в areas после сверки: ee7869b feat: add kanban stage progress and eta … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-10 | ⚠ 24 коммит(ов) в areas после сверки: ee7869b feat: add kanban stage progress and eta … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-12 | ⚠ 4 коммит(ов) в areas после сверки: ee7869b feat: add kanban stage progress and eta … |
