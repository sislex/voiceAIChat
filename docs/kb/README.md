...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-20 | ⚠ 122 коммит(ов) в areas после сверки: 03763530 fix(chat): continue FIFO queue after turn errors … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 133 коммит(ов) в areas после сверки: 03763530 fix(chat): continue FIFO queue after turn errors … |
...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 13 коммит(ов) в areas после сверки: 03763530 fix(chat): continue FIFO queue after turn errors … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 767 коммит(ов) в areas после сверки: 03763530 fix(chat): continue FIFO queue after turn errors … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-20 | ⚠ 186 коммит(ов) в areas после сверки: 03763530 fix(chat): continue FIFO queue after turn errors … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-28 | ⚠ 31 коммит(ов) в areas после сверки: 03763530 fix(chat): continue FIFO queue after turn errors … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-28 | ⚠ 11 коммит(ов) в areas после сверки: 03763530 fix(chat): continue FIFO queue after turn errors … |
