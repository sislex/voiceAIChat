...
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-07-26 | ⚠ 2 коммит(ов) в areas после сверки: d89891d fix(agents): вывод удалённого обновления писать в лог, а не в /dev/null … |
