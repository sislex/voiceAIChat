...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-17 | ⚠ 23 коммит(ов) в areas после сверки: 1efcc5f feat(ui): add multi-assignee kanban filters … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 427 коммит(ов) в areas после сверки: 1b69860 docs(kb): update after merge df25869a-786f-4e11-b76d-36d8300fead7 … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-18 | ⚠ 1 коммит(ов) в areas после сверки: 1efcc5f feat(ui): add multi-assignee kanban filters |
