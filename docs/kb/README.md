...
|---|---|---|---|
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-01 | ⚠ 25 коммит(ов) в areas после сверки: 0353f90 feat(ui): консоль машины — история команд, «Стоп» и копирование вывода … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-05 | ⚠ 5 коммит(ов) в areas после сверки: 4e41ab7 feat(ui): единая шапка утилиты машины — машина со статусом, бейджи политики и переключение консоль ↔ проводник … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 65 коммит(ов) в areas после сверки: 99f4933 feat(ui): preview and edit machine files … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-05 | ⚠ 2 коммит(ов) в areas после сверки: 4e41ab7 feat(ui): единая шапка утилиты машины — машина со статусом, бейджи политики и переключение консоль ↔ проводник … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-05 | ⚠ 4 коммит(ов) в areas после сверки: 0353f90 feat(ui): консоль машины — история команд, «Стоп» и копирование вывода … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-05 | ⚠ 5 коммит(ов) в areas после сверки: 0353f90 feat(ui): консоль машины — история команд, «Стоп» и копирование вывода … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-04 | ⚠ 6 коммит(ов) в areas после сверки: 0353f90 feat(ui): консоль машины — история команд, «Стоп» и копирование вывода … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-05 | ⚠ 3 коммит(ов) в areas после сверки: 99f4933 feat(ui): preview and edit machine files … |
