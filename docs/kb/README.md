...
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-08 | ⚠ 8 коммит(ов) в areas после сверки: 07a990b feat: improve kanban assistant and task chats … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-08 | ⚠ 8 коммит(ов) в areas после сверки: 07a990b feat: improve kanban assistant and task chats … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-08 | ⚠ 8 коммит(ов) в areas после сверки: 07a990b feat: improve kanban assistant and task chats … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-08 | ⚠ 1 коммит(ов) в areas после сверки: 07a990b feat: improve kanban assistant and task chats |
