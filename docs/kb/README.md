...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-09-10 | ⚠ 48 коммит(ов) в areas после сверки: 66ff001c feat(reader): круг 20 — заметки, читаемый отчёт и лента по страницам … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1480 коммит(ов) в areas после сверки: 66ff001c feat(reader): круг 20 — заметки, читаемый отчёт и лента по страницам … |
...
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-09-11 | ⚠ 47 коммит(ов) в areas после сверки: 66ff001c feat(reader): круг 20 — заметки, читаемый отчёт и лента по страницам … |
