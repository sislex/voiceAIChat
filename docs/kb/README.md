...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-09 | ⚠ 58 коммит(ов) в areas после сверки: 2078cd84 feat(kanban): reorder columns from keyboard … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1390 коммит(ов) в areas после сверки: 2078cd84 feat(kanban): reorder columns from keyboard … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-09-11 | ⚠ 31 коммит(ов) в areas после сверки: 2078cd84 feat(kanban): reorder columns from keyboard … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-10 | ⚠ 32 коммит(ов) в areas после сверки: 2078cd84 feat(kanban): reorder columns from keyboard … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-11 | ⚠ 22 коммит(ов) в areas после сверки: 2078cd84 feat(kanban): reorder columns from keyboard … |
