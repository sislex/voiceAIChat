...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-29 | ⚠ 34 коммит(ов) в areas после сверки: 941d0de8 fix(kanban): карточка задачи перестала быть белой в тёмной теме, круг 6 … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 870 коммит(ов) в areas после сверки: 941d0de8 fix(kanban): карточка задачи перестала быть белой в тёмной теме, круг 6 … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-30 | ⚠ 8 коммит(ов) в areas после сверки: 941d0de8 fix(kanban): карточка задачи перестала быть белой в тёмной теме, круг 6 … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-29 | ⚠ 32 коммит(ов) в areas после сверки: 941d0de8 fix(kanban): карточка задачи перестала быть белой в тёмной теме, круг 6 … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-29 | ⚠ 20 коммит(ов) в areas после сверки: 941d0de8 fix(kanban): карточка задачи перестала быть белой в тёмной теме, круг 6 … |
