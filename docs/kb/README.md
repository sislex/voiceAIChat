...
|---|---|---|---|
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-16 | ⚠ 4 коммит(ов) в areas после сверки: c744579 Merge task 23e68524-34e9-4d40-a7da-0f43eb2a9670 … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-17 | ⚠ 4 коммит(ов) в areas после сверки: 79fb7b5 Merge origin/main into CHAT-236 … |
...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-16 | ⚠ 9 коммит(ов) в areas после сверки: 79fb7b5 Merge origin/main into CHAT-236 … |
...
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-08-16 | ⚠ 6 коммит(ов) в areas после сверки: 79fb7b5 Merge origin/main into CHAT-236 … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-17 | ⚠ 6 коммит(ов) в areas после сверки: 79fb7b5 Merge origin/main into CHAT-236 … |
