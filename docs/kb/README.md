...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-09-10 | ⚠ 8 коммит(ов) в areas после сверки: d05bd8eb feat(playwright-reader): emulate the person's environment (cycle 4) … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-09-10 | ⚠ 24 коммит(ов) в areas после сверки: d05bd8eb feat(playwright-reader): emulate the person's environment (cycle 4) … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1351 коммит(ов) в areas после сверки: d05bd8eb feat(playwright-reader): emulate the person's environment (cycle 4) … |
...
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 323 коммит(ов) в areas после сверки: d05bd8eb feat(playwright-reader): emulate the person's environment (cycle 4) … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-10 | ⚠ 8 коммит(ов) в areas после сверки: d05bd8eb feat(playwright-reader): emulate the person's environment (cycle 4) … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-09-10 | ⚠ 6 коммит(ов) в areas после сверки: d05bd8eb feat(playwright-reader): emulate the person's environment (cycle 4) … |
...
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-09-11 | ⚠ 11 коммит(ов) в areas после сверки: d05bd8eb feat(playwright-reader): emulate the person's environment (cycle 4) … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-15 | ⚠ 2 коммит(ов) в areas после сверки: d05bd8eb feat(playwright-reader): emulate the person's environment (cycle 4) … |
