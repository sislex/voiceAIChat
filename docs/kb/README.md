...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 215 коммит(ов) в areas после сверки: a3fa860 CHAT-176 Разнести настройки карточки по вкладкам … |
