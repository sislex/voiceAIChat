...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 93 коммит(ов) в areas после сверки: ecb3aad test(ui): вернуть четыре теста к текущему поведению UI … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-06 | ⚠ 2 коммит(ов) в areas после сверки: ecb3aad test(ui): вернуть четыре теста к текущему поведению UI … |
...
| [testing-operations.md](testing-operations.md) | Разработка, тестирование, диагностика и эксплуатация | 2026-08-02 | ⚠ 17 коммит(ов) в areas после сверки: 1e65d50 CHAT-117: изолировать diff регрессии affected-check … |
