...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-09 | ⚠ 51 коммит(ов) в areas после сверки: ab74391b feat(kanban): make column menus keyboard accessible … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1383 коммит(ов) в areas после сверки: ab74391b feat(kanban): make column menus keyboard accessible … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-09-11 | ⚠ 24 коммит(ов) в areas после сверки: ab74391b feat(kanban): make column menus keyboard accessible … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-10 | ⚠ 26 коммит(ов) в areas после сверки: c9c83160 feat(kanban): add detailed assignee filter … |
| [features/task-autopilot.md](features/task-autopilot.md) | Автопроход задачи по QA-конвейеру | 2026-09-11 | ⚠ 10 коммит(ов) в areas после сверки: 62cad05c feat(kanban): explain search matches … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-11 | ⚠ 15 коммит(ов) в areas после сверки: ab74391b feat(kanban): make column menus keyboard accessible … |
