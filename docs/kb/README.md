...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-20 | ⚠ 46 коммит(ов) в areas после сверки: b3d269dc feat: add Web Reader self-diagnostics … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-24 | ⚠ 3 коммит(ов) в areas после сверки: b3d269dc feat: add Web Reader self-diagnostics … |
...
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-08-24 | ⚠ 7 коммит(ов) в areas после сверки: b3d269dc feat: add Web Reader self-diagnostics … |
...
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-23 | ⚠ 16 коммит(ов) в areas после сверки: b3d269dc feat: add Web Reader self-diagnostics … |
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-08-24 | ⚠ 7 коммит(ов) в areas после сверки: b3d269dc feat: add Web Reader self-diagnostics … |
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 23 коммит(ов) в areas после сверки: b3d269dc feat: add Web Reader self-diagnostics … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-23 | ⚠ 13 коммит(ов) в areas после сверки: b3d269dc feat: add Web Reader self-diagnostics … |
...
| [stt-runner.md](stt-runner.md) | STT Runner: внутренний протокол, ресурсы и lifecycle | 2026-08-20 | ⚠ 35 коммит(ов) в areas после сверки: b3d269dc feat: add Web Reader self-diagnostics … |
...
| [tts-runner.md](tts-runner.md) | TTS Runner: ресурсный API, движки и жизненный цикл WAV | 2026-08-20 | ⚠ 29 коммит(ов) в areas после сверки: b3d269dc feat: add Web Reader self-diagnostics … |
