...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-09-04 | ⚠ 5 коммит(ов) в areas после сверки: e00e5c8c feat: студия картинок — сплит «чат + галерея» с генерацией и правкой через LLM … |
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-09-04 | ✓ |
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-04 | ⚠ 30 коммит(ов) в areas после сверки: 1859fc73 feat: студия картинок — итерации 46–54 … |
...
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-09-04 | ✓ |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1126 коммит(ов) в areas после сверки: 1859fc73 feat: студия картинок — итерации 46–54 … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-30 | ⚠ 167 коммит(ов) в areas после сверки: 1859fc73 feat: студия картинок — итерации 46–54 … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-29 | ⚠ 212 коммит(ов) в areas после сверки: 1859fc73 feat: студия картинок — итерации 46–54 … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-03 | ⚠ 1 коммит(ов) в areas после сверки: 593eae9f feat: студия картинок 37–45, автопочинка merge-рана и кнопка исправления в чате |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-03 | ⚠ 26 коммит(ов) в areas после сверки: 1859fc73 feat: студия картинок — итерации 46–54 … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-04 | ⚠ 45 коммит(ов) в areas после сверки: 1859fc73 feat: студия картинок — итерации 46–54 … |
