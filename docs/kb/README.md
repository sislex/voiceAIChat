...
|---|---|---|---|
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-01 | ⚠ 76 коммит(ов) в areas после сверки: 69df56c CHAT-180: merge-ран v2 — постоянный клон, умный поток, редизайн вкладки Merge … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-12 | ⚠ 10 коммит(ов) в areas после сверки: 69df56c CHAT-180: merge-ран v2 — постоянный клон, умный поток, редизайн вкладки Merge … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-12 | ⚠ 8 коммит(ов) в areas после сверки: 69df56c CHAT-180: merge-ран v2 — постоянный клон, умный поток, редизайн вкладки Merge … |
...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-07 | ⚠ 34 коммит(ов) в areas после сверки: bfec9ba CHAT-180: вкладка merge-рана с выбором машины, учёт репозиториев задачи, канонизация origin URL … |
...
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-08-10 | ⚠ 19 коммит(ов) в areas после сверки: 69df56c CHAT-180: merge-ран v2 — постоянный клон, умный поток, редизайн вкладки Merge … |
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-13 | ⚠ 1 коммит(ов) в areas после сверки: 69df56c CHAT-180: merge-ран v2 — постоянный клон, умный поток, редизайн вкладки Merge |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 239 коммит(ов) в areas после сверки: 69df56c CHAT-180: merge-ран v2 — постоянный клон, умный поток, редизайн вкладки Merge … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-12 | ⚠ 11 коммит(ов) в areas после сверки: 69df56c CHAT-180: merge-ран v2 — постоянный клон, умный поток, редизайн вкладки Merge … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-12 | ⚠ 11 коммит(ов) в areas после сверки: 69df56c CHAT-180: merge-ран v2 — постоянный клон, умный поток, редизайн вкладки Merge … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-11 | ⚠ 20 коммит(ов) в areas после сверки: 69df56c CHAT-180: merge-ран v2 — постоянный клон, умный поток, редизайн вкладки Merge … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-08 | ⚠ 52 коммит(ов) в areas после сверки: 69df56c CHAT-180: merge-ран v2 — постоянный клон, умный поток, редизайн вкладки Merge … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-10 | ⚠ 21 коммит(ов) в areas после сверки: 69df56c CHAT-180: merge-ран v2 — постоянный клон, умный поток, редизайн вкладки Merge … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-13 | ⚠ 1 коммит(ов) в areas после сверки: 69df56c CHAT-180: merge-ран v2 — постоянный клон, умный поток, редизайн вкладки Merge |
