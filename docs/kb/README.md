...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 70 коммит(ов) в areas после сверки: 3c1304e6 feat(make): токены и открытые комментарии в промпте хода (roadmap-2 п.9); скриншоты превью со стилями … |
...
| [features/llm-runners.md](features/llm-runners.md) | Исполнители LLM: контейнеры с claude/codex CLI | 2026-08-18 | ⚠ 58 коммит(ов) в areas после сверки: 3c1304e6 feat(make): токены и открытые комментарии в промпте хода (roadmap-2 п.9); скриншоты превью со стилями … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 684 коммит(ов) в areas после сверки: 3c1304e6 feat(make): токены и открытые комментарии в промпте хода (roadmap-2 п.9); скриншоты превью со стилями … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-20 | ⚠ 132 коммит(ов) в areas после сверки: 3c1304e6 feat(make): токены и открытые комментарии в промпте хода (roadmap-2 п.9); скриншоты превью со стилями … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-25 | ⚠ 62 коммит(ов) в areas после сверки: 3c1304e6 feat(make): токены и открытые комментарии в промпте хода (roadmap-2 п.9); скриншоты превью со стилями … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-25 | ⚠ 61 коммит(ов) в areas после сверки: 3c1304e6 feat(make): токены и открытые комментарии в промпте хода (roadmap-2 п.9); скриншоты превью со стилями … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-27 | ⚠ 16 коммит(ов) в areas после сверки: 3c1304e6 feat(make): токены и открытые комментарии в промпте хода (roadmap-2 п.9); скриншоты превью со стилями … |
