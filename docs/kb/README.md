...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-08-19 | ⚠ 128 коммит(ов) в areas после сверки: 211646e1 fix(admin): служебные маршруты не принимаются за логин, даты в русском формате … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-29 | ⚠ 3 коммит(ов) в areas после сверки: ecfdf8b6 fix(projects): ссылка приглашения идемпотентна, смена роли проговаривается … |
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-08-29 | ✓ |
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 156 коммит(ов) в areas после сверки: 69ca93e1 fix(ui): иконочные цели нажатия на телефоне и порог по ширине в прогоне … |
| [features/feature-preview.md](features/feature-preview.md) | Feature-preview окружения задач | 2026-08-28 | ⚠ 11 коммит(ов) в areas после сверки: ecfdf8b6 fix(projects): ссылка приглашения идемпотентна, смена роли проговаривается … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 28 коммит(ов) в areas после сверки: 211646e1 fix(admin): служебные маршруты не принимаются за логин, даты в русском формате … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 791 коммит(ов) в areas после сверки: 69ca93e1 fix(ui): иконочные цели нажатия на телефоне и порог по ширине в прогоне … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-20 | ⚠ 200 коммит(ов) в areas после сверки: 69ca93e1 fix(ui): иконочные цели нажатия на телефоне и порог по ширине в прогоне … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-28 | ⚠ 54 коммит(ов) в areas после сверки: 69ca93e1 fix(ui): иконочные цели нажатия на телефоне и порог по ширине в прогоне … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-29 | ⚠ 1 коммит(ов) в areas после сверки: 69ca93e1 fix(ui): иконочные цели нажатия на телефоне и порог по ширине в прогоне |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-28 | ⚠ 18 коммит(ов) в areas после сверки: 18d962fd fix(project-types): участнику объясняют отказ derive-type вместо 404 … |
...
| [testing-operations.md](testing-operations.md) | Разработка, тестирование, диагностика и эксплуатация | 2026-08-29 | ⚠ 1 коммит(ов) в areas после сверки: 69ca93e1 fix(ui): иконочные цели нажатия на телефоне и порог по ширине в прогоне |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-29 | ⚠ 1 коммит(ов) в areas после сверки: 69ca93e1 fix(ui): иконочные цели нажатия на телефоне и порог по ширине в прогоне |
