...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 340 коммит(ов) в areas после сверки: bb1d4a5b feat(reader): круг 12 — состояние контролов, уведомления и чек-лист … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-14 | ⚠ 11 коммит(ов) в areas после сверки: bb1d4a5b feat(reader): круг 12 — состояние контролов, уведомления и чек-лист … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-09-14 | ⚠ 11 коммит(ов) в areas после сверки: bb1d4a5b feat(reader): круг 12 — состояние контролов, уведомления и чек-лист … |
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-14 | ⚠ 11 коммит(ов) в areas после сверки: bb1d4a5b feat(reader): круг 12 — состояние контролов, уведомления и чек-лист … |
| [operations-app.md](operations-app.md) | Frontend-модуль Operations: граница, store и подключение | 2026-08-19 | ⚠ 247 коммит(ов) в areas после сверки: bb1d4a5b feat(reader): круг 12 — состояние контролов, уведомления и чек-лист … |
