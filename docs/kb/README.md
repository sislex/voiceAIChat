...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 54 коммит(ов) в areas после сверки: a04ebf0d feat(make): play-функции стори — интерактивные тесты в раннере со статусом в панели (п.18) … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 657 коммит(ов) в areas после сверки: a04ebf0d feat(make): play-функции стори — интерактивные тесты в раннере со статусом в панели (п.18) … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-20 | ⚠ 117 коммит(ов) в areas после сверки: a04ebf0d feat(make): play-функции стори — интерактивные тесты в раннере со статусом в панели (п.18) … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-25 | ⚠ 45 коммит(ов) в areas после сверки: a04ebf0d feat(make): play-функции стори — интерактивные тесты в раннере со статусом в панели (п.18) … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-25 | ⚠ 43 коммит(ов) в areas после сверки: a04ebf0d feat(make): play-функции стори — интерактивные тесты в раннере со статусом в панели (п.18) … |
...
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-27 | ⚠ 12 коммит(ов) в areas после сверки: a04ebf0d feat(make): play-функции стори — интерактивные тесты в раннере со статусом в панели (п.18) … |
