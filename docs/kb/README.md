...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-06 | ⚠ 55 коммит(ов) в areas после сверки: 1a99413b Merge main into CHAT-430 (task 3e47abde-e891-4854-9c60-8917aae08e8b) … |
...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 110 коммит(ов) в areas после сверки: 1a99413b Merge main into CHAT-430 (task 3e47abde-e891-4854-9c60-8917aae08e8b) … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 281 коммит(ов) в areas после сверки: 1a99413b Merge main into CHAT-430 (task 3e47abde-e891-4854-9c60-8917aae08e8b) … |
...
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-05 | ⚠ 79 коммит(ов) в areas после сверки: 1a99413b Merge main into CHAT-430 (task 3e47abde-e891-4854-9c60-8917aae08e8b) … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-05 | ⚠ 72 коммит(ов) в areas после сверки: 1a99413b Merge main into CHAT-430 (task 3e47abde-e891-4854-9c60-8917aae08e8b) … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-07 | ⚠ 40 коммит(ов) в areas после сверки: 1a99413b Merge main into CHAT-430 (task 3e47abde-e891-4854-9c60-8917aae08e8b) … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-08 | ⚠ 4 коммит(ов) в areas после сверки: 1a99413b Merge main into CHAT-430 (task 3e47abde-e891-4854-9c60-8917aae08e8b) … |
