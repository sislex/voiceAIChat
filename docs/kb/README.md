...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-01 | ⚠ 7 коммит(ов) в areas после сверки: c2d0836 feat(ci): модель по стадии рана — актуализация БЗ и резюме дешевле … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 2 коммит(ов) в areas после сверки: c2d0836 feat(ci): модель по стадии рана — актуализация БЗ и резюме дешевле … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-01 | ⚠ 14 коммит(ов) в areas после сверки: c2d0836 feat(ci): модель по стадии рана — актуализация БЗ и резюме дешевле … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-01 | ⚠ 24 коммит(ов) в areas после сверки: c2d0836 feat(ci): модель по стадии рана — актуализация БЗ и резюме дешевле … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-02 | ⚠ 2 коммит(ов) в areas после сверки: c2d0836 feat(ci): модель по стадии рана — актуализация БЗ и резюме дешевле … |
