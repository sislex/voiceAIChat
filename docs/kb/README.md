...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-09-20 | ⚠ 9 коммит(ов) в areas после сверки: c99bf8e6 fix(shared): keep browser release bridge optional … |
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-09-22 | ⚠ 2 коммит(ов) в areas после сверки: 38dbc3b5 feat(core): activate compatible browser UI releases without restart … |
| [clients.md](clients.md) | Клиенты и упаковка: web, desktop и agent-tray | 2026-09-22 | ⚠ 2 коммит(ов) в areas после сверки: 38dbc3b5 feat(core): activate compatible browser UI releases without restart … |
| [conventions.md](conventions.md) | Конвенции: код, тесты, гейты, коммиты | 2026-09-22 | ⚠ 2 коммит(ов) в areas после сверки: 38dbc3b5 feat(core): activate compatible browser UI releases without restart … |
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-09-22 | ⚠ 3 коммит(ов) в areas после сверки: 4c0bb6a9 feat(releases): manage browser UI from release center … |
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-09-22 | ⚠ 1 коммит(ов) в areas после сверки: 4c0bb6a9 feat(releases): manage browser UI from release center |
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-17 | ⚠ 25 коммит(ов) в areas после сверки: 4c0bb6a9 feat(releases): manage browser UI from release center … |
...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 225 коммит(ов) в areas после сверки: c99bf8e6 fix(shared): keep browser release bridge optional … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 380 коммит(ов) в areas после сверки: 4c0bb6a9 feat(releases): manage browser UI from release center … |
| [features/llm-runners.md](features/llm-runners.md) | Исполнители LLM: контейнеры с claude/codex CLI | 2026-09-12 | ⚠ 24 коммит(ов) в areas после сверки: 38dbc3b5 feat(core): activate compatible browser UI releases without restart … |
...
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-09-22 | ⚠ 2 коммит(ов) в areas после сверки: c99bf8e6 fix(shared): keep browser release bridge optional … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1611 коммит(ов) в areas после сверки: c99bf8e6 fix(shared): keep browser release bridge optional … |
...
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-22 | ⚠ 2 коммит(ов) в areas после сверки: c99bf8e6 fix(shared): keep browser release bridge optional … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-17 | ⚠ 22 коммит(ов) в areas после сверки: c99bf8e6 fix(shared): keep browser release bridge optional … |
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 390 коммит(ов) в areas после сверки: c99bf8e6 fix(shared): keep browser release bridge optional … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-09-22 | ⚠ 4 коммит(ов) в areas после сверки: 4c0bb6a9 feat(releases): manage browser UI from release center … |
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-22 | ⚠ 4 коммит(ов) в areas после сверки: c99bf8e6 fix(shared): keep browser release bridge optional … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-17 | ⚠ 11 коммит(ов) в areas после сверки: c99bf8e6 fix(shared): keep browser release bridge optional … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-09-17 | ⚠ 18 коммит(ов) в areas после сверки: c99bf8e6 fix(shared): keep browser release bridge optional … |
