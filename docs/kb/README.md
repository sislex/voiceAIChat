...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-16 | ✓ |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 365 коммит(ов) в areas после сверки: de895b5 docs(kb): update after merge 5f881662-ea1b-445d-bc58-679063916bdb … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-16 | ✓ |
...
- [2026-08-16-mac-domain-stores-split.md](log/2026-08-16-mac-domain-stores-split.md) — domain-stores-split
