...
|---|---|---|---|
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-01 | ⚠ 31 коммит(ов) в areas после сверки: a5b4b95 feat(admin): add editable model prices and dual usage costs … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-06 | ⚠ 1 коммит(ов) в areas после сверки: a5b4b95 feat(admin): add editable model prices and dual usage costs |
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-08-07 | ✓ |
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-07 | ⚠ 2 коммит(ов) в areas после сверки: 722cf5c fix(ci): avoid duplicate vitest silent flag … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 95 коммит(ов) в areas после сверки: a5b4b95 feat(admin): add editable model prices and dual usage costs … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-06 | ⚠ 3 коммит(ов) в areas после сверки: a5b4b95 feat(admin): add editable model prices and dual usage costs … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-05 | ⚠ 9 коммит(ов) в areas после сверки: a5b4b95 feat(admin): add editable model prices and dual usage costs … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-06 | ⚠ 2 коммит(ов) в areas после сверки: a5b4b95 feat(admin): add editable model prices and dual usage costs … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-07 | ✓ |
