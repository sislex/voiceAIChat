...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-15 | ⚠ 1 коммит(ов) в areas после сверки: f67ddb9 Merge task fc2f548b-e8ff-42fc-8a92-ad89c41dced8 |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 358 коммит(ов) в areas после сверки: 0a044e4 Merge task a3c6553f-0f18-4959-8b82-860717a8a090 … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-15 | ⚠ 4 коммит(ов) в areas после сверки: 0a044e4 Merge task a3c6553f-0f18-4959-8b82-860717a8a090 … |
...
- [2026-08-15-2470-com-chat-240-parallel-merge.md](log/2026-08-15-2470-com-chat-240-parallel-merge.md) — chat-240-parallel-merge
