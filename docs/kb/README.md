...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 208 коммит(ов) в areas после сверки: 605adab feat: redesign release center … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-11 | ⚠ 9 коммит(ов) в areas после сверки: 605adab feat: redesign release center … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-08 | ⚠ 30 коммит(ов) в areas после сверки: 4e83404 fix: extend release test stage timeout … |
