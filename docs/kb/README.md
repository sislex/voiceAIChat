...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-26 | ⚠ 1 коммит(ов) в areas после сверки: 5a60255e feat(chat): блок токенов — триггер сведений об ответе, иконка ⓘ удалена |
