...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-08-19 | ⚠ 77 коммит(ов) в areas после сверки: d154a403 feat(make): presence вкладок и мягкая блокировка файла при чужом редактировании (roadmap-2 п.14) … |
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-20 | ⚠ 91 коммит(ов) в areas после сверки: d154a403 feat(make): presence вкладок и мягкая блокировка файла при чужом редактировании (roadmap-2 п.14) … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 74 коммит(ов) в areas после сверки: d154a403 feat(make): presence вкладок и мягкая блокировка файла при чужом редактировании (roadmap-2 п.14) … |
...
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-08-24 | ⚠ 45 коммит(ов) в areas после сверки: d154a403 feat(make): presence вкладок и мягкая блокировка файла при чужом редактировании (roadmap-2 п.14) … |
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-24 | ⚠ 43 коммит(ов) в areas после сверки: d154a403 feat(make): presence вкладок и мягкая блокировка файла при чужом редактировании (roadmap-2 п.14) … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 689 коммит(ов) в areas после сверки: d154a403 feat(make): presence вкладок и мягкая блокировка файла при чужом редактировании (roadmap-2 п.14) … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-20 | ⚠ 136 коммит(ов) в areas после сверки: d154a403 feat(make): presence вкладок и мягкая блокировка файла при чужом редактировании (roadmap-2 п.14) … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-25 | ⚠ 66 коммит(ов) в areas после сверки: d154a403 feat(make): presence вкладок и мягкая блокировка файла при чужом редактировании (roadmap-2 п.14) … |
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-08-25 | ⚠ 39 коммит(ов) в areas после сверки: d154a403 feat(make): presence вкладок и мягкая блокировка файла при чужом редактировании (roadmap-2 п.14) … |
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 63 коммит(ов) в areas после сверки: d154a403 feat(make): presence вкладок и мягкая блокировка файла при чужом редактировании (roadmap-2 п.14) … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-27 | ⚠ 20 коммит(ов) в areas после сверки: d154a403 feat(make): presence вкладок и мягкая блокировка файла при чужом редактировании (roadmap-2 п.14) … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-27 | ⚠ 30 коммит(ов) в areas после сверки: d154a403 feat(make): presence вкладок и мягкая блокировка файла при чужом редактировании (roadmap-2 п.14) … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-27 | ⚠ 1 коммит(ов) в areas после сверки: d154a403 feat(make): presence вкладок и мягкая блокировка файла при чужом редактировании (roadmap-2 п.14) |
