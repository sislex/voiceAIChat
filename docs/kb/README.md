...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-20 | ⚠ 66 коммит(ов) в areas после сверки: 7056ce02 feat(settings): инструкции чата с чекбоксами — модель получает только включённые подсказки … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 20 коммит(ов) в areas после сверки: 7056ce02 feat(settings): инструкции чата с чекбоксами — модель получает только включённые подсказки … |
...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-16 | ⚠ 111 коммит(ов) в areas после сверки: 7056ce02 feat(settings): инструкции чата с чекбоксами — модель получает только включённые подсказки … |
...
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-24 | ⚠ 17 коммит(ов) в areas после сверки: 7056ce02 feat(settings): инструкции чата с чекбоксами — модель получает только включённые подсказки … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 618 коммит(ов) в areas после сверки: 7056ce02 feat(settings): инструкции чата с чекбоксами — модель получает только включённые подсказки … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-20 | ⚠ 87 коммит(ов) в areas после сверки: 7056ce02 feat(settings): инструкции чата с чекбоксами — модель получает только включённые подсказки … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-25 | ⚠ 11 коммит(ов) в areas после сверки: 7056ce02 feat(settings): инструкции чата с чекбоксами — модель получает только включённые подсказки … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-08-26 | ⚠ 1 коммит(ов) в areas после сверки: 7056ce02 feat(settings): инструкции чата с чекбоксами — модель получает только включённые подсказки |
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-25 | ⚠ 17 коммит(ов) в areas после сверки: 7056ce02 feat(settings): инструкции чата с чекбоксами — модель получает только включённые подсказки … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-25 | ⚠ 9 коммит(ов) в areas после сверки: 7056ce02 feat(settings): инструкции чата с чекбоксами — модель получает только включённые подсказки … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-25 | ⚠ 10 коммит(ов) в areas после сверки: 7056ce02 feat(settings): инструкции чата с чекбоксами — модель получает только включённые подсказки … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-26 | ⚠ 1 коммит(ов) в areas после сверки: 7056ce02 feat(settings): инструкции чата с чекбоксами — модель получает только включённые подсказки |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-26 | ⚠ 1 коммит(ов) в areas после сверки: 7056ce02 feat(settings): инструкции чата с чекбоксами — модель получает только включённые подсказки |
