...
|---|---|---|---|
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-01 | ⚠ 59 коммит(ов) в areas после сверки: a0dc4c6 fix: возобновлять релиз после рестарта … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-06 | ⚠ 23 коммит(ов) в areas после сверки: a0dc4c6 fix: возобновлять релиз после рестарта … |
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-08-08 | ⚠ 8 коммит(ов) в areas после сверки: a0dc4c6 fix: возобновлять релиз после рестарта … |
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-10 | ⚠ 6 коммит(ов) в areas после сверки: a0dc4c6 fix: возобновлять релиз после рестарта … |
...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-07 | ⚠ 22 коммит(ов) в areas после сверки: a0dc4c6 fix: возобновлять релиз после рестарта … |
| [features/llm-runners.md](features/llm-runners.md) | Исполнители LLM: контейнеры с claude/codex CLI | 2026-08-02 | ⚠ 29 коммит(ов) в areas после сверки: a0dc4c6 fix: возобновлять релиз после рестарта … |
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-08-10 | ⚠ 2 коммит(ов) в areas после сверки: a0dc4c6 fix: возобновлять релиз после рестарта … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 186 коммит(ов) в areas после сверки: a0dc4c6 fix: возобновлять релиз после рестарта … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-10 | ⚠ 9 коммит(ов) в areas после сверки: a0dc4c6 fix: возобновлять релиз после рестарта … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-10 | ⚠ 3 коммит(ов) в areas после сверки: a0dc4c6 fix: возобновлять релиз после рестарта … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-08 | ⚠ 17 коммит(ов) в areas после сверки: a0dc4c6 fix: возобновлять релиз после рестарта … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-10 | ⚠ 3 коммит(ов) в areas после сверки: 544315f fix: стабилизировать публикацию релизов … |
