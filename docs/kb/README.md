...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-08-19 | ⚠ 143 коммит(ов) в areas после сверки: 26422a88 fix(scenario): набор требует дисциплины имён … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-29 | ⚠ 40 коммит(ов) в areas после сверки: 8dbbe39a fix(ui): цвет в app.css целиком на токенах, круг 10 … |
...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 62 коммит(ов) в areas после сверки: f66fd706 feat(kanban): промежуточная ширина и последние диалекты раскрытия, круг 9 … |
...
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-24 | ⚠ 132 коммит(ов) в areas после сверки: f66fd706 feat(kanban): промежуточная ширина и последние диалекты раскрытия, круг 9 … |
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-08-30 | ⚠ 3 коммит(ов) в areas после сверки: 525d823b Merge remote-tracking branch 'origin/main' into work3 … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 876 коммит(ов) в areas после сверки: 8dbbe39a fix(ui): цвет в app.css целиком на токенах, круг 10 … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-30 | ⚠ 12 коммит(ов) в areas после сверки: 8dbbe39a fix(ui): цвет в app.css целиком на токенах, круг 10 … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-29 | ⚠ 38 коммит(ов) в areas после сверки: 8dbbe39a fix(ui): цвет в app.css целиком на токенах, круг 10 … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-29 | ⚠ 26 коммит(ов) в areas после сверки: 8dbbe39a fix(ui): цвет в app.css целиком на токенах, круг 10 … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-30 | ⚠ 2 коммит(ов) в areas после сверки: 2aa08d76 Merge remote-tracking branch 'origin/main' into work3 … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-30 | ⚠ 1 коммит(ов) в areas после сверки: 8dbbe39a fix(ui): цвет в app.css целиком на токенах, круг 10 |
