...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-09 | ⚠ 63 коммит(ов) в areas после сверки: 164894e5 feat(kanban): functional tabs of the new task card by Make «Проект 19» … |
...
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-09-04 | ⚠ 83 коммит(ов) в areas после сверки: 164894e5 feat(kanban): functional tabs of the new task card by Make «Проект 19» … |
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-09-04 | ⚠ 106 коммит(ов) в areas после сверки: 164894e5 feat(kanban): functional tabs of the new task card by Make «Проект 19» … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1396 коммит(ов) в areas после сверки: 164894e5 feat(kanban): functional tabs of the new task card by Make «Проект 19» … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-09-11 | ⚠ 36 коммит(ов) в areas после сверки: 164894e5 feat(kanban): functional tabs of the new task card by Make «Проект 19» … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-10 | ⚠ 37 коммит(ов) в areas после сверки: 164894e5 feat(kanban): functional tabs of the new task card by Make «Проект 19» … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-11 | ⚠ 1 коммит(ов) в areas после сверки: 164894e5 feat(kanban): functional tabs of the new task card by Make «Проект 19» |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-12 | ⚠ 1 коммит(ов) в areas после сверки: 164894e5 feat(kanban): functional tabs of the new task card by Make «Проект 19» |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-11 | ⚠ 28 коммит(ов) в areas после сверки: 164894e5 feat(kanban): functional tabs of the new task card by Make «Проект 19» … |
