...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 363 коммит(ов) в areas после сверки: d909ba0 docs(kb): update after merge 2c76d538-a79a-4476-9957-4b682158e674 … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-15 | ⚠ код изменён 2026-08-16, сверка 2026-08-15 (по датам: правки того же дня не видны — поставь checked) |
