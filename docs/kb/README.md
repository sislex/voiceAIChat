...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-09 | ⚠ 54 коммит(ов) в areas после сверки: da728e21 feat(kanban): expose board snapshot status … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1386 коммит(ов) в areas после сверки: da728e21 feat(kanban): expose board snapshot status … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-09-11 | ⚠ 27 коммит(ов) в areas после сверки: da728e21 feat(kanban): expose board snapshot status … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-10 | ⚠ 29 коммит(ов) в areas после сверки: da728e21 feat(kanban): expose board snapshot status … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-11 | ⚠ 18 коммит(ов) в areas после сверки: da728e21 feat(kanban): expose board snapshot status … |
