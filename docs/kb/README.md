...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-02 | ⚠ 1 коммит(ов) в areas после сверки: a167224 test(ci): резюме рана по умолчанию идёт на модели своей стадии |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 4 коммит(ов) в areas после сверки: a4e5aa9 docs(kb): семантика патча настройки стадий и где она правится … |
