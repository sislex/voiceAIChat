...
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-09-09 | ⚠ 3 коммит(ов) в areas после сверки: f4474be3 fix(reader): restore project login and isolate cached data (cycle 03/20) … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1293 коммит(ов) в areas после сверки: f4474be3 fix(reader): restore project login and isolate cached data (cycle 03/20) … |
...
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-09-09 | ⚠ 6 коммит(ов) в areas после сверки: f4474be3 fix(reader): restore project login and isolate cached data (cycle 03/20) … |
