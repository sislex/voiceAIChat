...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-08-19 | ⚠ 50 коммит(ов) в areas после сверки: ba2d6042 feat(context): тумблеры инспектора контекста с реальным гейтингом … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 12 коммит(ов) в areas после сверки: ba2d6042 feat(context): тумблеры инспектора контекста с реальным гейтингом … |
...
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-08-25 | ⚠ 7 коммит(ов) в areas после сверки: ba2d6042 feat(context): тумблеры инспектора контекста с реальным гейтингом … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 612 коммит(ов) в areas после сверки: ba2d6042 feat(context): тумблеры инспектора контекста с реальным гейтингом … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-20 | ⚠ 79 коммит(ов) в areas после сверки: ba2d6042 feat(context): тумблеры инспектора контекста с реальным гейтингом … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-25 | ⚠ 3 коммит(ов) в areas после сверки: ba2d6042 feat(context): тумблеры инспектора контекста с реальным гейтингом … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-25 | ⚠ 12 коммит(ов) в areas после сверки: ba2d6042 feat(context): тумблеры инспектора контекста с реальным гейтингом … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-25 | ⚠ 1 коммит(ов) в areas после сверки: ba2d6042 feat(context): тумблеры инспектора контекста с реальным гейтингом |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-25 | ⚠ 7 коммит(ов) в areas после сверки: ba2d6042 feat(context): тумблеры инспектора контекста с реальным гейтингом … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-25 | ⚠ 6 коммит(ов) в areas после сверки: ba2d6042 feat(context): тумблеры инспектора контекста с реальным гейтингом … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-25 | ⚠ 3 коммит(ов) в areas после сверки: ba2d6042 feat(context): тумблеры инспектора контекста с реальным гейтингом … |
