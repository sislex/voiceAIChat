...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-09-10 | ⚠ 39 коммит(ов) в areas после сверки: 01a28f13 feat(playwright-reader): handle tabs the way a person names them (cycle 14) … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-09-13 | ⚠ 17 коммит(ов) в areas после сверки: 01a28f13 feat(playwright-reader): handle tabs the way a person names them (cycle 14) … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1469 коммит(ов) в areas после сверки: 01a28f13 feat(playwright-reader): handle tabs the way a person names them (cycle 14) … |
...
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 351 коммит(ов) в areas после сверки: 01a28f13 feat(playwright-reader): handle tabs the way a person names them (cycle 14) … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-13 | ⚠ 26 коммит(ов) в areas после сверки: 01a28f13 feat(playwright-reader): handle tabs the way a person names them (cycle 14) … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-09-15 | ⚠ 10 коммит(ов) в areas после сверки: 01a28f13 feat(playwright-reader): handle tabs the way a person names them (cycle 14) … |
...
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-09-11 | ⚠ 39 коммит(ов) в areas после сверки: 01a28f13 feat(playwright-reader): handle tabs the way a person names them (cycle 14) … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-15 | ⚠ 97 коммит(ов) в areas после сверки: 01a28f13 feat(playwright-reader): handle tabs the way a person names them (cycle 14) … |
