...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 52 коммит(ов) в areas после сверки: 38c1a131 feat(make): публичные сториз и галерея компонентов на публикации, «Поделиться» стори (п.15) … |
...
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-08-24 | ⚠ 36 коммит(ов) в areas после сверки: 38c1a131 feat(make): публичные сториз и галерея компонентов на публикации, «Поделиться» стори (п.15) … |
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-24 | ⚠ 32 коммит(ов) в areas после сверки: 38c1a131 feat(make): публичные сториз и галерея компонентов на публикации, «Поделиться» стори (п.15) … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 655 коммит(ов) в areas после сверки: 38c1a131 feat(make): публичные сториз и галерея компонентов на публикации, «Поделиться» стори (п.15) … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-20 | ⚠ 115 коммит(ов) в areas после сверки: 0574ce01 feat(make): проверка доступности превью axe-core с исправлением через ассистента (п.13) … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-25 | ⚠ 43 коммит(ов) в areas после сверки: 38c1a131 feat(make): публичные сториз и галерея компонентов на публикации, «Поделиться» стори (п.15) … |
...
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 52 коммит(ов) в areas после сверки: 38c1a131 feat(make): публичные сториз и галерея компонентов на публикации, «Поделиться» стори (п.15) … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-08-27 | ⚠ 3 коммит(ов) в areas после сверки: 38c1a131 feat(make): публичные сториз и галерея компонентов на публикации, «Поделиться» стори (п.15) … |
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-26 | ⚠ 14 коммит(ов) в areas после сверки: 38c1a131 feat(make): публичные сториз и галерея компонентов на публикации, «Поделиться» стори (п.15) … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-25 | ⚠ 41 коммит(ов) в areas после сверки: 0574ce01 feat(make): проверка доступности превью axe-core с исправлением через ассистента (п.13) … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-27 | ⚠ 8 коммит(ов) в areas после сверки: 38c1a131 feat(make): публичные сториз и галерея компонентов на публикации, «Поделиться» стори (п.15) … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-27 | ✓ |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-27 | ⚠ 10 коммит(ов) в areas после сверки: 38c1a131 feat(make): публичные сториз и галерея компонентов на публикации, «Поделиться» стори (п.15) … |
