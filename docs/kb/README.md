...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-09-01 | ⚠ 50 коммит(ов) в areas после сверки: 991a960a feat(projects): persist task rework cycles … |
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-20 | ⚠ 264 коммит(ов) в areas после сверки: 991a960a feat(projects): persist task rework cycles … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-09-04 | ⚠ 22 коммит(ов) в areas после сверки: 991a960a feat(projects): persist task rework cycles … |
...
| [features/feature-preview.md](features/feature-preview.md) | Feature-preview окружения задач | 2026-08-28 | ⚠ 113 коммит(ов) в areas после сверки: 991a960a feat(projects): persist task rework cycles … |
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 61 коммит(ов) в areas после сверки: 991a960a feat(projects): persist task rework cycles … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 236 коммит(ов) в areas после сверки: 991a960a feat(projects): persist task rework cycles … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-05 | ⚠ 27 коммит(ов) в areas после сверки: 991a960a feat(projects): persist task rework cycles … |
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 259 коммит(ов) в areas после сверки: 991a960a feat(projects): persist task rework cycles … |
...
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-09-06 | ⚠ 1 коммит(ов) в areas после сверки: 991a960a feat(projects): persist task rework cycles |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-09-03 | ⚠ 59 коммит(ов) в areas после сверки: 991a960a feat(projects): persist task rework cycles … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-06 | ⚠ 3 коммит(ов) в areas после сверки: 991a960a feat(projects): persist task rework cycles … |
