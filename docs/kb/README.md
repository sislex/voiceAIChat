...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1637 коммит(ов) в areas после сверки: 95969de2 feat(deploy): fence detached source recovery and pinned storage … |
...
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-23 | ⚠ 4 коммит(ов) в areas после сверки: 95969de2 feat(deploy): fence detached source recovery and pinned storage … |
...
| [testing-operations.md](testing-operations.md) | Разработка, тестирование, диагностика и эксплуатация | 2026-09-23 | ⚠ 6 коммит(ов) в areas после сверки: 95969de2 feat(deploy): fence detached source recovery and pinned storage … |
