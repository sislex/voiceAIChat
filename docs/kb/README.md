...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 51 коммит(ов) в areas после сверки: 0574ce01 feat(make): проверка доступности превью axe-core с исправлением через ассистента (п.13) … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 654 коммит(ов) в areas после сверки: 0574ce01 feat(make): проверка доступности превью axe-core с исправлением через ассистента (п.13) … |
...
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-25 | ⚠ 42 коммит(ов) в areas после сверки: 0574ce01 feat(make): проверка доступности превью axe-core с исправлением через ассистента (п.13) … |
