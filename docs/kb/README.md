...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 131 коммит(ов) в areas после сверки: b865b51c feat(machines): уровень доступа участников к машине проекта — полный или только чтение (roadmap п.18) … |
| [features/feature-preview.md](features/feature-preview.md) | Feature-preview окружения задач | 2026-08-23 | ⚠ 43 коммит(ов) в areas после сверки: b865b51c feat(machines): уровень доступа участников к машине проекта — полный или только чтение (roadmap п.18) … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-28 | ⚠ 9 коммит(ов) в areas после сверки: b865b51c feat(machines): уровень доступа участников к машине проекта — полный или только чтение (roadmap п.18) … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-27 | ⚠ 20 коммит(ов) в areas после сверки: b865b51c feat(machines): уровень доступа участников к машине проекта — полный или только чтение (roadmap п.18) … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-28 | ⚠ 1 коммит(ов) в areas после сверки: b865b51c feat(machines): уровень доступа участников к машине проекта — полный или только чтение (roadmap п.18) |
