...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-09-10 | ⚠ 38 коммит(ов) в areas после сверки: c9e1e35d feat(playwright-reader): assemble a check report for the task (cycle 13) … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-09-13 | ⚠ 16 коммит(ов) в areas после сверки: c9e1e35d feat(playwright-reader): assemble a check report for the task (cycle 13) … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1468 коммит(ов) в areas после сверки: c9e1e35d feat(playwright-reader): assemble a check report for the task (cycle 13) … |
...
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 350 коммит(ов) в areas после сверки: c9e1e35d feat(playwright-reader): assemble a check report for the task (cycle 13) … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-13 | ⚠ 25 коммит(ов) в areas после сверки: c9e1e35d feat(playwright-reader): assemble a check report for the task (cycle 13) … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-09-15 | ⚠ 9 коммит(ов) в areas после сверки: c9e1e35d feat(playwright-reader): assemble a check report for the task (cycle 13) … |
...
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-09-11 | ⚠ 38 коммит(ов) в areas после сверки: c9e1e35d feat(playwright-reader): assemble a check report for the task (cycle 13) … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-15 | ⚠ 96 коммит(ов) в areas после сверки: c9e1e35d feat(playwright-reader): assemble a check report for the task (cycle 13) … |
