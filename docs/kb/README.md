...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-28 | ⚠ 1 коммит(ов) в areas после сверки: e3cb7fa4 feat(machines): журнал команд машины — таблица, хук registry.onCommand, REST/CSV, панель на странице машин (roadmap п.4) |
