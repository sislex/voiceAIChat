...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-09-07 | ⚠ 1 коммит(ов) в areas после сверки: 69e52066 feat(db): Postgres как движок базы — адаптер pg, транслятор диалекта, схема из schema.ts, перенос данных |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1239 коммит(ов) в areas после сверки: 69e52066 feat(db): Postgres как движок базы — адаптер pg, транслятор диалекта, схема из schema.ts, перенос данных … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-09-07 | ⚠ 7 коммит(ов) в areas после сверки: 69e52066 feat(db): Postgres как движок базы — адаптер pg, транслятор диалекта, схема из schema.ts, перенос данных … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-07 | ⚠ 23 коммит(ов) в areas после сверки: 69e52066 feat(db): Postgres как движок базы — адаптер pg, транслятор диалекта, схема из schema.ts, перенос данных … |
...
- [2026-09-07-alexeys-macbook-air-2-db-postgres-round3.md](log/2026-09-07-alexeys-macbook-air-2-db-postgres-round3.md) — db-postgres-round3
