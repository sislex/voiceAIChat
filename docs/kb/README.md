...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-09-13 | ⚠ 32 коммит(ов) в areas после сверки: d486b032 Merge main into CHAT-476 (task 41f084dc-558e-46a5-bde5-3ce03c4e9914) … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-16 | ⚠ 5 коммит(ов) в areas после сверки: d486b032 Merge main into CHAT-476 (task 41f084dc-558e-46a5-bde5-3ce03c4e9914) … |
...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 197 коммит(ов) в areas после сверки: d486b032 Merge main into CHAT-476 (task 41f084dc-558e-46a5-bde5-3ce03c4e9914) … |
...
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-09-15 | ⚠ 11 коммит(ов) в areas после сверки: d486b032 Merge main into CHAT-476 (task 41f084dc-558e-46a5-bde5-3ce03c4e9914) … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1528 коммит(ов) в areas после сверки: d486b032 Merge main into CHAT-476 (task 41f084dc-558e-46a5-bde5-3ce03c4e9914) … |
...
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-12 | ⚠ 55 коммит(ов) в areas после сверки: d486b032 Merge main into CHAT-476 (task 41f084dc-558e-46a5-bde5-3ce03c4e9914) … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-16 | ⚠ 5 коммит(ов) в areas после сверки: d486b032 Merge main into CHAT-476 (task 41f084dc-558e-46a5-bde5-3ce03c4e9914) … |
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 366 коммит(ов) в areas после сверки: d486b032 Merge main into CHAT-476 (task 41f084dc-558e-46a5-bde5-3ce03c4e9914) … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-09-14 | ⚠ 28 коммит(ов) в areas после сверки: d486b032 Merge main into CHAT-476 (task 41f084dc-558e-46a5-bde5-3ce03c4e9914) … |
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-16 | ⚠ 9 коммит(ов) в areas после сверки: d486b032 Merge main into CHAT-476 (task 41f084dc-558e-46a5-bde5-3ce03c4e9914) … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-15 | ⚠ 32 коммит(ов) в areas после сверки: d486b032 Merge main into CHAT-476 (task 41f084dc-558e-46a5-bde5-3ce03c4e9914) … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-09-15 | ⚠ 21 коммит(ов) в areas после сверки: d486b032 Merge main into CHAT-476 (task 41f084dc-558e-46a5-bde5-3ce03c4e9914) … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-09-11 | ⚠ 74 коммит(ов) в areas после сверки: d486b032 Merge main into CHAT-476 (task 41f084dc-558e-46a5-bde5-3ce03c4e9914) … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-16 | ⚠ 6 коммит(ов) в areas после сверки: d486b032 Merge main into CHAT-476 (task 41f084dc-558e-46a5-bde5-3ce03c4e9914) … |
