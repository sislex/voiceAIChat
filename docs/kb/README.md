...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-12 | ⚠ 71 коммит(ов) в areas после сверки: b5d92e42 feat(releases): Release Center improvement cycle 7 — deep links, log reading, remembered mode … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-09-12 | ⚠ 1 коммит(ов) в areas после сверки: d9864647 fix(llm-runner): keep silent CLI response streams alive |
