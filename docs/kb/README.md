...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-09 | ⚠ 50 коммит(ов) в areas после сверки: c9c83160 feat(kanban): add detailed assignee filter … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1382 коммит(ов) в areas после сверки: c9c83160 feat(kanban): add detailed assignee filter … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-09-11 | ⚠ 23 коммит(ов) в areas после сверки: c9c83160 feat(kanban): add detailed assignee filter … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-11 | ⚠ 14 коммит(ов) в areas после сверки: c9c83160 feat(kanban): add detailed assignee filter … |
