...
|---|---|---|---|
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-01 | ⚠ 44 коммит(ов) в areas после сверки: 17679ee fix: выпуск preview-cookie из Bearer для восстановленных сессий … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-08 | ⚠ 7 коммит(ов) в areas после сверки: 17679ee fix: выпуск preview-cookie из Bearer для восстановленных сессий … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 132 коммит(ов) в areas после сверки: 17679ee fix: выпуск preview-cookie из Bearer для восстановленных сессий … |
...
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-08 | ✓ |
