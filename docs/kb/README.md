...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-08 | ⚠ 2 коммит(ов) в areas после сверки: a499867 chatai-150: показывать коммит и задачу в версии … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 149 коммит(ов) в areas после сверки: 7492fde chatai-149: работа CI-рана … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-08 | ⚠ 1 коммит(ов) в areas после сверки: a499867 chatai-150: показывать коммит и задачу в версии |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-08 | ⚠ 6 коммит(ов) в areas после сверки: a499867 chatai-150: показывать коммит и задачу в версии … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-08 | ⚠ 5 коммит(ов) в areas после сверки: a499867 chatai-150: показывать коммит и задачу в версии … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-08 | ⚠ 6 коммит(ов) в areas после сверки: a499867 chatai-150: показывать коммит и задачу в версии … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-08 | ⚠ 2 коммит(ов) в areas после сверки: a499867 chatai-150: показывать коммит и задачу в версии … |
