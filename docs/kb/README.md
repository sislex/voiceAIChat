...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 205 коммит(ов) в areas после сверки: d3821f2 fix: make release gates and deploy restart-safe … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-11 | ⚠ 6 коммит(ов) в areas после сверки: d3821f2 fix: make release gates and deploy restart-safe … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-08 | ⚠ 28 коммит(ов) в areas после сверки: d3821f2 fix: make release gates and deploy restart-safe … |
