...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 47 коммит(ов) в areas после сверки: 17ccbe80 feat(make): inline-команда ассистенту по выделению в редакторе — Cmd/Ctrl+I (п.6) … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 649 коммит(ов) в areas после сверки: 17ccbe80 feat(make): inline-команда ассистенту по выделению в редакторе — Cmd/Ctrl+I (п.6) … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-20 | ⚠ 111 коммит(ов) в areas после сверки: 17ccbe80 feat(make): inline-команда ассистенту по выделению в редакторе — Cmd/Ctrl+I (п.6) … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-25 | ⚠ 38 коммит(ов) в areas после сверки: 17ccbe80 feat(make): inline-команда ассистенту по выделению в редакторе — Cmd/Ctrl+I (п.6) … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-25 | ⚠ 37 коммит(ов) в areas после сверки: 17ccbe80 feat(make): inline-команда ассистенту по выделению в редакторе — Cmd/Ctrl+I (п.6) … |
...
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-27 | ⚠ 8 коммит(ов) в areas после сверки: fd195bb9 feat(make): поиск и замена по всему проекту со снимком перед заменой (п.1) … |
