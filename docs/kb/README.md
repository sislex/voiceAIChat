...
|---|---|---|---|
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-01 | ⚠ 38 коммит(ов) в areas после сверки: 8f12df0 CHAT-134: параллельный запуск и распределение тасков по машинам … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 117 коммит(ов) в areas после сверки: 8f12df0 CHAT-134: параллельный запуск и распределение тасков по машинам … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-07 | ⚠ 3 коммит(ов) в areas после сверки: 8f12df0 CHAT-134: параллельный запуск и распределение тасков по машинам … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-05 | ⚠ 17 коммит(ов) в areas после сверки: 8f12df0 CHAT-134: параллельный запуск и распределение тасков по машинам … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-06 | ⚠ 12 коммит(ов) в areas после сверки: 8f12df0 CHAT-134: параллельный запуск и распределение тасков по машинам … |
