...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-09-01 | ⚠ 104 коммит(ов) в areas после сверки: 181c142e feat(qa): improve stage panels and snapshot retries … |
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-09-10 | ⚠ 13 коммит(ов) в areas после сверки: 181c142e feat(qa): improve stage panels and snapshot retries … |
| [clients.md](clients.md) | Клиенты и упаковка: web, desktop и agent-tray | 2026-09-07 | ⚠ 35 коммит(ов) в areas после сверки: 181c142e feat(qa): improve stage panels and snapshot retries … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-12 | ⚠ 7 коммит(ов) в areas после сверки: 181c142e feat(qa): improve stage panels and snapshot retries … |
...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 156 коммит(ов) в areas после сверки: 181c142e feat(qa): improve stage panels and snapshot retries … |
...
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-09-04 | ⚠ 111 коммит(ов) в areas после сверки: 181c142e feat(qa): improve stage panels and snapshot retries … |
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-09-10 | ⚠ 24 коммит(ов) в areas после сверки: 181c142e feat(qa): improve stage panels and snapshot retries … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1421 коммит(ов) в areas после сверки: 181c142e feat(qa): improve stage panels and snapshot retries … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-09-13 | ✓ |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-12 | ⚠ 11 коммит(ов) в areas после сверки: 181c142e feat(qa): improve stage panels and snapshot retries … |
| [features/task-autopilot.md](features/task-autopilot.md) | Автопроход задачи по QA-конвейеру | 2026-09-11 | ⚠ 27 коммит(ов) в areas после сверки: 181c142e feat(qa): improve stage panels and snapshot retries … |
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-13 | ✓ |
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 324 коммит(ов) в areas после сверки: 181c142e feat(qa): improve stage panels and snapshot retries … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-13 | ⚠ 1 коммит(ов) в areas после сверки: 181c142e feat(qa): improve stage panels and snapshot retries |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-13 | ⚠ 5 коммит(ов) в areas после сверки: 181c142e feat(qa): improve stage panels and snapshot retries … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-09-10 | ⚠ 11 коммит(ов) в areas после сверки: 181c142e feat(qa): improve stage panels and snapshot retries … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-09-12 | ⚠ 17 коммит(ов) в areas после сверки: 181c142e feat(qa): improve stage panels and snapshot retries … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-09-11 | ⚠ 10 коммит(ов) в areas после сверки: 181c142e feat(qa): improve stage panels and snapshot retries … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-13 | ⚠ 3 коммит(ов) в areas после сверки: 181c142e feat(qa): improve stage panels and snapshot retries … |
