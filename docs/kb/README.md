...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-09-01 | ⚠ 23 коммит(ов) в areas после сверки: c112bf21 feat: студия картинок — итерация улучшений 10 (вьюер и навигация) … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-03 | ⚠ 8 коммит(ов) в areas после сверки: c112bf21 feat: студия картинок — итерация улучшений 10 (вьюер и навигация) … |
...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 12 коммит(ов) в areas после сверки: c112bf21 feat: студия картинок — итерация улучшений 10 (вьюер и навигация) … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-02 | ⚠ 28 коммит(ов) в areas после сверки: c112bf21 feat: студия картинок — итерация улучшений 10 (вьюер и навигация) … |
