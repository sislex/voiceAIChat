...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-09-10 | ⚠ 34 коммит(ов) в areas после сверки: 99d28cc1 feat(reader): круг 11 — замечать изменения, заканчивать шаг одним ходом … |
...
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-09-12 | ⚠ 15 коммит(ов) в areas после сверки: 99d28cc1 feat(reader): круг 11 — замечать изменения, заканчивать шаг одним ходом … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1464 коммит(ов) в areas после сверки: 99d28cc1 feat(reader): круг 11 — замечать изменения, заканчивать шаг одним ходом … |
...
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-09-11 | ⚠ 35 коммит(ов) в areas после сверки: 99d28cc1 feat(reader): круг 11 — замечать изменения, заканчивать шаг одним ходом … |
