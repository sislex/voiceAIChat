...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-06 | ⚠ 1 коммит(ов) в areas после сверки: f3efb89 feat(ui): add personal LLM access controls |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 80 коммит(ов) в areas после сверки: f3efb89 feat(ui): add personal LLM access controls … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-06 | ⚠ 2 коммит(ов) в areas после сверки: f3efb89 feat(ui): add personal LLM access controls … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-05 | ⚠ 13 коммит(ов) в areas после сверки: f60fcc9 feat: add personal LLM model access controls … |
