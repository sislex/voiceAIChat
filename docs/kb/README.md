...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-09-10 | ⚠ 7 коммит(ов) в areas после сверки: 32e584db feat(playwright-reader): reach the content and search the page (cycle 3) … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-09-10 | ⚠ 23 коммит(ов) в areas после сверки: 32e584db feat(playwright-reader): reach the content and search the page (cycle 3) … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1350 коммит(ов) в areas после сверки: 32e584db feat(playwright-reader): reach the content and search the page (cycle 3) … |
...
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 322 коммит(ов) в areas после сверки: 32e584db feat(playwright-reader): reach the content and search the page (cycle 3) … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-10 | ⚠ 7 коммит(ов) в areas после сверки: 32e584db feat(playwright-reader): reach the content and search the page (cycle 3) … |
...
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-09-11 | ⚠ 10 коммит(ов) в areas после сверки: 32e584db feat(playwright-reader): reach the content and search the page (cycle 3) … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-15 | ⚠ 1 коммит(ов) в areas после сверки: 32e584db feat(playwright-reader): reach the content and search the page (cycle 3) |
