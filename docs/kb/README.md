...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 619 коммит(ов) в areas после сверки: 43994ac8 feat(turns): вырезать блоки выключенных инструкций из ответа модели … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-08-26 | ⚠ 1 коммит(ов) в areas после сверки: 43994ac8 feat(turns): вырезать блоки выключенных инструкций из ответа модели |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-25 | ⚠ 10 коммит(ов) в areas после сверки: 43994ac8 feat(turns): вырезать блоки выключенных инструкций из ответа модели … |
