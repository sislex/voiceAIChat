...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-09 | ⚠ 46 коммит(ов) в areas после сверки: 715707f6 feat(kanban): improve swimlane controls … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1378 коммит(ов) в areas после сверки: 715707f6 feat(kanban): improve swimlane controls … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-09-11 | ⚠ 19 коммит(ов) в areas после сверки: 715707f6 feat(kanban): improve swimlane controls … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-10 | ⚠ 22 коммит(ов) в areas после сверки: 715707f6 feat(kanban): improve swimlane controls … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-11 | ⚠ 10 коммит(ов) в areas после сверки: 715707f6 feat(kanban): improve swimlane controls … |
