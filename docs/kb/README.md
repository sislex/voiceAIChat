...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 46 коммит(ов) в areas после сверки: d165b540 feat(make): перенос файлов между папками дерева перетаскиванием (п.5) … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 648 коммит(ов) в areas после сверки: d165b540 feat(make): перенос файлов между папками дерева перетаскиванием (п.5) … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-20 | ⚠ 110 коммит(ов) в areas после сверки: d165b540 feat(make): перенос файлов между папками дерева перетаскиванием (п.5) … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-25 | ⚠ 37 коммит(ов) в areas после сверки: d165b540 feat(make): перенос файлов между папками дерева перетаскиванием (п.5) … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-25 | ⚠ 36 коммит(ов) в areas после сверки: d165b540 feat(make): перенос файлов между папками дерева перетаскиванием (п.5) … |
