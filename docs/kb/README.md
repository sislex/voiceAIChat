...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-12 | ⚠ 3 коммит(ов) в areas после сверки: 67a2e6d Merge CHAT-178 … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-12 | ⚠ 5 коммит(ов) в areas после сверки: 26f5477 fix: дождаться завершения production deploy … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 225 коммит(ов) в areas после сверки: b6fd564 chatai-180: работа CI-рана … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-12 | ⚠ 2 коммит(ов) в areas после сверки: af254ac CHAT-180 expand desktop composer by default … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-11 | ⚠ 11 коммит(ов) в areas после сверки: af254ac CHAT-180 expand desktop composer by default … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-12 | ⚠ 4 коммит(ов) в areas после сверки: 26f5477 fix: дождаться завершения production deploy … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-12 | ⚠ 7 коммит(ов) в areas после сверки: af254ac CHAT-180 expand desktop composer by default … |
