...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-09-09 | ⚠ 6 коммит(ов) в areas после сверки: b5e6fe3a fix(reader): wait for actual page and form readiness … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-10 | ⚠ 6 коммит(ов) в areas после сверки: b5e6fe3a fix(reader): wait for actual page and form readiness … |
