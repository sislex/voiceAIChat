...
|---|---|---|---|
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-01 | ⚠ 69 коммит(ов) в areas после сверки: 31c5e8b feat: execute merge runs with realtime feed … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-06 | ⚠ 32 коммит(ов) в areas после сверки: 31c5e8b feat: execute merge runs with realtime feed … |
...
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-08-10 | ⚠ 9 коммит(ов) в areas после сверки: 31c5e8b feat: execute merge runs with realtime feed … |
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-12 | ✓ |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 215 коммит(ов) в areas после сверки: 31c5e8b feat: execute merge runs with realtime feed … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-12 | ⚠ 3 коммит(ов) в areas после сверки: 31c5e8b feat: execute merge runs with realtime feed … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-11 | ⚠ 6 коммит(ов) в areas после сверки: 31c5e8b feat: execute merge runs with realtime feed … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-08 | ⚠ 22 коммит(ов) в areas после сверки: 31c5e8b feat: execute merge runs with realtime feed … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-08 | ⚠ 35 коммит(ов) в areas после сверки: 31c5e8b feat: execute merge runs with realtime feed … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-10 | ⚠ 14 коммит(ов) в areas после сверки: 31c5e8b feat: execute merge runs with realtime feed … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-10 | ⚠ 15 коммит(ов) в areas после сверки: 31c5e8b feat: execute merge runs with realtime feed … |
