...
|---|---|---|---|
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-01 | ⚠ 89 коммит(ов) в areas после сверки: 9c8c654 CHAT-199 reset knowledge usage badge on view … |
...
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-08-13 | ⚠ 4 коммит(ов) в areas после сверки: 9c8c654 CHAT-199 reset knowledge usage badge on view … |
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-13 | ⚠ 4 коммит(ов) в areas после сверки: b2cbff8 Merge task cee5d25d-d7fb-4a17-9c93-a997cdc3d515 … |
...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-13 | ⚠ 1 коммит(ов) в areas после сверки: 259286a Merge task 11e2269b-d8c0-4567-89d1-9b44a6b7cae9 |
...
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-08-13 | ⚠ 2 коммит(ов) в areas после сверки: 9c8c654 CHAT-199 reset knowledge usage badge on view … |
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-13 | ⚠ 1 коммит(ов) в areas после сверки: 2f79b67 Merge task 2bf0d0e9-5795-43e5-99b1-a763bcb6b999 |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 287 коммит(ов) в areas после сверки: b2cbff8 Merge task cee5d25d-d7fb-4a17-9c93-a997cdc3d515 … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-13 | ⚠ 6 коммит(ов) в areas после сверки: b2cbff8 Merge task cee5d25d-d7fb-4a17-9c93-a997cdc3d515 … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-12 | ⚠ 18 коммит(ов) в areas после сверки: 9c8c654 CHAT-199 reset knowledge usage badge on view … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-13 | ⚠ 21 коммит(ов) в areas после сверки: b2cbff8 Merge task cee5d25d-d7fb-4a17-9c93-a997cdc3d515 … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-12 | ⚠ 18 коммит(ов) в areas после сверки: 9c8c654 CHAT-199 reset knowledge usage badge on view … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-08 | ⚠ 82 коммит(ов) в areas после сверки: 2f79b67 Merge task 2bf0d0e9-5795-43e5-99b1-a763bcb6b999 … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-10 | ⚠ 37 коммит(ов) в areas после сверки: 9c8c654 CHAT-199 reset knowledge usage badge on view … |
...
- [2026-08-13-alexeys-macbook-air-2-kb-usage-unread-badge.md](log/2026-08-13-alexeys-macbook-air-2-kb-usage-unread-badge.md) — kb-usage-unread-badge
