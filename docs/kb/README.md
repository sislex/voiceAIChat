...
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-09-09 | ⚠ 1 коммит(ов) в areas после сверки: 6d90d29b fix(reader): parse HTML resources reliably (cycle 01/20) |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1291 коммит(ов) в areas после сверки: 6d90d29b fix(reader): parse HTML resources reliably (cycle 01/20) … |
...
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-09-09 | ⚠ 4 коммит(ов) в areas после сверки: 6d90d29b fix(reader): parse HTML resources reliably (cycle 01/20) … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-10 | ⚠ 1 коммит(ов) в areas после сверки: 6d90d29b fix(reader): parse HTML resources reliably (cycle 01/20) |
