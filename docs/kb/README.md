...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-02 | ✓ |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-01 | ⚠ 13 коммит(ов) в areas после сверки: 259877e fix(kb): авто-инъекция не молчит на кодовых описаниях задач … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-02 | ✓ |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-01 | ⚠ 23 коммит(ов) в areas после сверки: 259877e fix(kb): авто-инъекция не молчит на кодовых описаниях задач … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-02 | ⚠ 2 коммит(ов) в areas после сверки: 259877e fix(kb): авто-инъекция не молчит на кодовых описаниях задач … |
| [stt-tts.md](stt-tts.md) | Речь: Whisper (STT) и Piper/say (TTS) | 2026-07-26 | ✓ |
| [testing-operations.md](testing-operations.md) | Разработка, тестирование, диагностика и эксплуатация | 2026-08-02 | ✓ |
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-02 | ⚠ 1 коммит(ов) в areas после сверки: 259877e fix(kb): авто-инъекция не молчит на кодовых описаниях задач |
