...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-09-01 | ⚠ 16 коммит(ов) в areas после сверки: 0a7acd40 Merge remote-tracking branch 'origin/main' into feat/kanban-assistant-template … |
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-20 | ⚠ 224 коммит(ов) в areas после сверки: c9caced5 Merge remote-tracking branch 'origin/main' into feat/make-project-sync … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1077 коммит(ов) в areas после сверки: 0a7acd40 Merge remote-tracking branch 'origin/main' into feat/kanban-assistant-template … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-02 | ⚠ 4 коммит(ов) в areas после сверки: 0a7acd40 Merge remote-tracking branch 'origin/main' into feat/kanban-assistant-template … |
...
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-09-02 | ⚠ 4 коммит(ов) в areas после сверки: c9caced5 Merge remote-tracking branch 'origin/main' into feat/make-project-sync … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-31 | ⚠ 90 коммит(ов) в areas после сверки: c9caced5 Merge remote-tracking branch 'origin/main' into feat/make-project-sync … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-30 | ⚠ 95 коммит(ов) в areas после сверки: c9caced5 Merge remote-tracking branch 'origin/main' into feat/make-project-sync … |
| [stt-runner.md](stt-runner.md) | STT Runner: внутренний протокол, ресурсы и lifecycle | 2026-08-20 | ⚠ 136 коммит(ов) в areas после сверки: c9caced5 Merge remote-tracking branch 'origin/main' into feat/make-project-sync … |
...
| [tts-runner.md](tts-runner.md) | TTS Runner: ресурсный API, движки и жизненный цикл WAV | 2026-08-26 | ⚠ 88 коммит(ов) в areas после сверки: c9caced5 Merge remote-tracking branch 'origin/main' into feat/make-project-sync … |
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-02 | ⚠ 11 коммит(ов) в areas после сверки: 0a7acd40 Merge remote-tracking branch 'origin/main' into feat/kanban-assistant-template … |
