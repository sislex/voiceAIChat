...
|---|---|---|---|
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-07-27 | ⚠ 5 коммит(ов) в areas после сверки: f4364e2 feat(projects): канбан-доска в стиле Jira … |
| [clients.md](clients.md) | Клиенты и упаковка: web, desktop и agent-tray | 2026-07-27 | ⚠ 1 коммит(ов) в areas после сверки: 28786c6 fix(desktop): объявить window.board в preload d.ts — чинит typecheck:desktop |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-07-27 | ⚠ 1 коммит(ов) в areas после сверки: d5581ee feat(ui): Storybook для канбана, утилиты-страницы, сайдбар «Чаты | Проекты» |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-07-28 | ⚠ 8 коммит(ов) в areas после сверки: 725b419 feat(ui): авто-редирект на последний проект; убрать «Проекты» из меню … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-07-29 | ✓ |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-07-27 | ⚠ 10 коммит(ов) в areas после сверки: f4364e2 feat(projects): канбан-доска в стиле Jira … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-07-27 | ⚠ 3 коммит(ов) в areas после сверки: f4364e2 feat(projects): канбан-доска в стиле Jira … |
| [stt-tts.md](stt-tts.md) | Речь: Whisper (STT) и Piper/say (TTS) | 2026-07-26 | ✓ |
| [testing-operations.md](testing-operations.md) | Разработка, тестирование, диагностика и эксплуатация | 2026-07-27 | ✓ |
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-07-29 | ✓ |
