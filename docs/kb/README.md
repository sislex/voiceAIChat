...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 216 коммит(ов) в areas после сверки: 585833c chatai-176: работа CI-рана … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-11 | ⚠ 6 коммит(ов) в areas после сверки: a3fa860 CHAT-176 Разнести настройки карточки по вкладкам … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-10 | ⚠ 15 коммит(ов) в areas после сверки: a3fa860 CHAT-176 Разнести настройки карточки по вкладкам … |
