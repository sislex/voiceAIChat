...
|---|---|---|---|
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-16 | ✓ |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-17 | ✓ |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-17 | ⚠ 1 коммит(ов) в areas после сверки: 0f95bf9 refactor(ui): split global voiceStore into domain stores with AppRuntime |
| [features/feature-preview.md](features/feature-preview.md) | Feature-preview окружения задач | 2026-08-17 | ✓ |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-16 | ⚠ 1 коммит(ов) в areas после сверки: 0f95bf9 refactor(ui): split global voiceStore into domain stores with AppRuntime |
...
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-08-16 | ⚠ 1 коммит(ов) в areas после сверки: 0f95bf9 refactor(ui): split global voiceStore into domain stores with AppRuntime |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 366 коммит(ов) в areas после сверки: 0f95bf9 refactor(ui): split global voiceStore into domain stores with AppRuntime … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-16 | ✓ |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-16 | ⚠ 1 коммит(ов) в areas после сверки: 0f95bf9 refactor(ui): split global voiceStore into domain stores with AppRuntime |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-17 | ⚠ 1 коммит(ов) в areas после сверки: 0f95bf9 refactor(ui): split global voiceStore into domain stores with AppRuntime |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-17 | ⚠ 1 коммит(ов) в areas после сверки: 0f95bf9 refactor(ui): split global voiceStore into domain stores with AppRuntime |
| [usage/chatai-basics.md](usage/chatai-basics.md) | Как пользоваться ChatAI | 2026-08-01 | ⚠ код изменён 2026-08-16, сверка 2026-08-01 (по датам: правки того же дня не видны — поставь checked) |
