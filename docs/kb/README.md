...
| [features/feature-preview.md](features/feature-preview.md) | Feature-preview окружения задач | 2026-09-13 | ⚠ 16 коммит(ов) в areas после сверки: 7d8ad812 refactor: extract Agent and Desktop into independent repositories … |
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 221 коммит(ов) в areas после сверки: 7d8ad812 refactor: extract Agent and Desktop into independent repositories … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 377 коммит(ов) в areas после сверки: 7d8ad812 refactor: extract Agent and Desktop into independent repositories … |
...
| [kb-workflow.md](kb-workflow.md) | Как устроена и ведётся база знаний | 2026-08-31 | ⚠ 38 коммит(ов) в areas после сверки: 7d8ad812 refactor: extract Agent and Desktop into independent repositories … |
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-09-22 | ⚠ 2 коммит(ов) в areas после сверки: 7d8ad812 refactor: extract Agent and Desktop into independent repositories … |
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-22 | ⚠ 1 коммит(ов) в areas после сверки: 7d8ad812 refactor: extract Agent and Desktop into independent repositories |
| [operations-app.md](operations-app.md) | Frontend-модуль Operations: граница, store и подключение | 2026-08-19 | ⚠ 274 коммит(ов) в areas после сверки: 7d8ad812 refactor: extract Agent and Desktop into independent repositories … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-17 | ⚠ 8 коммит(ов) в areas после сверки: 7d8ad812 refactor: extract Agent and Desktop into independent repositories … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-09-17 | ⚠ 15 коммит(ов) в areas после сверки: 7d8ad812 refactor: extract Agent and Desktop into independent repositories … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-09-22 | ⚠ 5 коммит(ов) в areas после сверки: 7d8ad812 refactor: extract Agent and Desktop into independent repositories … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-09-20 | ⚠ 7 коммит(ов) в areas после сверки: 7d8ad812 refactor: extract Agent and Desktop into independent repositories … |
| [stt-runner.md](stt-runner.md) | STT Runner: внутренний протокол, ресурсы и lifecycle | 2026-08-20 | ⚠ 217 коммит(ов) в areas после сверки: 7d8ad812 refactor: extract Agent and Desktop into independent repositories … |
