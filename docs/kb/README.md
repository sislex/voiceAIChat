...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-08-19 | ⚠ 46 коммит(ов) в areas после сверки: a11f9ac2 feat(chat): make message submission feedback immediate … |
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-20 | ⚠ 59 коммит(ов) в areas после сверки: 92e42b00 feat(playwright-reader): связка панели с browser-runner (оркестрация + Chromium) … |
...
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-08-25 | ⚠ 2 коммит(ов) в areas после сверки: a11f9ac2 feat(chat): make message submission feedback immediate … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 601 коммит(ов) в areas после сверки: dc38cd8d fix(prod): persist managed checkout path … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-08-23 | ⚠ 14 коммит(ов) в areas после сверки: 92e42b00 feat(playwright-reader): связка панели с browser-runner (оркестрация + Chromium) … |
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-25 | ⚠ 4 коммит(ов) в areas после сверки: a11f9ac2 feat(chat): make message submission feedback immediate … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-24 | ⚠ 22 коммит(ов) в areas после сверки: a11f9ac2 feat(chat): make message submission feedback immediate … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-25 | ⚠ 1 коммит(ов) в areas после сверки: 92e42b00 feat(playwright-reader): связка панели с browser-runner (оркестрация + Chromium) |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-25 | ⚠ 4 коммит(ов) в areas после сверки: dc38cd8d fix(prod): persist managed checkout path … |
...
- [2026-08-25-alexeys-macbook-air-2-playwright-reader-runner-wiring.md](log/2026-08-25-alexeys-macbook-air-2-playwright-reader-runner-wiring.md) — playwright-reader-runner-wiring
