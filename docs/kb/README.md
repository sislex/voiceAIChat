...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-06 | ⚠ 3 коммит(ов) в areas после сверки: 5ab5f210 perf(chats): кэш стоимости беседы и списки разделов по требованию … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-06 | ⚠ 1 коммит(ов) в areas после сверки: 5ab5f210 perf(chats): кэш стоимости беседы и списки разделов по требованию |
