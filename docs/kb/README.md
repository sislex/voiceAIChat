...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-16 | ⚠ 9 коммит(ов) в areas после сверки: 5b48daf9 Merge main into CHAT-482 (task 4406e522-009a-4ebe-8bde-4e3b7c71be1b) … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-09-14 | ⚠ 31 коммит(ов) в areas после сверки: 5b48daf9 Merge main into CHAT-482 (task 4406e522-009a-4ebe-8bde-4e3b7c71be1b) … |
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-16 | ⚠ 2 коммит(ов) в areas после сверки: 5b48daf9 Merge main into CHAT-482 (task 4406e522-009a-4ebe-8bde-4e3b7c71be1b) … |
