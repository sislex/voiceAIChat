...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-07-30 | ⚠ 4 коммит(ов) в areas после сверки: 8e103de feat(ci): мерж без пересборки прода заводит автозадачу «Пересборка прода» … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-07-31 | ⚠ 1 коммит(ов) в areas после сверки: 8e103de feat(ci): мерж без пересборки прода заводит автозадачу «Пересборка прода» |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-07-31 | ⚠ 3 коммит(ов) в areas после сверки: 8e103de feat(ci): мерж без пересборки прода заводит автозадачу «Пересборка прода» … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-07-27 | ⚠ 40 коммит(ов) в areas после сверки: 8e103de feat(ci): мерж без пересборки прода заводит автозадачу «Пересборка прода» … |
