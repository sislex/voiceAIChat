...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-20 | ⚠ 281 коммит(ов) в areas после сверки: 399e57aa Merge main into CHAT-423 (task d21dcb8a-a342-4fc1-91d1-685f2c01c439) … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-06 | ⚠ 31 коммит(ов) в areas после сверки: 10665c2b Merge main into CHAT-421 (task 127849dd-93d5-4145-9f73-7005da497446) … |
...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 90 коммит(ов) в areas после сверки: 10665c2b Merge main into CHAT-421 (task 127849dd-93d5-4145-9f73-7005da497446) … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 263 коммит(ов) в areas после сверки: 10665c2b Merge main into CHAT-421 (task 127849dd-93d5-4145-9f73-7005da497446) … |
...
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-09-04 | ⚠ 52 коммит(ов) в areas после сверки: 10665c2b Merge main into CHAT-421 (task 127849dd-93d5-4145-9f73-7005da497446) … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1243 коммит(ов) в areas после сверки: 10665c2b Merge main into CHAT-421 (task 127849dd-93d5-4145-9f73-7005da497446) … |
...
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-05 | ⚠ 57 коммит(ов) в areas после сверки: 10665c2b Merge main into CHAT-421 (task 127849dd-93d5-4145-9f73-7005da497446) … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-05 | ⚠ 54 коммит(ов) в areas после сверки: 10665c2b Merge main into CHAT-421 (task 127849dd-93d5-4145-9f73-7005da497446) … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-07 | ⚠ 20 коммит(ов) в areas после сверки: 10665c2b Merge main into CHAT-421 (task 127849dd-93d5-4145-9f73-7005da497446) … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-07 | ⚠ 15 коммит(ов) в areas после сверки: 10665c2b Merge main into CHAT-421 (task 127849dd-93d5-4145-9f73-7005da497446) … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-09-07 | ⚠ 7 коммит(ов) в areas после сверки: 399e57aa Merge main into CHAT-423 (task d21dcb8a-a342-4fc1-91d1-685f2c01c439) … |
