...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-09-09 | ⚠ 5 коммит(ов) в areas после сверки: e139188d fix(reader): preserve SPA navigation and live page state (cycle 04/20) … |
...
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-09-09 | ⚠ 4 коммит(ов) в areas после сверки: e139188d fix(reader): preserve SPA navigation and live page state (cycle 04/20) … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1294 коммит(ов) в areas после сверки: e139188d fix(reader): preserve SPA navigation and live page state (cycle 04/20) … |
...
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-09-09 | ⚠ 7 коммит(ов) в areas после сверки: e139188d fix(reader): preserve SPA navigation and live page state (cycle 04/20) … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-10 | ⚠ 1 коммит(ов) в areas после сверки: e139188d fix(reader): preserve SPA navigation and live page state (cycle 04/20) |
