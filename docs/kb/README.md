...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 163 коммит(ов) в areas после сверки: 4f735e8f fix(ui): вернуть стили ленты и консоли, потерянные при слиянии CHAT-354 … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 802 коммит(ов) в areas после сверки: 4f735e8f fix(ui): вернуть стили ленты и консоли, потерянные при слиянии CHAT-354 … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-20 | ⚠ 207 коммит(ов) в areas после сверки: 4f735e8f fix(ui): вернуть стили ленты и консоли, потерянные при слиянии CHAT-354 … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-28 | ⚠ 61 коммит(ов) в areas после сверки: 4f735e8f fix(ui): вернуть стили ленты и консоли, потерянные при слиянии CHAT-354 … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-29 | ⚠ 8 коммит(ов) в areas после сверки: 4f735e8f fix(ui): вернуть стили ленты и консоли, потерянные при слиянии CHAT-354 … |
