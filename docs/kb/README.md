...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-08-18 | ⚠ 5 коммит(ов) в areas после сверки: 66d4da57 feat: add local AI image retouching … |
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-18 | ⚠ 10 коммит(ов) в areas после сверки: 66d4da57 feat: add local AI image retouching … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-19 | ⚠ 2 коммит(ов) в areas после сверки: e76af0f2 Merge task e037f5cc-65d7-4a43-92ff-6ad4f77d6ae9 … |
...
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-17 | ⚠ 21 коммит(ов) в areas после сверки: e76af0f2 Merge task e037f5cc-65d7-4a43-92ff-6ad4f77d6ae9 … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 450 коммит(ов) в areas после сверки: e76af0f2 Merge task e037f5cc-65d7-4a43-92ff-6ad4f77d6ae9 … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-16 | ⚠ 45 коммит(ов) в areas после сверки: e76af0f2 Merge task e037f5cc-65d7-4a43-92ff-6ad4f77d6ae9 … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-18 | ⚠ 8 коммит(ов) в areas после сверки: e76af0f2 Merge task e037f5cc-65d7-4a43-92ff-6ad4f77d6ae9 … |
