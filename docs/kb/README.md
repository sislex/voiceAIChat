...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-09-01 | ⚠ 34 коммит(ов) в areas после сверки: a3552856 feat: align device enrollment interfaces with Make project 2 … |
...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 201 коммит(ов) в areas после сверки: a3552856 feat: align device enrollment interfaces with Make project 2 … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-02 | ⚠ 40 коммит(ов) в areas после сверки: a3552856 feat: align device enrollment interfaces with Make project 2 … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-03 | ⚠ 2 коммит(ов) в areas после сверки: a3552856 feat: align device enrollment interfaces with Make project 2 … |
| [operations-app.md](operations-app.md) | Frontend-модуль Operations: граница, store и подключение | 2026-08-19 | ⚠ 190 коммит(ов) в areas после сверки: a3552856 feat: align device enrollment interfaces with Make project 2 … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-03 | ⚠ 27 коммит(ов) в areas после сверки: a3552856 feat: align device enrollment interfaces with Make project 2 … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-03 | ⚠ 1 коммит(ов) в areas после сверки: a3552856 feat: align device enrollment interfaces with Make project 2 |
