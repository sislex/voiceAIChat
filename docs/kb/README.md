...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 787 коммит(ов) в areas после сверки: bbe7762a fix(project-types): отказ по опубликованному типу объясняется вместо 404 … |
