...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-01 | ⚠ 20 коммит(ов) в areas после сверки: 9e4da0e chore(ci): увеличить лимиты гейта втрое … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 16 коммит(ов) в areas после сверки: 98f204f test(ci): учесть девять попыток fix-loop … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-01 | ⚠ 27 коммит(ов) в areas после сверки: 9e4da0e chore(ci): увеличить лимиты гейта втрое … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-02 | ⚠ 12 коммит(ов) в areas после сверки: e39fa65 feat(ci): проверять только затронутые пакеты … |
