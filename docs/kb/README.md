...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-20 | ⚠ 137 коммит(ов) в areas после сверки: b1380a6d Merge remote-tracking branch 'origin/main' … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-29 | ⚠ 5 коммит(ов) в areas после сверки: b1380a6d Merge remote-tracking branch 'origin/main' … |
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-08-29 | ✓ |
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 161 коммит(ов) в areas после сверки: b1380a6d Merge remote-tracking branch 'origin/main' … |
| [features/feature-preview.md](features/feature-preview.md) | Feature-preview окружения задач | 2026-08-28 | ⚠ 13 коммит(ов) в areas после сверки: b1380a6d Merge remote-tracking branch 'origin/main' … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 31 коммит(ов) в areas после сверки: b1380a6d Merge remote-tracking branch 'origin/main' … |
...
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-08-25 | ⚠ 97 коммит(ов) в areas после сверки: b1380a6d Merge remote-tracking branch 'origin/main' … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 800 коммит(ов) в areas после сверки: b1380a6d Merge remote-tracking branch 'origin/main' … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-20 | ⚠ 205 коммит(ов) в areas после сверки: b1380a6d Merge remote-tracking branch 'origin/main' … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-28 | ⚠ 59 коммит(ов) в areas после сверки: b1380a6d Merge remote-tracking branch 'origin/main' … |
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-08-28 | ⚠ 30 коммит(ов) в areas после сверки: b1380a6d Merge remote-tracking branch 'origin/main' … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-28 | ⚠ 31 коммит(ов) в areas после сверки: b1380a6d Merge remote-tracking branch 'origin/main' … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-29 | ⚠ 6 коммит(ов) в areas после сверки: b1380a6d Merge remote-tracking branch 'origin/main' … |
