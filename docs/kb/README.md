...
| [clients.md](clients.md) | Клиенты и упаковка: web, desktop и agent-tray | 2026-07-27 | ⚠ 13 коммит(ов) в areas после сверки: fc03446 CHAT-261 push CLI auth status over WebSocket … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-17 | ⚠ 6 коммит(ов) в areas после сверки: eb4cc6e Merge task fc3e4541-e7fd-4460-a8f7-3f8f17da8ebd … |
...
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-08-16 | ⚠ 18 коммит(ов) в areas после сверки: eb4cc6e Merge task fc3e4541-e7fd-4460-a8f7-3f8f17da8ebd … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 401 коммит(ов) в areas после сверки: 59b74af docs(kb): update after merge fc3e4541-e7fd-4460-a8f7-3f8f17da8ebd … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-16 | ⚠ 15 коммит(ов) в areas после сверки: eb4cc6e Merge task fc3e4541-e7fd-4460-a8f7-3f8f17da8ebd … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-17 | ⚠ 6 коммит(ов) в areas после сверки: eb4cc6e Merge task fc3e4541-e7fd-4460-a8f7-3f8f17da8ebd … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-12 | ⚠ 55 коммит(ов) в areas после сверки: fc03446 CHAT-261 push CLI auth status over WebSocket … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-17 | ⚠ 17 коммит(ов) в areas после сверки: eb4cc6e Merge task fc3e4541-e7fd-4460-a8f7-3f8f17da8ebd … |
