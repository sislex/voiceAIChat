...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-09-10 | ⚠ 5 коммит(ов) в areas после сверки: dfa84be6 feat(playwright-reader): work the keyboard and the frame like a person (cycle 1) … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-09-10 | ⚠ 21 коммит(ов) в areas после сверки: dfa84be6 feat(playwright-reader): work the keyboard and the frame like a person (cycle 1) … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1348 коммит(ов) в areas после сверки: dfa84be6 feat(playwright-reader): work the keyboard and the frame like a person (cycle 1) … |
...
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 320 коммит(ов) в areas после сверки: dfa84be6 feat(playwright-reader): work the keyboard and the frame like a person (cycle 1) … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-10 | ⚠ 5 коммит(ов) в areas после сверки: dfa84be6 feat(playwright-reader): work the keyboard and the frame like a person (cycle 1) … |
...
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-09-11 | ⚠ 8 коммит(ов) в areas после сверки: dfa84be6 feat(playwright-reader): work the keyboard and the frame like a person (cycle 1) … |
