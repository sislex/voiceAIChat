...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 61 коммит(ов) в areas после сверки: 0403bf7 docs(kb): ui.md — общая шапка утилиты машины у всех трёх виджетов … |
