...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-09 | ⚠ 45 коммит(ов) в areas после сверки: 3d7b62a7 feat(kanban): add collapsible columns … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1377 коммит(ов) в areas после сверки: 3d7b62a7 feat(kanban): add collapsible columns … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-09-11 | ⚠ 18 коммит(ов) в areas после сверки: 3d7b62a7 feat(kanban): add collapsible columns … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-10 | ⚠ 21 коммит(ов) в areas после сверки: 3d7b62a7 feat(kanban): add collapsible columns … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-11 | ⚠ 9 коммит(ов) в areas после сверки: 3d7b62a7 feat(kanban): add collapsible columns … |
