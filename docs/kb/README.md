...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-09-01 | ⚠ 97 коммит(ов) в areas после сверки: 9c4bebf1 feat(image-studio): add object editing and version history … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-09 | ⚠ 65 коммит(ов) в areas после сверки: 475deeea feat(releases): Release Center improvement cycle 1 — form, production markers, mobile tables … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1399 коммит(ов) в areas после сверки: 475deeea feat(releases): Release Center improvement cycle 1 — form, production markers, mobile tables … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-09-11 | ⚠ 38 коммит(ов) в areas после сверки: 475deeea feat(releases): Release Center improvement cycle 1 — form, production markers, mobile tables … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-12 | ⚠ 2 коммит(ов) в areas после сверки: 475deeea feat(releases): Release Center improvement cycle 1 — form, production markers, mobile tables … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-10 | ⚠ 11 коммит(ов) в areas после сверки: 475deeea feat(releases): Release Center improvement cycle 1 — form, production markers, mobile tables … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-12 | ⚠ 4 коммит(ов) в areas после сверки: 475deeea feat(releases): Release Center improvement cycle 1 — form, production markers, mobile tables … |
...
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-09-11 | ⚠ 3 коммит(ов) в areas после сверки: 475deeea feat(releases): Release Center improvement cycle 1 — form, production markers, mobile tables … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-12 | ⚠ 2 коммит(ов) в areas после сверки: 475deeea feat(releases): Release Center improvement cycle 1 — form, production markers, mobile tables … |
