...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-08-19 | ⚠ 72 коммит(ов) в areas после сверки: b182a56d feat(make): комментарии к элементам превью с метками и запросом «Исправить все» (п.32) … |
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-20 | ⚠ 86 коммит(ов) в areas после сверки: b182a56d feat(make): комментарии к элементам превью с метками и запросом «Исправить все» (п.32) … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 61 коммит(ов) в areas после сверки: b182a56d feat(make): комментарии к элементам превью с метками и запросом «Исправить все» (п.32) … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 668 коммит(ов) в areas после сверки: d909d233 refactor(ui): убрать дубли примитивов ui-kit из components/ui (п.40) … |
...
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-25 | ⚠ 53 коммит(ов) в areas после сверки: d909d233 refactor(ui): убрать дубли примитивов ui-kit из components/ui (п.40) … |
...
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 58 коммит(ов) в areas после сверки: b182a56d feat(make): комментарии к элементам превью с метками и запросом «Исправить все» (п.32) … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-08-27 | ⚠ 4 коммит(ов) в areas после сверки: b182a56d feat(make): комментарии к элементам превью с метками и запросом «Исправить все» (п.32) … |
