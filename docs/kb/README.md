...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-20 | ⚠ 216 коммит(ов) в areas после сверки: c567ccf1 feat: scope task Make designs to selected files … |
...
| [features/llm-runners.md](features/llm-runners.md) | Исполнители LLM: контейнеры с claude/codex CLI | 2026-08-18 | ⚠ 121 коммит(ов) в areas после сверки: c567ccf1 feat: scope task Make designs to selected files … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-01 | ⚠ 9 коммит(ов) в areas после сверки: 9122dcc2 Merge task 6f58c609-a806-4075-a40f-4a052a4fab10 … |
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 205 коммит(ов) в areas после сверки: c567ccf1 feat: scope task Make designs to selected files … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-09-01 | ⚠ 10 коммит(ов) в areas после сверки: c567ccf1 feat: scope task Make designs to selected files … |
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-02 | ⚠ 2 коммит(ов) в areas после сверки: 9122dcc2 Merge task 6f58c609-a806-4075-a40f-4a052a4fab10 … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-31 | ⚠ 71 коммит(ов) в areas после сверки: 9122dcc2 Merge task 6f58c609-a806-4075-a40f-4a052a4fab10 … |
...
| [stt-runner.md](stt-runner.md) | STT Runner: внутренний протокол, ресурсы и lifecycle | 2026-08-20 | ⚠ 128 коммит(ов) в areas после сверки: c567ccf1 feat: scope task Make designs to selected files … |
...
| [tts-runner.md](tts-runner.md) | TTS Runner: ресурсный API, движки и жизненный цикл WAV | 2026-08-26 | ⚠ 80 коммит(ов) в areas после сверки: c567ccf1 feat: scope task Make designs to selected files … |
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-01 | ⚠ 7 коммит(ов) в areas после сверки: 9122dcc2 Merge task 6f58c609-a806-4075-a40f-4a052a4fab10 … |
