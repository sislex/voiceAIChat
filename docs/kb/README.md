...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-01 | ⚠ 6 коммит(ов) в areas после сверки: f15b2ba feat(server): add remote MCP file tools … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-07-27 | ⚠ 59 коммит(ов) в areas после сверки: f15b2ba feat(server): add remote MCP file tools … |
