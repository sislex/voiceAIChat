...
|---|---|---|---|
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-01 | ⚠ 98 коммит(ов) в areas после сверки: 5a78a82 Merge task 1cd9a143-3458-4ff3-9adc-29643f7a843d … |
...
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-08-14 | ⚠ 1 коммит(ов) в areas после сверки: f194d43 Merge task b4a2de10-a44b-47c2-ba07-6e4664b9aaf3 |
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-14 | ⚠ 13 коммит(ов) в areas после сверки: 5a78a82 Merge task 1cd9a143-3458-4ff3-9adc-29643f7a843d … |
...
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-08-14 | ⚠ 4 коммит(ов) в areas после сверки: 5a78a82 Merge task 1cd9a143-3458-4ff3-9adc-29643f7a843d … |
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-14 | ⚠ 6 коммит(ов) в areas после сверки: 5a78a82 Merge task 1cd9a143-3458-4ff3-9adc-29643f7a843d … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 313 коммит(ов) в areas после сверки: 5a78a82 Merge task 1cd9a143-3458-4ff3-9adc-29643f7a843d … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-14 | ⚠ 12 коммит(ов) в areas после сверки: 5a78a82 Merge task 1cd9a143-3458-4ff3-9adc-29643f7a843d … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-12 | ⚠ 27 коммит(ов) в areas после сверки: 5a78a82 Merge task 1cd9a143-3458-4ff3-9adc-29643f7a843d … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-14 | ✓ |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-12 | ⚠ 25 коммит(ов) в areas после сверки: 5a78a82 Merge task 1cd9a143-3458-4ff3-9adc-29643f7a843d … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-14 | ⚠ 10 коммит(ов) в areas после сверки: 5a78a82 Merge task 1cd9a143-3458-4ff3-9adc-29643f7a843d … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-10 | ⚠ 45 коммит(ов) в areas после сверки: 5a78a82 Merge task 1cd9a143-3458-4ff3-9adc-29643f7a843d … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-14 | ⚠ 3 коммит(ов) в areas после сверки: 5a78a82 Merge task 1cd9a143-3458-4ff3-9adc-29643f7a843d … |
...
- [2026-08-14-alexeys-macbook-air-2-active-request-status.md](log/2026-08-14-alexeys-macbook-air-2-active-request-status.md) — active-request-status
