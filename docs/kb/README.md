...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-08-19 | ⚠ 3 коммит(ов) в areas после сверки: 4166e971 feat: notify about preparation questions … |
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-20 | ⚠ 1 коммит(ов) в areas после сверки: 4166e971 feat: notify about preparation questions |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-18 | ⚠ 18 коммит(ов) в areas после сверки: 4166e971 feat: notify about preparation questions … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-20 | ⚠ 5 коммит(ов) в areas после сверки: 4166e971 feat: notify about preparation questions … |
| [features/feature-preview.md](features/feature-preview.md) | Feature-preview окружения задач | 2026-08-17 | ⚠ 27 коммит(ов) в areas после сверки: 4166e971 feat: notify about preparation questions … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-16 | ⚠ 49 коммит(ов) в areas после сверки: 4166e971 feat: notify about preparation questions … |
...
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-08-17 | ⚠ 35 коммит(ов) в areas после сверки: 4166e971 feat: notify about preparation questions … |
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-17 | ⚠ 31 коммит(ов) в areas после сверки: 4166e971 feat: notify about preparation questions … |
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-08-19 | ⚠ 3 коммит(ов) в areas после сверки: 4166e971 feat: notify about preparation questions … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 472 коммит(ов) в areas после сверки: 4166e971 feat: notify about preparation questions … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-20 | ⚠ 1 коммит(ов) в areas после сверки: 4166e971 feat: notify about preparation questions |
...
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-19 | ⚠ 5 коммит(ов) в areas после сверки: 4166e971 feat: notify about preparation questions … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-19 | ⚠ 6 коммит(ов) в areas после сверки: 4166e971 feat: notify about preparation questions … |
| [operations-app.md](operations-app.md) | Frontend-модуль Operations: граница, store и подключение | 2026-08-19 | ⚠ 3 коммит(ов) в areas после сверки: 4166e971 feat: notify about preparation questions … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-20 | ⚠ 3 коммит(ов) в areas после сверки: 4166e971 feat: notify about preparation questions … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-19 | ⚠ 8 коммит(ов) в areas после сверки: 4166e971 feat: notify about preparation questions … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-20 | ⚠ 1 коммит(ов) в areas после сверки: 4166e971 feat: notify about preparation questions |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-20 | ⚠ 2 коммит(ов) в areas после сверки: 4166e971 feat: notify about preparation questions … |
