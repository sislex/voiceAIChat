...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-18 | ⚠ 16 коммит(ов) в areas после сверки: d924c2e2 Merge task 4012d157-a344-4280-a63e-275ee1366338 … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-19 | ⚠ 6 коммит(ов) в areas после сверки: 0a645e99 Merge task e84d075e-6d92-4d14-bb67-57767dbbabec … |
| [features/feature-preview.md](features/feature-preview.md) | Feature-preview окружения задач | 2026-08-17 | ⚠ 22 коммит(ов) в areas после сверки: d924c2e2 Merge task 4012d157-a344-4280-a63e-275ee1366338 … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-16 | ⚠ 46 коммит(ов) в areas после сверки: d924c2e2 Merge task 4012d157-a344-4280-a63e-275ee1366338 … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-19 | ⚠ 3 коммит(ов) в areas после сверки: d924c2e2 Merge task 4012d157-a344-4280-a63e-275ee1366338 … |
