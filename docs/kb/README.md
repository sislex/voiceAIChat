...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-28 | ⚠ 1 коммит(ов) в areas после сверки: 3a02f63b fix(auth): CSRF на logout и других мутациях /api/session по cookie — старая вкладка отзывала общую сессию |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 727 коммит(ов) в areas после сверки: d4c807cb docs(kb): журнал — релиз 0.1.173 задеплоен … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-27 | ⚠ 2 коммит(ов) в areas после сверки: 3a02f63b fix(auth): CSRF на logout и других мутациях /api/session по cookie — старая вкладка отзывала общую сессию … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-27 | ⚠ 2 коммит(ов) в areas после сверки: 3a02f63b fix(auth): CSRF на logout и других мутациях /api/session по cookie — старая вкладка отзывала общую сессию … |
