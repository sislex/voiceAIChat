...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-16 | ⚠ 19 коммит(ов) в areas после сверки: 3129e7d5 Merge main into CHAT-487 (task 0083fdb3-9a17-41ed-a60d-bc85b3776e94) … |
| [features/development-preview.md](features/development-preview.md) | Development CI: isolated Docker preview and browser evidence | 2026-09-17 | ⚠ 2 коммит(ов) в areas после сверки: 0d74e062 Merge main into CHAT-449 (task 1fa649c4-8315-4b8b-8728-6f3aacc0429e) … |
...
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-09-17 | ⚠ 8 коммит(ов) в areas после сверки: 3129e7d5 Merge main into CHAT-487 (task 0083fdb3-9a17-41ed-a60d-bc85b3776e94) … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1549 коммит(ов) в areas после сверки: 3129e7d5 Merge main into CHAT-487 (task 0083fdb3-9a17-41ed-a60d-bc85b3776e94) … |
...
| [features/task-autopilot.md](features/task-autopilot.md) | Автопроход задачи по QA-конвейеру | 2026-09-16 | ⚠ 7 коммит(ов) в areas после сверки: 0d74e062 Merge main into CHAT-449 (task 1fa649c4-8315-4b8b-8728-6f3aacc0429e) … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-09-15 | ⚠ 36 коммит(ов) в areas после сверки: aa8eb95f Merge main into CHAT-484 (task 66e9bba2-7e8c-42e6-b42b-a923d5d6e777) … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-16 | ⚠ 18 коммит(ов) в areas после сверки: 3129e7d5 Merge main into CHAT-487 (task 0083fdb3-9a17-41ed-a60d-bc85b3776e94) … |
