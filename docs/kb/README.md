...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-16 | ⚠ 2 коммит(ов) в areas после сверки: d154a7ef fix(autopilot): stop a QA stage after consecutive failed runs (#203) … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1533 коммит(ов) в areas после сверки: d154a7ef fix(autopilot): stop a QA stage after consecutive failed runs (#203) … |
...
| [features/task-autopilot.md](features/task-autopilot.md) | Автопроход задачи по QA-конвейеру | 2026-09-16 | ⚠ 1 коммит(ов) в areas после сверки: d154a7ef fix(autopilot): stop a QA stage after consecutive failed runs (#203) |
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-16 | ⚠ 7 коммит(ов) в areas после сверки: d154a7ef fix(autopilot): stop a QA stage after consecutive failed runs (#203) … |
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 367 коммит(ов) в areas после сверки: 9e663b79 feat: configure machine command notifications … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-09-14 | ⚠ 29 коммит(ов) в areas после сверки: 9e663b79 feat: configure machine command notifications … |
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-16 | ✓ |
| [operations-app.md](operations-app.md) | Frontend-модуль Operations: граница, store и подключение | 2026-08-19 | ⚠ 261 коммит(ов) в areas после сверки: 9e663b79 feat: configure machine command notifications … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-15 | ⚠ 33 коммит(ов) в areas после сверки: 9e663b79 feat: configure machine command notifications … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-09-15 | ⚠ 24 коммит(ов) в areas после сверки: d154a7ef fix(autopilot): stop a QA stage after consecutive failed runs (#203) … |
...
- [2026-09-16-alexeys-macbook-air-tailae39a6-ts-net-automated-qa-retry-loop.md](log/2026-09-16-alexeys-macbook-air-tailae39a6-ts-net-automated-qa-retry-loop.md) — automated-qa-retry-loop
