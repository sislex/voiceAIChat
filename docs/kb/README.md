...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-07-30 | ⚠ 4 коммит(ов) в areas после сверки: baa4936 refactor(ui): CI-панель на Button/IconButton … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-07-27 | ⚠ 6 коммит(ов) в areas после сверки: 5d2fef6 style(ui): атрибуты Button/IconButton по одному на строку … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-07-30 | ⚠ 7 коммит(ов) в areas после сверки: d498612 refactor(ui): сайдбар, шапки окон и остатки зоопарка кнопок на Button … |
