...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-08-19 | ⚠ 1 коммит(ов) в areas после сверки: c73c5103 fix: refine project machine settings |
...
| [conventions.md](conventions.md) | Конвенции: код, тесты, гейты, коммиты | 2026-08-01 | ⚠ 6 коммит(ов) в areas после сверки: 17eeda66 feat(frontend): extract reader workspace packages … |
...
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-08-18 | ⚠ 10 коммит(ов) в areas после сверки: 0a645e99 Merge task e84d075e-6d92-4d14-bb67-57767dbbabec … |
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-19 | ⚠ 7 коммит(ов) в areas после сверки: c9ed3cd3 CHAT-288 group sidebar history and backfill cancelled … |
| [features/feature-preview.md](features/feature-preview.md) | Feature-preview окружения задач | 2026-08-17 | ⚠ 23 коммит(ов) в areas после сверки: c9ed3cd3 CHAT-288 group sidebar history and backfill cancelled … |
...
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-08-19 | ⚠ 1 коммит(ов) в areas после сверки: c9ed3cd3 CHAT-288 group sidebar history and backfill cancelled |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-19 | ⚠ 4 коммит(ов) в areas после сверки: c9ed3cd3 CHAT-288 group sidebar history and backfill cancelled … |
| [operations-app.md](operations-app.md) | Frontend-модуль Operations: граница, store и подключение | 2026-08-19 | ⚠ 1 коммит(ов) в areas после сверки: 17eeda66 feat(frontend): extract reader workspace packages |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-19 | ⚠ 8 коммит(ов) в areas после сверки: c9ed3cd3 CHAT-288 group sidebar history and backfill cancelled … |
