...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-09-01 | ⚠ 76 коммит(ов) в areas после сверки: 6d90d29b fix(reader): parse HTML resources reliably (cycle 01/20) … |
...
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-09-09 | ⚠ 2 коммит(ов) в areas после сверки: 1a5c4422 fix(reader): load module graphs and bundled assets (cycle 02/20) … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1292 коммит(ов) в areas после сверки: 1a5c4422 fix(reader): load module graphs and bundled assets (cycle 02/20) … |
...
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-09-09 | ⚠ 5 коммит(ов) в areas после сверки: 1a5c4422 fix(reader): load module graphs and bundled assets (cycle 02/20) … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-10 | ⚠ 2 коммит(ов) в areas после сверки: 1a5c4422 fix(reader): load module graphs and bundled assets (cycle 02/20) … |
