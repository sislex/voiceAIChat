...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-09-01 | ⚠ 62 коммит(ов) в areas после сверки: 8ccad34f fix: preserve Make conversation modes … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-06 | ⚠ 29 коммит(ов) в areas после сверки: 399e57aa Merge main into CHAT-423 (task d21dcb8a-a342-4fc1-91d1-685f2c01c439) … |
...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 88 коммит(ов) в areas после сверки: 399e57aa Merge main into CHAT-423 (task d21dcb8a-a342-4fc1-91d1-685f2c01c439) … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 261 коммит(ов) в areas после сверки: 399e57aa Merge main into CHAT-423 (task d21dcb8a-a342-4fc1-91d1-685f2c01c439) … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-05 | ⚠ 52 коммит(ов) в areas после сверки: 399e57aa Merge main into CHAT-423 (task d21dcb8a-a342-4fc1-91d1-685f2c01c439) … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-07 | ⚠ 18 коммит(ов) в areas после сверки: 399e57aa Merge main into CHAT-423 (task d21dcb8a-a342-4fc1-91d1-685f2c01c439) … |
| [operations-app.md](operations-app.md) | Frontend-модуль Operations: граница, store и подключение | 2026-08-19 | ⚠ 206 коммит(ов) в areas после сверки: 8ccad34f fix: preserve Make conversation modes … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-07 | ⚠ 13 коммит(ов) в areas после сверки: 399e57aa Merge main into CHAT-423 (task d21dcb8a-a342-4fc1-91d1-685f2c01c439) … |
