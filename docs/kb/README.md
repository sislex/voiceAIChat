...
|---|---|---|---|
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-01 | ⚠ 36 коммит(ов) в areas после сверки: 440c8c3 feat: add session-bound production deploy tool … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-06 | ⚠ 5 коммит(ов) в areas после сверки: abeab22 feat(admin): add protected production deploy API … |
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-08-07 | ✓ |
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-07 | ⚠ 4 коммит(ов) в areas после сверки: 440c8c3 feat: add session-bound production deploy tool … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 107 коммит(ов) в areas после сверки: 440c8c3 feat: add session-bound production deploy tool … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-07 | ✓ |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-05 | ⚠ 13 коммит(ов) в areas после сверки: abeab22 feat(admin): add protected production deploy API … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-06 | ⚠ 7 коммит(ов) в areas после сверки: 440c8c3 feat: add session-bound production deploy tool … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-07 | ⚠ 4 коммит(ов) в areas после сверки: 440c8c3 feat: add session-bound production deploy tool … |
| [stt-tts.md](stt-tts.md) | Речь: Whisper (STT) и Piper/say (TTS) | 2026-07-26 | ✓ |
| [testing-operations.md](testing-operations.md) | Разработка, тестирование, диагностика и эксплуатация | 2026-08-07 | ⚠ 1 коммит(ов) в areas после сверки: abeab22 feat(admin): add protected production deploy API |
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-07 | ⚠ 3 коммит(ов) в areas после сверки: 4284dd0 feat: support multiple task launch proposals … |
