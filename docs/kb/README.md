...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-01 | ⚠ 17 коммит(ов) в areas после сверки: b0501717 merge: resolve main conflicts for CHAT-388 … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-09-01 | ⚠ 21 коммит(ов) в areas после сверки: b0501717 merge: resolve main conflicts for CHAT-388 … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-31 | ⚠ 62 коммит(ов) в areas после сверки: b0501717 merge: resolve main conflicts for CHAT-388 … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-30 | ⚠ 81 коммит(ов) в areas после сверки: b0501717 merge: resolve main conflicts for CHAT-388 … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-01 | ⚠ 5 коммит(ов) в areas после сверки: b0501717 merge: resolve main conflicts for CHAT-388 … |
