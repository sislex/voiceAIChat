...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-09-01 | ⚠ 28 коммит(ов) в areas после сверки: 4a4ef918 feat: студия картинок — итерация улучшений 22 (перенос между чатами) … |
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-20 | ⚠ 236 коммит(ов) в areas после сверки: 4a4ef918 feat: студия картинок — итерация улучшений 22 (перенос между чатами) … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-03 | ⚠ 17 коммит(ов) в areas после сверки: 4a4ef918 feat: студия картинок — итерация улучшений 22 (перенос между чатами) … |
...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 18 коммит(ов) в areas после сверки: 4a4ef918 feat: студия картинок — итерация улучшений 22 (перенос между чатами) … |
...
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-09-03 | ⚠ 12 коммит(ов) в areas после сверки: 4a4ef918 feat: студия картинок — итерация улучшений 22 (перенос между чатами) … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1110 коммит(ов) в areas после сверки: 4a4ef918 feat: студия картинок — итерация улучшений 22 (перенос между чатами) … |
...
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-29 | ⚠ 205 коммит(ов) в areas после сверки: 4a4ef918 feat: студия картинок — итерация улучшений 22 (перенос между чатами) … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-02 | ⚠ 34 коммит(ов) в areas после сверки: 4a4ef918 feat: студия картинок — итерация улучшений 22 (перенос между чатами) … |
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 226 коммит(ов) в areas после сверки: 4a4ef918 feat: студия картинок — итерация улучшений 22 (перенос между чатами) … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-02 | ⚠ 17 коммит(ов) в areas после сверки: 4a4ef918 feat: студия картинок — итерация улучшений 22 (перенос между чатами) … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-03 | ⚠ 19 коммит(ов) в areas после сверки: 4a4ef918 feat: студия картинок — итерация улучшений 22 (перенос между чатами) … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-09-03 | ⚠ 1 коммит(ов) в areas после сверки: 4a4ef918 feat: студия картинок — итерация улучшений 22 (перенос между чатами) |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-09-03 | ⚠ 7 коммит(ов) в areas после сверки: 4a4ef918 feat: студия картинок — итерация улучшений 22 (перенос между чатами) … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-09-03 | ⚠ 8 коммит(ов) в areas после сверки: 4a4ef918 feat: студия картинок — итерация улучшений 22 (перенос между чатами) … |
