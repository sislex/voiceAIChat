...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-06 | ⚠ 4 коммит(ов) в areas после сверки: be40e93 fix(ci): отключение машины — инфраструктурный сбой, без fix-loop … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 91 коммит(ов) в areas после сверки: f8999ca fix(prod): пересборка ждёт простоя ранов вместо слепой задержки … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-06 | ⚠ 1 коммит(ов) в areas после сверки: be40e93 fix(ci): отключение машины — инфраструктурный сбой, без fix-loop |
...
| [testing-operations.md](testing-operations.md) | Разработка, тестирование, диагностика и эксплуатация | 2026-08-02 | ⚠ 15 коммит(ов) в areas после сверки: f8999ca fix(prod): пересборка ждёт простоя ранов вместо слепой задержки … |
