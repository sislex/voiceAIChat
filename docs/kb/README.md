...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-17 | ⚠ 11 коммит(ов) в areas после сверки: 735c1bc Merge origin/main into CHAT-265 … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-17 | ⚠ 14 коммит(ов) в areas после сверки: 735c1bc Merge origin/main into CHAT-265 … |
| [features/feature-preview.md](features/feature-preview.md) | Feature-preview окружения задач | 2026-08-17 | ⚠ 5 коммит(ов) в areas после сверки: 735c1bc Merge origin/main into CHAT-265 … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-16 | ⚠ 22 коммит(ов) в areas после сверки: 735c1bc Merge origin/main into CHAT-265 … |
...
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-08-17 | ⚠ 5 коммит(ов) в areas после сверки: 735c1bc Merge origin/main into CHAT-265 … |
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-17 | ⚠ 21 коммит(ов) в areas после сверки: 735c1bc Merge origin/main into CHAT-265 … |
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-08-16 | ⚠ 24 коммит(ов) в areas после сверки: 735c1bc Merge origin/main into CHAT-265 … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 412 коммит(ов) в areas после сверки: 735c1bc Merge origin/main into CHAT-265 … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-16 | ⚠ 24 коммит(ов) в areas после сверки: 735c1bc Merge origin/main into CHAT-265 … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-17 | ⚠ 3 коммит(ов) в areas после сверки: 735c1bc Merge origin/main into CHAT-265 … |
...
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-17 | ⚠ 3 коммит(ов) в areas после сверки: 735c1bc Merge origin/main into CHAT-265 … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-17 | ✓ |
