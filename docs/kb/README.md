...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-29 | ⚠ 39 коммит(ов) в areas после сверки: f66fd706 feat(kanban): промежуточная ширина и последние диалекты раскрытия, круг 9 … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 875 коммит(ов) в areas после сверки: f66fd706 feat(kanban): промежуточная ширина и последние диалекты раскрытия, круг 9 … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-30 | ⚠ 12 коммит(ов) в areas после сверки: f66fd706 feat(kanban): промежуточная ширина и последние диалекты раскрытия, круг 9 … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-29 | ⚠ 37 коммит(ов) в areas после сверки: f66fd706 feat(kanban): промежуточная ширина и последние диалекты раскрытия, круг 9 … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-29 | ⚠ 25 коммит(ов) в areas после сверки: f66fd706 feat(kanban): промежуточная ширина и последние диалекты раскрытия, круг 9 … |
