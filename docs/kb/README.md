...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 45 коммит(ов) в areas после сверки: fd195bb9 feat(make): поиск и замена по всему проекту со снимком перед заменой (п.1) … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-27 | ⚠ 1 коммит(ов) в areas после сверки: fd195bb9 feat(make): поиск и замена по всему проекту со снимком перед заменой (п.1) |
