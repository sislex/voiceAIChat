...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-08-19 | ⚠ 142 коммит(ов) в areas после сверки: e96495c5 fix(settings): пользовательские настройки переживают релиз и деплой … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-29 | ⚠ 25 коммит(ов) в areas после сверки: e96495c5 fix(settings): пользовательские настройки переживают релиз и деплой … |
...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 60 коммит(ов) в areas после сверки: e96495c5 fix(settings): пользовательские настройки переживают релиз и деплой … |
...
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-08-30 | ⚠ 1 коммит(ов) в areas после сверки: e96495c5 fix(settings): пользовательские настройки переживают релиз и деплой |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 860 коммит(ов) в areas после сверки: e96495c5 fix(settings): пользовательские настройки переживают релиз и деплой … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-30 | ⚠ 1 коммит(ов) в areas после сверки: e96495c5 fix(settings): пользовательские настройки переживают релиз и деплой |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-29 | ⚠ 25 коммит(ов) в areas после сверки: e96495c5 fix(settings): пользовательские настройки переживают релиз и деплой … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-08-28 | ⚠ 59 коммит(ов) в areas после сверки: e96495c5 fix(settings): пользовательские настройки переживают релиз и деплой … |
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 128 коммит(ов) в areas после сверки: e96495c5 fix(settings): пользовательские настройки переживают релиз и деплой … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-08-27 | ⚠ 37 коммит(ов) в areas после сверки: e96495c5 fix(settings): пользовательские настройки переживают релиз и деплой … |
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-28 | ⚠ 59 коммит(ов) в areas после сверки: e96495c5 fix(settings): пользовательские настройки переживают релиз и деплой … |
| [operations-app.md](operations-app.md) | Frontend-модуль Operations: граница, store и подключение | 2026-08-19 | ⚠ 103 коммит(ов) в areas после сверки: e96495c5 fix(settings): пользовательские настройки переживают релиз и деплой … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-30 | ⚠ 1 коммит(ов) в areas после сверки: e96495c5 fix(settings): пользовательские настройки переживают релиз и деплой |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-29 | ⚠ 20 коммит(ов) в areas после сверки: e96495c5 fix(settings): пользовательские настройки переживают релиз и деплой … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-30 | ⚠ 1 коммит(ов) в areas после сверки: e96495c5 fix(settings): пользовательские настройки переживают релиз и деплой |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-29 | ⚠ 32 коммит(ов) в areas после сверки: e96495c5 fix(settings): пользовательские настройки переживают релиз и деплой … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-30 | ⚠ 1 коммит(ов) в areas после сверки: e96495c5 fix(settings): пользовательские настройки переживают релиз и деплой |
