...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-09-01 | ⚠ 76 коммит(ов) в areas после сверки: 3fae59bd fix(playwright-reader): открывать страницы проекта и восстановить навигацию … |
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-09-09 | ⚠ 7 коммит(ов) в areas после сверки: e4e68958 feat(playwright-reader): управлять вкладками и popup из модели … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-09-09 | ⚠ 3 коммит(ов) в areas после сверки: e4e68958 feat(playwright-reader): управлять вкладками и popup из модели … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1294 коммит(ов) в areas после сверки: e4e68958 feat(playwright-reader): управлять вкладками и popup из модели … |
...
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 300 коммит(ов) в areas после сверки: e4e68958 feat(playwright-reader): управлять вкладками и popup из модели … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-08 | ⚠ 11 коммит(ов) в areas после сверки: e4e68958 feat(playwright-reader): управлять вкладками и popup из модели … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-09 | ⚠ 5 коммит(ов) в areas после сверки: e4e68958 feat(playwright-reader): управлять вкладками и popup из модели … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-09-09 | ⚠ 6 коммит(ов) в areas после сверки: e4e68958 feat(playwright-reader): управлять вкладками и popup из модели … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-09-09 | ⚠ 9 коммит(ов) в areas после сверки: e4e68958 feat(playwright-reader): управлять вкладками и popup из модели … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-09-09 | ⚠ 8 коммит(ов) в areas после сверки: e4e68958 feat(playwright-reader): управлять вкладками и popup из модели … |
...
| [testing-operations.md](testing-operations.md) | Разработка, тестирование, диагностика и эксплуатация | 2026-09-09 | ⚠ 6 коммит(ов) в areas после сверки: e4e68958 feat(playwright-reader): управлять вкладками и popup из модели … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-10 | ⚠ 3 коммит(ов) в areas после сверки: e4e68958 feat(playwright-reader): управлять вкладками и popup из модели … |
