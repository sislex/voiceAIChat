...
| [features/feature-preview.md](features/feature-preview.md) | Feature-preview окружения задач | 2026-08-14 | ⚠ 1 коммит(ов) в areas после сверки: 70fb9bf Merge task f2659ed3-a453-443d-b68c-1dd6242c2da5 |
...
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-14 | ⚠ 10 коммит(ов) в areas после сверки: 94f5135 Merge task 44dc28f9-42cb-4087-91cf-5b01cf526de9 … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 315 коммит(ов) в areas после сверки: 70fb9bf Merge task f2659ed3-a453-443d-b68c-1dd6242c2da5 … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-14 | ⚠ 16 коммит(ов) в areas после сверки: 94f5135 Merge task 44dc28f9-42cb-4087-91cf-5b01cf526de9 … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-12 | ⚠ 29 коммит(ов) в areas после сверки: 70fb9bf Merge task f2659ed3-a453-443d-b68c-1dd6242c2da5 … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-14 | ⚠ 5 коммит(ов) в areas после сверки: 94f5135 Merge task 44dc28f9-42cb-4087-91cf-5b01cf526de9 … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-14 | ⚠ 7 коммит(ов) в areas после сверки: 94f5135 Merge task 44dc28f9-42cb-4087-91cf-5b01cf526de9 … |
...
- [2026-08-14-alexeys-macbook-air-2-ci-queue-ui-labels.md](log/2026-08-14-alexeys-macbook-air-2-ci-queue-ui-labels.md) — ci-queue-ui-labels
