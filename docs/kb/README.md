...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-05 | ⚠ 4 коммит(ов) в areas после сверки: 0353f90 feat(ui): консоль машины — история команд, «Стоп» и копирование вывода … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 58 коммит(ов) в areas после сверки: 0353f90 feat(ui): консоль машины — история команд, «Стоп» и копирование вывода … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-05 | ⚠ 1 коммит(ов) в areas после сверки: 0353f90 feat(ui): консоль машины — история команд, «Стоп» и копирование вывода |
