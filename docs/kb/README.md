...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-07-31 | ⚠ 1 коммит(ов) в areas после сверки: b0c37a0 feat(ui): перенос задач на канбане пальцем и с клавиатуры вместо HTML5 DnD |
