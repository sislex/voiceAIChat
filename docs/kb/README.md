...
|---|---|---|---|
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-01 | ⚠ 34 коммит(ов) в areas после сверки: 4284dd0 feat: support multiple task launch proposals … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-06 | ⚠ 4 коммит(ов) в areas после сверки: 4284dd0 feat: support multiple task launch proposals … |
...
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-05 | ⚠ 12 коммит(ов) в areas после сверки: 4284dd0 feat: support multiple task launch proposals … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-06 | ⚠ 5 коммит(ов) в areas после сверки: 4284dd0 feat: support multiple task launch proposals … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-07 | ⚠ 2 коммит(ов) в areas после сверки: 4284dd0 feat: support multiple task launch proposals … |
| [stt-tts.md](stt-tts.md) | Речь: Whisper (STT) и Piper/say (TTS) | 2026-07-26 | ✓ |
| [testing-operations.md](testing-operations.md) | Разработка, тестирование, диагностика и эксплуатация | 2026-08-07 | ✓ |
