...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-08-19 | ⚠ 129 коммит(ов) в areas после сверки: 84569eb5 fix(invitations): ссылка из письма открывается у вошедшего, экран стал окном … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 162 коммит(ов) в areas после сверки: 84569eb5 fix(invitations): ссылка из письма открывается у вошедшего, экран стал окном … |
...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 32 коммит(ов) в areas после сверки: 84569eb5 fix(invitations): ссылка из письма открывается у вошедшего, экран стал окном … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 801 коммит(ов) в areas после сверки: 84569eb5 fix(invitations): ссылка из письма открывается у вошедшего, экран стал окном … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-20 | ⚠ 206 коммит(ов) в areas после сверки: 84569eb5 fix(invitations): ссылка из письма открывается у вошедшего, экран стал окном … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-28 | ⚠ 60 коммит(ов) в areas после сверки: 84569eb5 fix(invitations): ссылка из письма открывается у вошедшего, экран стал окном … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-29 | ⚠ 7 коммит(ов) в areas после сверки: 84569eb5 fix(invitations): ссылка из письма открывается у вошедшего, экран стал окном … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-29 | ⚠ 1 коммит(ов) в areas после сверки: 84569eb5 fix(invitations): ссылка из письма открывается у вошедшего, экран стал окном |
