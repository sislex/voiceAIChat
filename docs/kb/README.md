...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-29 | ⚠ 106 коммит(ов) в areas после сверки: 8b916927 Merge remote-tracking branch 'origin/main' into work3 … |
...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 105 коммит(ов) в areas после сверки: f58c7c84 feat(ui): add accessible question copy action coverage … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 933 коммит(ов) в areas после сверки: 8b916927 Merge remote-tracking branch 'origin/main' into work3 … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-08-28 | ⚠ 113 коммит(ов) в areas после сверки: 8b916927 Merge remote-tracking branch 'origin/main' into work3 … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-31 | ⚠ 5 коммит(ов) в areas после сверки: 49b77875 Merge task 3b2ac5c5-c50f-4559-8596-b0d512192b0f … |
