...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 78 коммит(ов) в areas после сверки: f60fcc9 feat: add personal LLM model access controls … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-06 | ⚠ 1 коммит(ов) в areas после сверки: f60fcc9 feat: add personal LLM model access controls |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-06 | ⚠ 2 коммит(ов) в areas после сверки: f60fcc9 feat: add personal LLM model access controls … |
