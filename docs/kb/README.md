...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-09 | ⚠ 53 коммит(ов) в areas после сверки: 0ebaed5f feat(kanban): show task update freshness … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1385 коммит(ов) в areas после сверки: 0ebaed5f feat(kanban): show task update freshness … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-09-11 | ⚠ 26 коммит(ов) в areas после сверки: 0ebaed5f feat(kanban): show task update freshness … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-10 | ⚠ 28 коммит(ов) в areas после сверки: 0ebaed5f feat(kanban): show task update freshness … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-11 | ⚠ 17 коммит(ов) в areas после сверки: 0ebaed5f feat(kanban): show task update freshness … |
