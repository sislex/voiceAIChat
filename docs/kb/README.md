...
|---|---|---|---|
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-01 | ⚠ 102 коммит(ов) в areas после сверки: 2b24531 CHAT-227: automate component QA lifecycle … |
...
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-08-14 | ⚠ 4 коммит(ов) в areas после сверки: 2b24531 CHAT-227: automate component QA lifecycle … |
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-14 | ✓ |
| [features/feature-preview.md](features/feature-preview.md) | Feature-preview окружения задач | 2026-08-14 | ⚠ 7 коммит(ов) в areas после сверки: 2b24531 CHAT-227: automate component QA lifecycle … |
...
| [features/llm-runners.md](features/llm-runners.md) | Исполнители LLM: контейнеры с claude/codex CLI | 2026-08-02 | ⚠ 48 коммит(ов) в areas после сверки: 2b24531 CHAT-227: automate component QA lifecycle … |
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-08-14 | ✓ |
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-14 | ⚠ 3 коммит(ов) в areas после сверки: 2b24531 CHAT-227: automate component QA lifecycle … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 330 коммит(ов) в areas после сверки: 2b24531 CHAT-227: automate component QA lifecycle … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-14 | ⚠ 5 коммит(ов) в areas после сверки: 2b24531 CHAT-227: automate component QA lifecycle … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-12 | ⚠ 37 коммит(ов) в areas после сверки: 2b24531 CHAT-227: automate component QA lifecycle … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-14 | ⚠ 3 коммит(ов) в areas после сверки: 2b24531 CHAT-227: automate component QA lifecycle … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-14 | ⚠ 22 коммит(ов) в areas после сверки: 2b24531 CHAT-227: automate component QA lifecycle … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-14 | ⚠ 18 коммит(ов) в areas после сверки: 2b24531 CHAT-227: automate component QA lifecycle … |
