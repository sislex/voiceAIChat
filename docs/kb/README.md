...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-08-19 | ⚠ 63 коммит(ов) в areas после сверки: 8e522673 feat(make): скриншот превью или выбранного элемента во вложения чата (п.10) … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 43 коммит(ов) в areas после сверки: 8e522673 feat(make): скриншот превью или выбранного элемента во вложения чата (п.10) … |
...
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-08-25 | ⚠ 23 коммит(ов) в areas после сверки: 8e522673 feat(make): скриншот превью или выбранного элемента во вложения чата (п.10) … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 643 коммит(ов) в areas после сверки: 8e522673 feat(make): скриншот превью или выбранного элемента во вложения чата (п.10) … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-20 | ⚠ 107 коммит(ов) в areas после сверки: 8e522673 feat(make): скриншот превью или выбранного элемента во вложения чата (п.10) … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-25 | ⚠ 34 коммит(ов) в areas после сверки: 8e522673 feat(make): скриншот превью или выбранного элемента во вложения чата (п.10) … |
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-08-25 | ⚠ 24 коммит(ов) в areas после сверки: 8e522673 feat(make): скриншот превью или выбранного элемента во вложения чата (п.10) … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-26 | ⚠ 11 коммит(ов) в areas после сверки: 8e522673 feat(make): скриншот превью или выбранного элемента во вложения чата (п.10) … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-25 | ⚠ 33 коммит(ов) в areas после сверки: 8e522673 feat(make): скриншот превью или выбранного элемента во вложения чата (п.10) … |
...
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-27 | ⚠ 6 коммит(ов) в areas после сверки: 6f810a5b feat(make): controls по argTypes — диапазон, цвет, select, JSON для массивов/объектов (п.14) … |
