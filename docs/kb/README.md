...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-17 | ⚠ 5 коммит(ов) в areas после сверки: 449e16f Merge task 92cec86f-3e60-4dd3-85c3-c984146eb058 … |
...
| [features/feature-preview.md](features/feature-preview.md) | Feature-preview окружения задач | 2026-08-17 | ⚠ 2 коммит(ов) в areas после сверки: 449e16f Merge task 92cec86f-3e60-4dd3-85c3-c984146eb058 … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-16 | ⚠ 14 коммит(ов) в areas после сверки: 449e16f Merge task 92cec86f-3e60-4dd3-85c3-c984146eb058 … |
...
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-17 | ⚠ 12 коммит(ов) в areas после сверки: d9897f0 CHAT-256 move model work into disclosure … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 388 коммит(ов) в areas после сверки: f694372 docs(kb): update after merge 7e007e5f-041a-4d9e-88bc-0488b57bcc6f … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-16 | ⚠ 15 коммит(ов) в areas после сверки: d9897f0 CHAT-256 move model work into disclosure … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-16 | ⚠ 10 коммит(ов) в areas после сверки: 449e16f Merge task 92cec86f-3e60-4dd3-85c3-c984146eb058 … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-17 | ⚠ 2 коммит(ов) в areas после сверки: 4ea96b9 Merge task 60f4b64d-f437-40cb-a53e-ecc05c3bb87c … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-12 | ⚠ 53 коммит(ов) в areas после сверки: 449e16f Merge task 92cec86f-3e60-4dd3-85c3-c984146eb058 … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-17 | ⚠ 9 коммит(ов) в areas после сверки: 4ea96b9 Merge task 60f4b64d-f437-40cb-a53e-ecc05c3bb87c … |
