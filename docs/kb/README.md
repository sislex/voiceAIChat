...
|---|---|---|---|
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-01 | ⚠ 65 коммит(ов) в areas после сверки: 54d7be6 fix: isolate release knowledge base preflight … |
...
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-08-08 | ⚠ 14 коммит(ов) в areas после сверки: 54d7be6 fix: isolate release knowledge base preflight … |
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-10 | ⚠ 4 коммит(ов) в areas после сверки: 54d7be6 fix: isolate release knowledge base preflight … |
...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-07 | ⚠ 28 коммит(ов) в areas после сверки: 54d7be6 fix: isolate release knowledge base preflight … |
| [features/llm-runners.md](features/llm-runners.md) | Исполнители LLM: контейнеры с claude/codex CLI | 2026-08-02 | ⚠ 34 коммит(ов) в areas после сверки: 54d7be6 fix: isolate release knowledge base preflight … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 202 коммит(ов) в areas после сверки: 54d7be6 fix: isolate release knowledge base preflight … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-11 | ⚠ 3 коммит(ов) в areas после сверки: 54d7be6 fix: isolate release knowledge base preflight … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-08 | ⚠ 25 коммит(ов) в areas после сверки: 54d7be6 fix: isolate release knowledge base preflight … |
