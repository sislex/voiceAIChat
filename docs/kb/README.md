...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-14 | ⚠ 4 коммит(ов) в areas после сверки: 996f67a Merge task b607ac70-9051-4bca-ab05-a24531a44124 … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 302 коммит(ов) в areas после сверки: 041f1ca Merge task b4a2de10-a44b-47c2-ba07-6e4664b9aaf3 … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-14 | ⚠ 5 коммит(ов) в areas после сверки: 041f1ca Merge task b4a2de10-a44b-47c2-ba07-6e4664b9aaf3 … |
...
| [testing-operations.md](testing-operations.md) | Разработка, тестирование, диагностика и эксплуатация | 2026-08-14 | ⚠ 3 коммит(ов) в areas после сверки: 041f1ca Merge task b4a2de10-a44b-47c2-ba07-6e4664b9aaf3 … |
