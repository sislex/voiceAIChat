...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-20 | ⚠ 132 коммит(ов) в areas после сверки: b0357f94 fix(projects): отказ гейта объясняется человеку, а не показывается кодом … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 147 коммит(ов) в areas после сверки: b0357f94 fix(projects): отказ гейта объясняется человеку, а не показывается кодом … |
...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 23 коммит(ов) в areas после сверки: 394e3d4c fix(projects): ошибки форм на месте, состояние списка проектов и русские тексты … |
...
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-24 | ⚠ 93 коммит(ов) в areas после сверки: b0357f94 fix(projects): отказ гейта объясняется человеку, а не показывается кодом … |
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-08-25 | ⚠ 88 коммит(ов) в areas после сверки: b0357f94 fix(projects): отказ гейта объясняется человеку, а не показывается кодом … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 774 коммит(ов) в areas после сверки: b0357f94 fix(projects): отказ гейта объясняется человеку, а не показывается кодом … |
...
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-28 | ⚠ 45 коммит(ов) в areas после сверки: b0357f94 fix(projects): отказ гейта объясняется человеку, а не показывается кодом … |
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-08-28 | ⚠ 21 коммит(ов) в areas после сверки: b0357f94 fix(projects): отказ гейта объясняется человеку, а не показывается кодом … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-28 | ⚠ 22 коммит(ов) в areas после сверки: b0357f94 fix(projects): отказ гейта объясняется человеку, а не показывается кодом … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-29 | ⚠ 1 коммит(ов) в areas после сверки: b0357f94 fix(projects): отказ гейта объясняется человеку, а не показывается кодом |
...
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-27 | ⚠ 28 коммит(ов) в areas после сверки: b0357f94 fix(projects): отказ гейта объясняется человеку, а не показывается кодом … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-29 | ⚠ 9 коммит(ов) в areas после сверки: b0357f94 fix(projects): отказ гейта объясняется человеку, а не показывается кодом … |
