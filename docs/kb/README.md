...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-29 | ⚠ 47 коммит(ов) в areas после сверки: 2d656f2b Merge remote-tracking branch 'origin/main' … |
...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 67 коммит(ов) в areas после сверки: 2d656f2b Merge remote-tracking branch 'origin/main' … |
...
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-24 | ⚠ 137 коммит(ов) в areas после сверки: 2d656f2b Merge remote-tracking branch 'origin/main' … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 886 коммит(ов) в areas после сверки: 2d656f2b Merge remote-tracking branch 'origin/main' … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-30 | ⚠ 16 коммит(ов) в areas после сверки: 2d656f2b Merge remote-tracking branch 'origin/main' … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-29 | ⚠ 45 коммит(ов) в areas после сверки: 2d656f2b Merge remote-tracking branch 'origin/main' … |
| [features/task-autopilot.md](features/task-autopilot.md) | Автопроход задачи по QA-конвейеру | 2026-08-29 | ⚠ 17 коммит(ов) в areas после сверки: 2d656f2b Merge remote-tracking branch 'origin/main' … |
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-08-28 | ⚠ 68 коммит(ов) в areas после сверки: 2d656f2b Merge remote-tracking branch 'origin/main' … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-28 | ⚠ 63 коммит(ов) в areas после сверки: bdd6d8e3 fix(preview): уникальное имя временного файла хранилища превью … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-29 | ⚠ 34 коммит(ов) в areas после сверки: 2d656f2b Merge remote-tracking branch 'origin/main' … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-30 | ⚠ 4 коммит(ов) в areas после сверки: bdd6d8e3 fix(preview): уникальное имя временного файла хранилища превью … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-30 | ⚠ 10 коммит(ов) в areas после сверки: 2d656f2b Merge remote-tracking branch 'origin/main' … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-30 | ⚠ 2 коммит(ов) в areas после сверки: 2d656f2b Merge remote-tracking branch 'origin/main' … |
