...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-09-01 | ⚠ 110 коммит(ов) в areas после сверки: 33bf88a8 Merge main into CHAT-455 (task fc0df848-3209-4105-9885-d65ca4c0e21a) … |
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-09-10 | ⚠ 17 коммит(ов) в areas после сверки: 33bf88a8 Merge main into CHAT-455 (task fc0df848-3209-4105-9885-d65ca4c0e21a) … |
| [clients.md](clients.md) | Клиенты и упаковка: web, desktop и agent-tray | 2026-09-07 | ⚠ 39 коммит(ов) в areas после сверки: 33bf88a8 Merge main into CHAT-455 (task fc0df848-3209-4105-9885-d65ca4c0e21a) … |
| [conventions.md](conventions.md) | Конвенции: код, тесты, гейты, коммиты | 2026-09-11 | ✓ |
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-09-11 | ⚠ 7 коммит(ов) в areas после сверки: 06c94c52 Merge main into CHAT-458 (task 9ae92e81-fdd5-42ba-a5d2-81821d817408) … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-12 | ⚠ 13 коммит(ов) в areas после сверки: 33bf88a8 Merge main into CHAT-455 (task fc0df848-3209-4105-9885-d65ca4c0e21a) … |
...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 162 коммит(ов) в areas после сверки: 33bf88a8 Merge main into CHAT-455 (task fc0df848-3209-4105-9885-d65ca4c0e21a) … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 322 коммит(ов) в areas после сверки: 06c94c52 Merge main into CHAT-458 (task 9ae92e81-fdd5-42ba-a5d2-81821d817408) … |
...
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-09-04 | ⚠ 115 коммит(ов) в areas после сверки: 33bf88a8 Merge main into CHAT-455 (task fc0df848-3209-4105-9885-d65ca4c0e21a) … |
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-09-10 | ⚠ 30 коммит(ов) в areas после сверки: 33bf88a8 Merge main into CHAT-455 (task fc0df848-3209-4105-9885-d65ca4c0e21a) … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1431 коммит(ов) в areas после сверки: 33bf88a8 Merge main into CHAT-455 (task fc0df848-3209-4105-9885-d65ca4c0e21a) … |
...
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-12 | ⚠ 17 коммит(ов) в areas после сверки: 33bf88a8 Merge main into CHAT-455 (task fc0df848-3209-4105-9885-d65ca4c0e21a) … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-13 | ⚠ 4 коммит(ов) в areas после сверки: 33bf88a8 Merge main into CHAT-455 (task fc0df848-3209-4105-9885-d65ca4c0e21a) … |
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 330 коммит(ов) в areas после сверки: 33bf88a8 Merge main into CHAT-455 (task fc0df848-3209-4105-9885-d65ca4c0e21a) … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-09-12 | ⚠ 8 коммит(ов) в areas после сверки: 06c94c52 Merge main into CHAT-458 (task 9ae92e81-fdd5-42ba-a5d2-81821d817408) … |
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-13 | ⚠ 7 коммит(ов) в areas после сверки: 33bf88a8 Merge main into CHAT-455 (task fc0df848-3209-4105-9885-d65ca4c0e21a) … |
| [operations-app.md](operations-app.md) | Frontend-модуль Operations: граница, store и подключение | 2026-08-19 | ⚠ 231 коммит(ов) в areas после сверки: 06c94c52 Merge main into CHAT-458 (task 9ae92e81-fdd5-42ba-a5d2-81821d817408) … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-13 | ⚠ 2 коммит(ов) в areas после сверки: 33bf88a8 Merge main into CHAT-455 (task fc0df848-3209-4105-9885-d65ca4c0e21a) … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-09-10 | ⚠ 17 коммит(ов) в areas после сверки: 33bf88a8 Merge main into CHAT-455 (task fc0df848-3209-4105-9885-d65ca4c0e21a) … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-09-13 | ✓ |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-09-11 | ⚠ 16 коммит(ов) в areas после сверки: 33bf88a8 Merge main into CHAT-455 (task fc0df848-3209-4105-9885-d65ca4c0e21a) … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-13 | ⚠ 12 коммит(ов) в areas после сверки: 33bf88a8 Merge main into CHAT-455 (task fc0df848-3209-4105-9885-d65ca4c0e21a) … |
