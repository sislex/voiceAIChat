...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-20 | ⚠ 2 коммит(ов) в areas после сверки: 42f8ea61 Merge origin/main into CHAT-289 … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 469 коммит(ов) в areas после сверки: 42f8ea61 Merge origin/main into CHAT-289 … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-16 | ⚠ 52 коммит(ов) в areas после сверки: 785096bb feat(stt): isolate whisper in STT runner … |
