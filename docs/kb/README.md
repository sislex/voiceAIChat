...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 154 коммит(ов) в areas после сверки: ecfdf8b6 fix(projects): ссылка приглашения идемпотентна, смена роли проговаривается … |
...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 27 коммит(ов) в areas после сверки: ecfdf8b6 fix(projects): ссылка приглашения идемпотентна, смена роли проговаривается … |
...
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-08-25 | ⚠ 94 коммит(ов) в areas после сверки: ecfdf8b6 fix(projects): ссылка приглашения идемпотентна, смена роли проговаривается … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 784 коммит(ов) в areas после сверки: ecfdf8b6 fix(projects): ссылка приглашения идемпотентна, смена роли проговаривается … |
...
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-28 | ⚠ 52 коммит(ов) в areas после сверки: ecfdf8b6 fix(projects): ссылка приглашения идемпотентна, смена роли проговаривается … |
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-08-28 | ⚠ 27 коммит(ов) в areas после сверки: ecfdf8b6 fix(projects): ссылка приглашения идемпотентна, смена роли проговаривается … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-28 | ⚠ 28 коммит(ов) в areas после сверки: ecfdf8b6 fix(projects): ссылка приглашения идемпотентна, смена роли проговаривается … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-29 | ⚠ 1 коммит(ов) в areas после сверки: ecfdf8b6 fix(projects): ссылка приглашения идемпотентна, смена роли проговаривается |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-27 | ⚠ 36 коммит(ов) в areas после сверки: ecfdf8b6 fix(projects): ссылка приглашения идемпотентна, смена роли проговаривается … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-29 | ✓ |
