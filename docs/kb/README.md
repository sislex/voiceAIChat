...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-08-19 | ⚠ 199 коммит(ов) в areas после сверки: 4b23a49f Merge branch 'fix/account-dialogs-top-level': окна аккаунта открываются с любого маршрута … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-29 | ⚠ 129 коммит(ов) в areas после сверки: 4b23a49f Merge branch 'fix/account-dialogs-top-level': окна аккаунта открываются с любого маршрута … |
...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-08-31 | ⚠ 21 коммит(ов) в areas после сверки: 4b23a49f Merge branch 'fix/account-dialogs-top-level': окна аккаунта открываются с любого маршрута … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 127 коммит(ов) в areas после сверки: 4b23a49f Merge branch 'fix/account-dialogs-top-level': окна аккаунта открываются с любого маршрута … |
...
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-08-30 | ⚠ 62 коммит(ов) в areas после сверки: 4b23a49f Merge branch 'fix/account-dialogs-top-level': окна аккаунта открываются с любого маршрута … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 961 коммит(ов) в areas после сверки: 4b23a49f Merge branch 'fix/account-dialogs-top-level': окна аккаунта открываются с любого маршрута … |
...
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-29 | ⚠ 118 коммит(ов) в areas после сверки: 4b23a49f Merge branch 'fix/account-dialogs-top-level': окна аккаунта открываются с любого маршрута … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-08-28 | ⚠ 135 коммит(ов) в areas после сверки: 4b23a49f Merge branch 'fix/account-dialogs-top-level': окна аккаунта открываются с любого маршрута … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-31 | ⚠ 14 коммит(ов) в areas после сверки: 4b23a49f Merge branch 'fix/account-dialogs-top-level': окна аккаунта открываются с любого маршрута … |
| [operations-app.md](operations-app.md) | Frontend-модуль Operations: граница, store и подключение | 2026-08-19 | ⚠ 152 коммит(ов) в areas после сверки: 4b23a49f Merge branch 'fix/account-dialogs-top-level': окна аккаунта открываются с любого маршрута … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-31 | ⚠ 13 коммит(ов) в areas после сверки: 4b23a49f Merge branch 'fix/account-dialogs-top-level': окна аккаунта открываются с любого маршрута … |
