...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-06 | ⚠ 16 коммит(ов) в areas после сверки: ec5d38d feat(ui): add project chat selector to assistant header … |
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-08-08 | ✓ |
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-08 | ⚠ 1 коммит(ов) в areas после сверки: 345c7ef feat: serve web recorder in production |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-07 | ⚠ 11 коммит(ов) в areas после сверки: 345c7ef feat: serve web recorder in production … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 161 коммит(ов) в areas после сверки: e020e75 chatai-158: работа CI-рана … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-08 | ⚠ 1 коммит(ов) в areas после сверки: aa5fb97 fix(ui): make web reader full screen |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-08 | ⚠ 2 коммит(ов) в areas после сверки: 345c7ef feat: serve web recorder in production … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-08 | ⚠ 9 коммит(ов) в areas после сверки: ec5d38d feat(ui): add project chat selector to assistant header … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-09 | ✓ |
