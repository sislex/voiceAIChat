...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-05 | ⚠ 1 коммит(ов) в areas после сверки: 5cad358 feat: expose personal usage and account context |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 53 коммит(ов) в areas после сверки: 5cad358 feat: expose personal usage and account context … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-04 | ⚠ 7 коммит(ов) в areas после сверки: 5cad358 feat: expose personal usage and account context … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-05 | ⚠ 2 коммит(ов) в areas после сверки: 5cad358 feat: expose personal usage and account context … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-05 | ⚠ 2 коммит(ов) в areas после сверки: 5cad358 feat: expose personal usage and account context … |
