...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-08-19 | ⚠ 4 коммит(ов) в areas после сверки: ba1be0d3 feat(ui): add green interface theme … |
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-20 | ⚠ 6 коммит(ов) в areas после сверки: 8487fb08 Merge origin/main into CHAT-291 … |
...
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-08-20 | ⚠ 19 коммит(ов) в areas после сверки: 8487fb08 Merge origin/main into CHAT-291 … |
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-20 | ⚠ 15 коммит(ов) в areas после сверки: 8487fb08 Merge origin/main into CHAT-291 … |
...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-16 | ⚠ 54 коммит(ов) в areas после сверки: 8487fb08 Merge origin/main into CHAT-291 … |
| [features/llm-runners.md](features/llm-runners.md) | Исполнители LLM: контейнеры с claude/codex CLI | 2026-08-18 | ⚠ 7 коммит(ов) в areas после сверки: 8487fb08 Merge origin/main into CHAT-291 … |
...
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-19 | ⚠ 11 коммит(ов) в areas после сверки: 8487fb08 Merge origin/main into CHAT-291 … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-08-17 | ⚠ 9 коммит(ов) в areas после сверки: 8487fb08 Merge origin/main into CHAT-291 … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-20 | ⚠ 1 коммит(ов) в areas после сверки: ba1be0d3 feat(ui): add green interface theme |
...
| [stt-runner.md](stt-runner.md) | STT Runner: внутренний протокол, ресурсы и lifecycle | 2026-08-20 | ⚠ 6 коммит(ов) в areas после сверки: 8487fb08 Merge origin/main into CHAT-291 … |
...
| [tts-runner.md](tts-runner.md) | TTS Runner: ресурсный API, движки и жизненный цикл WAV | 2026-08-20 | ✓ |
...
- [2026-08-20-192-168-1-9-tts-runner.md](log/2026-08-20-192-168-1-9-tts-runner.md) — tts-runner
