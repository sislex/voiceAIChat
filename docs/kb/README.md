...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-08 | ⚠ 32 коммит(ов) в areas после сверки: 62d8bfc fix: pass release version to production deploy … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-10 | ⚠ 13 коммит(ов) в areas после сверки: 35c0471 fixed test … |
