...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-06 | ⚠ 34 коммит(ов) в areas после сверки: c1ace3e4 Merge remote-tracking branch 'origin/main' into feat/db-postgres … |
...
- [2026-09-07-alexeys-macbook-air-2-kanban-service-round1.md](log/2026-09-07-alexeys-macbook-air-2-kanban-service-round1.md) — kanban-service-round1
