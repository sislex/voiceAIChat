...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 213 коммит(ов) в areas после сверки: db0d72ff Extract Identity into a versioned independent application … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-17 | ⚠ 10 коммит(ов) в areas после сверки: db0d72ff Extract Identity into a versioned independent application … |
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 378 коммит(ов) в areas после сверки: db0d72ff Extract Identity into a versioned independent application … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-09-14 | ⚠ 42 коммит(ов) в areas после сверки: db0d72ff Extract Identity into a versioned independent application … |
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-16 | ⚠ 17 коммит(ов) в areas после сверки: db0d72ff Extract Identity into a versioned independent application … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-17 | ⚠ 2 коммит(ов) в areas после сверки: db0d72ff Extract Identity into a versioned independent application … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-09-17 | ⚠ 7 коммит(ов) в areas после сверки: db0d72ff Extract Identity into a versioned independent application … |
...
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-09-20 | ⚠ 4 коммит(ов) в areas после сверки: db0d72ff Extract Identity into a versioned independent application … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-20 | ⚠ 1 коммит(ов) в areas после сверки: db0d72ff Extract Identity into a versioned independent application |
