...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 226 коммит(ов) в areas после сверки: 60b95a53 fix(shared): keep renderer bridge contract complete … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-22 | ⚠ 5 коммит(ов) в areas после сверки: 60b95a53 fix(shared): keep renderer bridge contract complete … |
