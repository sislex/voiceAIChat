...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-20 | ⚠ 105 коммит(ов) в areas после сверки: b7250d17 feat(auth): открытая регистрация с подтверждением email — SMTP-клиент без зависимостей, заявки/verify, переключатель в админке, экраны регистрации … |
...
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-08-28 | ⚠ 1 коммит(ов) в areas после сверки: b7250d17 feat(auth): открытая регистрация с подтверждением email — SMTP-клиент без зависимостей, заявки/verify, переключатель в админке, экраны регистрации |
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 101 коммит(ов) в areas после сверки: b7250d17 feat(auth): открытая регистрация с подтверждением email — SMTP-клиент без зависимостей, заявки/verify, переключатель в админке, экраны регистрации … |
| [features/feature-preview.md](features/feature-preview.md) | Feature-preview окружения задач | 2026-08-23 | ⚠ 29 коммит(ов) в areas после сверки: b7250d17 feat(auth): открытая регистрация с подтверждением email — SMTP-клиент без зависимостей, заявки/verify, переключатель в админке, экраны регистрации … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-16 | ⚠ 134 коммит(ов) в areas после сверки: b7250d17 feat(auth): открытая регистрация с подтверждением email — SMTP-клиент без зависимостей, заявки/verify, переключатель в админке, экраны регистрации … |
| [features/llm-runners.md](features/llm-runners.md) | Исполнители LLM: контейнеры с claude/codex CLI | 2026-08-18 | ⚠ 68 коммит(ов) в areas после сверки: b7250d17 feat(auth): открытая регистрация с подтверждением email — SMTP-клиент без зависимостей, заявки/verify, переключатель в админке, экраны регистрации … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 725 коммит(ов) в areas после сверки: b7250d17 feat(auth): открытая регистрация с подтверждением email — SMTP-клиент без зависимостей, заявки/verify, переключатель в админке, экраны регистрации … |
...
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-27 | ⚠ 5 коммит(ов) в areas после сверки: b7250d17 feat(auth): открытая регистрация с подтверждением email — SMTP-клиент без зависимостей, заявки/verify, переключатель в админке, экраны регистрации … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-27 | ⚠ 1 коммит(ов) в areas после сверки: b7250d17 feat(auth): открытая регистрация с подтверждением email — SMTP-клиент без зависимостей, заявки/verify, переключатель в админке, экраны регистрации |
...
| [stt-runner.md](stt-runner.md) | STT Runner: внутренний протокол, ресурсы и lifecycle | 2026-08-20 | ⚠ 59 коммит(ов) в areas после сверки: b7250d17 feat(auth): открытая регистрация с подтверждением email — SMTP-клиент без зависимостей, заявки/verify, переключатель в админке, экраны регистрации … |
...
| [tts-runner.md](tts-runner.md) | TTS Runner: ресурсный API, движки и жизненный цикл WAV | 2026-08-26 | ⚠ 12 коммит(ов) в areas после сверки: b7250d17 feat(auth): открытая регистрация с подтверждением email — SMTP-клиент без зависимостей, заявки/verify, переключатель в админке, экраны регистрации … |
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-27 | ⚠ 1 коммит(ов) в areas после сверки: b7250d17 feat(auth): открытая регистрация с подтверждением email — SMTP-клиент без зависимостей, заявки/verify, переключатель в админке, экраны регистрации |
