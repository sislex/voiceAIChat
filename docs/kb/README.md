...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-09-01 | ⚠ 30 коммит(ов) в areas после сверки: e28067df feat: студия картинок — итерация улучшений 27 (корзина и стили) … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-03 | ⚠ 20 коммит(ов) в areas после сверки: e28067df feat: студия картинок — итерация улучшений 27 (корзина и стили) … |
...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 20 коммит(ов) в areas после сверки: e28067df feat: студия картинок — итерация улучшений 27 (корзина и стили) … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-02 | ⚠ 36 коммит(ов) в areas после сверки: e28067df feat: студия картинок — итерация улучшений 27 (корзина и стили) … |
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 228 коммит(ов) в areas после сверки: e28067df feat: студия картинок — итерация улучшений 27 (корзина и стили) … |
