...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-08-19 | ⚠ 142 коммит(ов) в areas после сверки: 3653d83d feat(qa-stage): набор сценариев вместо одного … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-29 | ⚠ 33 коммит(ов) в areas после сверки: 363e0e04 feat(kanban): форма запуска подготовки как остальные вкладки карточки, круг 5 … |
...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 60 коммит(ов) в areas после сверки: 3653d83d feat(qa-stage): набор сценариев вместо одного … |
...
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-24 | ⚠ 129 коммит(ов) в areas после сверки: 2aa08d76 Merge remote-tracking branch 'origin/main' into work3 … |
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-08-30 | ⚠ 4 коммит(ов) в areas после сверки: 3653d83d feat(qa-stage): набор сценариев вместо одного … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 869 коммит(ов) в areas после сверки: 363e0e04 feat(kanban): форма запуска подготовки как остальные вкладки карточки, круг 5 … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-30 | ⚠ 7 коммит(ов) в areas после сверки: 363e0e04 feat(kanban): форма запуска подготовки как остальные вкладки карточки, круг 5 … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-29 | ⚠ 31 коммит(ов) в areas после сверки: 363e0e04 feat(kanban): форма запуска подготовки как остальные вкладки карточки, круг 5 … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-08-28 | ⚠ 61 коммит(ов) в areas после сверки: 363e0e04 feat(kanban): форма запуска подготовки как остальные вкладки карточки, круг 5 … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-28 | ⚠ 59 коммит(ов) в areas после сверки: 3653d83d feat(qa-stage): набор сценариев вместо одного … |
| [operations-app.md](operations-app.md) | Frontend-модуль Operations: граница, store и подключение | 2026-08-19 | ⚠ 103 коммит(ов) в areas после сверки: 3653d83d feat(qa-stage): набор сценариев вместо одного … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-29 | ⚠ 19 коммит(ов) в areas после сверки: 363e0e04 feat(kanban): форма запуска подготовки как остальные вкладки карточки, круг 5 … |
...
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-30 | ⚠ 1 коммит(ов) в areas после сверки: 9ebb21c4 feat(qa): русские статусы и общие состояния во вкладках настроек и QA, круг 4 |
...
| [testing-operations.md](testing-operations.md) | Разработка, тестирование, диагностика и эксплуатация | 2026-08-30 | ⚠ 2 коммит(ов) в areas после сверки: 3653d83d feat(qa-stage): набор сценариев вместо одного … |
