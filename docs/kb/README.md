...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-09-01 | ⚠ 66 коммит(ов) в areas после сверки: f6b08fe6 CHAT-427 open conversation settings immediately … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-09-08 | ⚠ 3 коммит(ов) в areas после сверки: 3e65e459 fix(ci, releases): обратное давление на поток вывода команд; событие релиза только при смене статуса шага … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-06 | ⚠ 49 коммит(ов) в areas после сверки: 3e65e459 fix(ci, releases): обратное давление на поток вывода команд; событие релиза только при смене статуса шага … |
...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 106 коммит(ов) в areas после сверки: 06b670cf Merge main into CHAT-427 (task bd2a2869-807e-4180-a240-b5d568d28727) … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 277 коммит(ов) в areas после сверки: 06b670cf Merge main into CHAT-427 (task bd2a2869-807e-4180-a240-b5d568d28727) … |
...
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-09-04 | ⚠ 70 коммит(ов) в areas после сверки: 0aea426b fix(projects): черновики доработок читают вложения через порт с await … |
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-09-04 | ⚠ 57 коммит(ов) в areas после сверки: f6b08fe6 CHAT-427 open conversation settings immediately … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1260 коммит(ов) в areas после сверки: be6b9602 docs(kb): update after merge bd2a2869-807e-4180-a240-b5d568d28727 … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-09-06 | ⚠ 31 коммит(ов) в areas после сверки: 7ce37a59 Merge remote-tracking branch 'origin/main' into feat/distributed-polish … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-05 | ⚠ 74 коммит(ов) в areas после сверки: 3e65e459 fix(ci, releases): обратное давление на поток вывода команд; событие релиза только при смене статуса шага … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-05 | ⚠ 68 коммит(ов) в areas после сверки: 06b670cf Merge main into CHAT-427 (task bd2a2869-807e-4180-a240-b5d568d28727) … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-07 | ⚠ 34 коммит(ов) в areas после сверки: 3e65e459 fix(ci, releases): обратное давление на поток вывода команд; событие релиза только при смене статуса шага … |
| [operations-app.md](operations-app.md) | Frontend-модуль Operations: граница, store и подключение | 2026-08-19 | ⚠ 209 коммит(ов) в areas после сверки: f6b08fe6 CHAT-427 open conversation settings immediately … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-08 | ⚠ 7 коммит(ов) в areas после сверки: 06b670cf Merge main into CHAT-427 (task bd2a2869-807e-4180-a240-b5d568d28727) … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-09-08 | ⚠ 5 коммит(ов) в areas после сверки: 3e65e459 fix(ci, releases): обратное давление на поток вывода команд; событие релиза только при смене статуса шага … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-08 | ⚠ 1 коммит(ов) в areas после сверки: 3e65e459 fix(ci, releases): обратное давление на поток вывода команд; событие релиза только при смене статуса шага |
