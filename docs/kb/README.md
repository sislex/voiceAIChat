...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 216 коммит(ов) в areas после сверки: 92c0f7e2 Integrate Billing and stable Identity with independent component releases … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 372 коммит(ов) в areas после сверки: 92c0f7e2 Integrate Billing and stable Identity with independent component releases … |
| [features/llm-runners.md](features/llm-runners.md) | Исполнители LLM: контейнеры с claude/codex CLI | 2026-09-12 | ⚠ 19 коммит(ов) в areas после сверки: 92c0f7e2 Integrate Billing and stable Identity with independent component releases … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-17 | ⚠ 13 коммит(ов) в areas после сверки: 92c0f7e2 Integrate Billing and stable Identity with independent component releases … |
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 381 коммит(ов) в areas после сверки: 92c0f7e2 Integrate Billing and stable Identity with independent component releases … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-09-14 | ⚠ 45 коммит(ов) в areas после сверки: 92c0f7e2 Integrate Billing and stable Identity with independent component releases … |
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-16 | ⚠ 20 коммит(ов) в areas после сверки: 92c0f7e2 Integrate Billing and stable Identity with independent component releases … |
...
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-09-17 | ⚠ 10 коммит(ов) в areas после сверки: 92c0f7e2 Integrate Billing and stable Identity with independent component releases … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-09-15 | ⚠ 58 коммит(ов) в areas после сверки: 92c0f7e2 Integrate Billing and stable Identity with independent component releases … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-09-20 | ⚠ 2 коммит(ов) в areas после сверки: 92c0f7e2 Integrate Billing and stable Identity with independent component releases … |
| [stt-runner.md](stt-runner.md) | STT Runner: внутренний протокол, ресурсы и lifecycle | 2026-08-20 | ⚠ 211 коммит(ов) в areas после сверки: 92c0f7e2 Integrate Billing and stable Identity with independent component releases … |
...
| [tts-runner.md](tts-runner.md) | TTS Runner: ресурсный API, движки и жизненный цикл WAV | 2026-08-26 | ⚠ 163 коммит(ов) в areas после сверки: 92c0f7e2 Integrate Billing and stable Identity with independent component releases … |
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-20 | ⚠ 4 коммит(ов) в areas после сверки: 92c0f7e2 Integrate Billing and stable Identity with independent component releases … |
