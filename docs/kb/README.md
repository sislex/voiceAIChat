...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-07-27 | ⚠ 1 коммит(ов) в areas после сверки: 02dc1b7 feat(projects): add agent feature workflow |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-07-28 | ⚠ 1 коммит(ов) в areas после сверки: 02dc1b7 feat(projects): add agent feature workflow |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-07-28 | ⚠ 1 коммит(ов) в areas после сверки: 02dc1b7 feat(projects): add agent feature workflow |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-07-27 | ⚠ 4 коммит(ов) в areas после сверки: 02dc1b7 feat(projects): add agent feature workflow … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-07-27 | ⚠ 3 коммит(ов) в areas после сверки: 02dc1b7 feat(projects): add agent feature workflow … |
