...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-27 | ⚠ 1 коммит(ов) в areas после сверки: a9a1aed3 feat(make): drag-and-drop файлов в проект и подсветка синтаксиса в редакторе |
