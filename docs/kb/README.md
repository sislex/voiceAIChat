...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 868 коммит(ов) в areas после сверки: c77005d0 fix(reader): внутренний адрес алиаса больше не уезжает в сценарий … |
...
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 131 коммит(ов) в areas после сверки: c77005d0 fix(reader): внутренний адрес алиаса больше не уезжает в сценарий … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-29 | ⚠ 17 коммит(ов) в areas после сверки: c77005d0 fix(reader): внутренний адрес алиаса больше не уезжает в сценарий … |
...
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-29 | ⚠ 36 коммит(ов) в areas после сверки: c77005d0 fix(reader): внутренний адрес алиаса больше не уезжает в сценарий … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-30 | ⚠ 10 коммит(ов) в areas после сверки: c77005d0 fix(reader): внутренний адрес алиаса больше не уезжает в сценарий … |
