...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-01 | ⚠ 1 коммит(ов) в areas после сверки: 8ded752 CHAT-55: точные бусты по токенам запроса и путям, компактный запрос авто-инъекции БЗ |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-07-27 | ⚠ 56 коммит(ов) в areas после сверки: 8ded752 CHAT-55: точные бусты по токенам запроса и путям, компактный запрос авто-инъекции БЗ … |
