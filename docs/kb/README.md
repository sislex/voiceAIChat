...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-17 | ⚠ 2 коммит(ов) в areas после сверки: c973c6d Merge task 9b300fea-8f64-4c04-bbcf-76086d459603 … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 377 коммит(ов) в areas после сверки: 154a401 docs(kb): update after merge 0dfeebbd-8d46-4a4e-9e77-850f55c0c55c … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-17 | ⚠ 4 коммит(ов) в areas после сверки: c973c6d Merge task 9b300fea-8f64-4c04-bbcf-76086d459603 … |
