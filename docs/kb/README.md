...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-08-19 | ⚠ 202 коммит(ов) в areas после сверки: 1ef1f9e1 Merge branch 'feat/context-inspector-improvements': три круга улучшений «Контекста и инструкций» … |
...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-08-31 | ⚠ 26 коммит(ов) в areas после сверки: 1ef1f9e1 Merge branch 'feat/context-inspector-improvements': три круга улучшений «Контекста и инструкций» … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 131 коммит(ов) в areas после сверки: 1ef1f9e1 Merge branch 'feat/context-inspector-improvements': три круга улучшений «Контекста и инструкций» … |
| [features/llm-runners.md](features/llm-runners.md) | Исполнители LLM: контейнеры с claude/codex CLI | 2026-08-18 | ⚠ 109 коммит(ов) в areas после сверки: 1ef1f9e1 Merge branch 'feat/context-inspector-improvements': три круга улучшений «Контекста и инструкций» … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-08-28 | ⚠ 138 коммит(ов) в areas после сверки: 1ef1f9e1 Merge branch 'feat/context-inspector-improvements': три круга улучшений «Контекста и инструкций» … |
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 175 коммит(ов) в areas после сверки: 1ef1f9e1 Merge branch 'feat/context-inspector-improvements': три круга улучшений «Контекста и инструкций» … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-08-31 | ⚠ 8 коммит(ов) в areas после сверки: 1ef1f9e1 Merge branch 'feat/context-inspector-improvements': три круга улучшений «Контекста и инструкций» … |
...
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-31 | ⚠ 5 коммит(ов) в areas после сверки: 1ef1f9e1 Merge branch 'feat/context-inspector-improvements': три круга улучшений «Контекста и инструкций» … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-31 | ⚠ 16 коммит(ов) в areas после сверки: 1ef1f9e1 Merge branch 'feat/context-inspector-improvements': три круга улучшений «Контекста и инструкций» … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-31 | ⚠ 6 коммит(ов) в areas после сверки: de2cd726 fix(ui-tests): findBy* ждёт ленивый чанк 5 секунд, а не одну … |
