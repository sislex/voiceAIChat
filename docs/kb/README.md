...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-16 | ⚠ 3 коммит(ов) в areas после сверки: 7c9c968 Merge task 29841760-d6bd-4fc5-a5a2-ed4b5932bd50 … |
| [features/feature-preview.md](features/feature-preview.md) | Feature-preview окружения задач | 2026-08-14 | ⚠ код изменён 2026-08-16, сверка 2026-08-14 (по датам: правки того же дня не видны — поставь checked) |
...
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-17 | ⚠ 2 коммит(ов) в areas после сверки: 7c9c968 Merge task 29841760-d6bd-4fc5-a5a2-ed4b5932bd50 … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 372 коммит(ов) в areas после сверки: 3396f37 docs(kb): update after merge df9d98f6-73b3-420d-80d0-0b2bbf0f79d0 … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-16 | ⚠ 3 коммит(ов) в areas после сверки: 7c9c968 Merge task 29841760-d6bd-4fc5-a5a2-ed4b5932bd50 … |
