...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-06 | ⚠ 35 коммит(ов) в areas после сверки: 8facc58 fix: separate task CI result from latest attempt … |
...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-07 | ⚠ 32 коммит(ов) в areas после сверки: 8facc58 fix: separate task CI result from latest attempt … |
...
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-08-10 | ⚠ 12 коммит(ов) в areas после сверки: 8facc58 fix: separate task CI result from latest attempt … |
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-12 | ⚠ 6 коммит(ов) в areas после сверки: 8facc58 fix: separate task CI result from latest attempt … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 224 коммит(ов) в areas после сверки: 8facc58 fix: separate task CI result from latest attempt … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-12 | ⚠ 2 коммит(ов) в areas после сверки: 8facc58 fix: separate task CI result from latest attempt … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-12 | ⚠ 4 коммит(ов) в areas после сверки: 8facc58 fix: separate task CI result from latest attempt … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-11 | ⚠ 11 коммит(ов) в areas после сверки: 8facc58 fix: separate task CI result from latest attempt … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-08 | ⚠ 39 коммит(ов) в areas после сверки: 8facc58 fix: separate task CI result from latest attempt … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-10 | ⚠ 18 коммит(ов) в areas после сверки: 8facc58 fix: separate task CI result from latest attempt … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-10 | ⚠ 21 коммит(ов) в areas после сверки: 8facc58 fix: separate task CI result from latest attempt … |
