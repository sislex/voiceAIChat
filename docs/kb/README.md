...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-09 | ⚠ 61 коммит(ов) в areas после сверки: 679cb84f feat(kanban): copy task permalinks … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1393 коммит(ов) в areas после сверки: 679cb84f feat(kanban): copy task permalinks … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-09-11 | ⚠ 34 коммит(ов) в areas после сверки: 679cb84f feat(kanban): copy task permalinks … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-10 | ⚠ 35 коммит(ов) в areas после сверки: 679cb84f feat(kanban): copy task permalinks … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-12 | ⚠ 1 коммит(ов) в areas после сверки: 679cb84f feat(kanban): copy task permalinks |
