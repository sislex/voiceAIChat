...
|---|---|---|---|
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-01 | ⚠ 91 коммит(ов) в areas после сверки: da0cd12 Merge task a752dbf4-7431-4740-8ed3-14257b87de28 … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 289 коммит(ов) в areas после сверки: da0cd12 Merge task a752dbf4-7431-4740-8ed3-14257b87de28 … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-13 | ⚠ 23 коммит(ов) в areas после сверки: da0cd12 Merge task a752dbf4-7431-4740-8ed3-14257b87de28 … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-12 | ⚠ 20 коммит(ов) в areas после сверки: da0cd12 Merge task a752dbf4-7431-4740-8ed3-14257b87de28 … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-08 | ⚠ 84 коммит(ов) в areas после сверки: da0cd12 Merge task a752dbf4-7431-4740-8ed3-14257b87de28 … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-10 | ⚠ 39 коммит(ов) в areas после сверки: da0cd12 Merge task a752dbf4-7431-4740-8ed3-14257b87de28 … |
