...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-09 | ⚠ 52 коммит(ов) в areas после сверки: 80eb824b feat(kanban): explain child task progress … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1384 коммит(ов) в areas после сверки: 80eb824b feat(kanban): explain child task progress … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-09-11 | ⚠ 25 коммит(ов) в areas после сверки: 80eb824b feat(kanban): explain child task progress … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-10 | ⚠ 27 коммит(ов) в areas после сверки: 80eb824b feat(kanban): explain child task progress … |
| [features/task-autopilot.md](features/task-autopilot.md) | Автопроход задачи по QA-конвейеру | 2026-09-11 | ⚠ 11 коммит(ов) в areas после сверки: 80eb824b feat(kanban): explain child task progress … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-11 | ⚠ 16 коммит(ов) в areas после сверки: 80eb824b feat(kanban): explain child task progress … |
