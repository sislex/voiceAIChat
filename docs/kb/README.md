...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-20 | ⚠ 33 коммит(ов) в areas после сверки: f6a59e5f merge(main): resolve CHAT-312 platform conflicts … |
...
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-08-20 | ⚠ 35 коммит(ов) в areas после сверки: 22b413d4 feat(releases): add managed production environments … |
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-22 | ⚠ 1 коммит(ов) в areas после сверки: 22b413d4 feat(releases): add managed production environments |
| [features/feature-preview.md](features/feature-preview.md) | Feature-preview окружения задач | 2026-08-22 | ⚠ 1 коммит(ов) в areas после сверки: 22b413d4 feat(releases): add managed production environments |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-16 | ⚠ 83 коммит(ов) в areas после сверки: 22b413d4 feat(releases): add managed production environments … |
| [features/llm-runners.md](features/llm-runners.md) | Исполнители LLM: контейнеры с claude/codex CLI | 2026-08-18 | ⚠ 25 коммит(ов) в areas после сверки: f6a59e5f merge(main): resolve CHAT-312 platform conflicts … |
...
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 10 коммит(ов) в areas после сверки: 22b413d4 feat(releases): add managed production environments … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-22 | ⚠ 5 коммит(ов) в areas после сверки: 22b413d4 feat(releases): add managed production environments … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-22 | ⚠ 17 коммит(ов) в areas после сверки: f6a59e5f merge(main): resolve CHAT-312 platform conflicts … |
...
| [stt-runner.md](stt-runner.md) | STT Runner: внутренний протокол, ресурсы и lifecycle | 2026-08-20 | ⚠ 22 коммит(ов) в areas после сверки: 22b413d4 feat(releases): add managed production environments … |
...
| [tts-runner.md](tts-runner.md) | TTS Runner: ресурсный API, движки и жизненный цикл WAV | 2026-08-20 | ⚠ 16 коммит(ов) в areas после сверки: 22b413d4 feat(releases): add managed production environments … |
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-21 | ⚠ 25 коммит(ов) в areas после сверки: 22b413d4 feat(releases): add managed production environments … |
