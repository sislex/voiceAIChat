...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-17 | ⚠ 13 коммит(ов) в areas после сверки: 236412e Merge main into CHAT-263 … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-17 | ⚠ 16 коммит(ов) в areas после сверки: 236412e Merge main into CHAT-263 … |
| [features/feature-preview.md](features/feature-preview.md) | Feature-preview окружения задач | 2026-08-17 | ⚠ 7 коммит(ов) в areas после сверки: 236412e Merge main into CHAT-263 … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-16 | ⚠ 24 коммит(ов) в areas после сверки: 236412e Merge main into CHAT-263 … |
...
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-08-17 | ⚠ 7 коммит(ов) в areas после сверки: 236412e Merge main into CHAT-263 … |
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-17 | ⚠ 23 коммит(ов) в areas после сверки: 236412e Merge main into CHAT-263 … |
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-08-16 | ⚠ 26 коммит(ов) в areas после сверки: 236412e Merge main into CHAT-263 … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 415 коммит(ов) в areas после сверки: 236412e Merge main into CHAT-263 … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-16 | ⚠ 26 коммит(ов) в areas после сверки: 236412e Merge main into CHAT-263 … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-17 | ⚠ 5 коммит(ов) в areas после сверки: 236412e Merge main into CHAT-263 … |
...
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-17 | ⚠ 5 коммит(ов) в areas после сверки: 236412e Merge main into CHAT-263 … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-17 | ⚠ 2 коммит(ов) в areas после сверки: 236412e Merge main into CHAT-263 … |
