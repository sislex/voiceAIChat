...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-09-01 | ⚠ 32 коммит(ов) в areas после сверки: 593eae9f feat: студия картинок 37–45, автопочинка merge-рана и кнопка исправления в чате … |
...
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-08-30 | ⚠ 57 коммит(ов) в areas после сверки: 593eae9f feat: студия картинок 37–45, автопочинка merge-рана и кнопка исправления в чате … |
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-04 | ⚠ 1 коммит(ов) в areas после сверки: 593eae9f feat: студия картинок 37–45, автопочинка merge-рана и кнопка исправления в чате |
...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 22 коммит(ов) в areas после сверки: 593eae9f feat: студия картинок 37–45, автопочинка merge-рана и кнопка исправления в чате … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 199 коммит(ов) в areas после сверки: 593eae9f feat: студия картинок 37–45, автопочинка merge-рана и кнопка исправления в чате … |
...
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-09-03 | ⚠ 16 коммит(ов) в areas после сверки: 593eae9f feat: студия картинок 37–45, автопочинка merge-рана и кнопка исправления в чате … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1125 коммит(ов) в areas после сверки: 593eae9f feat: студия картинок 37–45, автопочинка merge-рана и кнопка исправления в чате … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-30 | ⚠ 166 коммит(ов) в areas после сверки: 593eae9f feat: студия картинок 37–45, автопочинка merge-рана и кнопка исправления в чате … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-29 | ⚠ 211 коммит(ов) в areas после сверки: 593eae9f feat: студия картинок 37–45, автопочинка merge-рана и кнопка исправления в чате … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-02 | ⚠ 38 коммит(ов) в areas после сверки: 593eae9f feat: студия картинок 37–45, автопочинка merge-рана и кнопка исправления в чате … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-02 | ⚠ 21 коммит(ов) в areas после сверки: 593eae9f feat: студия картинок 37–45, автопочинка merge-рана и кнопка исправления в чате … |
| [operations-app.md](operations-app.md) | Frontend-модуль Operations: граница, store и подключение | 2026-08-19 | ⚠ 188 коммит(ов) в areas после сверки: 593eae9f feat: студия картинок 37–45, автопочинка merge-рана и кнопка исправления в чате … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-03 | ⚠ 25 коммит(ов) в areas после сверки: 593eae9f feat: студия картинок 37–45, автопочинка merge-рана и кнопка исправления в чате … |
...
- [2026-09-04-alexeys-macbook-air-2-image-studio-improvements-46.md](log/2026-09-04-alexeys-macbook-air-2-image-studio-improvements-46.md) — image-studio-improvements-46
