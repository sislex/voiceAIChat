...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 227 коммит(ов) в areas после сверки: c6c97eb1 feat: account for usage across services (#242) … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 381 коммит(ов) в areas после сверки: c6c97eb1 feat: account for usage across services (#242) … |
| [features/llm-runners.md](features/llm-runners.md) | Исполнители LLM: контейнеры с claude/codex CLI | 2026-09-12 | ⚠ 25 коммит(ов) в areas после сверки: c6c97eb1 feat: account for usage across services (#242) … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-17 | ⚠ 24 коммит(ов) в areas после сверки: c6c97eb1 feat: account for usage across services (#242) … |
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 392 коммит(ов) в areas после сверки: c6c97eb1 feat: account for usage across services (#242) … |
...
| [testing-operations.md](testing-operations.md) | Разработка, тестирование, диагностика и эксплуатация | 2026-09-22 | ⚠ 1 коммит(ов) в areas после сверки: c6c97eb1 feat: account for usage across services (#242) |
| [tts-runner.md](tts-runner.md) | TTS Runner: ресурсный API, движки и жизненный цикл WAV | 2026-08-26 | ⚠ 173 коммит(ов) в areas после сверки: c6c97eb1 feat: account for usage across services (#242) … |
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-22 | ⚠ 2 коммит(ов) в areas после сверки: c6c97eb1 feat: account for usage across services (#242) … |
