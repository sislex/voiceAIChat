...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-09 | ⚠ 59 коммит(ов) в areas после сверки: 1c1cdb21 feat(kanban): move tasks to any stage from menu … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1391 коммит(ов) в areas после сверки: 1c1cdb21 feat(kanban): move tasks to any stage from menu … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-09-11 | ⚠ 32 коммит(ов) в areas после сверки: 1c1cdb21 feat(kanban): move tasks to any stage from menu … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-10 | ⚠ 33 коммит(ов) в areas после сверки: 1c1cdb21 feat(kanban): move tasks to any stage from menu … |
| [features/task-autopilot.md](features/task-autopilot.md) | Автопроход задачи по QA-конвейеру | 2026-09-11 | ⚠ 13 коммит(ов) в areas после сверки: 1c1cdb21 feat(kanban): move tasks to any stage from menu … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-11 | ⚠ 23 коммит(ов) в areas после сверки: 1c1cdb21 feat(kanban): move tasks to any stage from menu … |
