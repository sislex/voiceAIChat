...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-02 | ⚠ 12 коммит(ов) в areas после сверки: ecfec79c merge: update CHAT-391 from main … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-02 | ⚠ 15 коммит(ов) в areas после сверки: ecfec79c merge: update CHAT-391 from main … |
