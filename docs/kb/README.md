...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 164 коммит(ов) в areas после сверки: 4b237176 fix(ui): вернуть раскладку страницы консоли, выпавшую из правил … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 803 коммит(ов) в areas после сверки: 4b237176 fix(ui): вернуть раскладку страницы консоли, выпавшую из правил … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-29 | ⚠ 1 коммит(ов) в areas после сверки: 4b237176 fix(ui): вернуть раскладку страницы консоли, выпавшую из правил |
