...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 535 коммит(ов) в areas после сверки: b6d4f3b2 docs(kb): update after merge 8ae5b130-5fca-4e3c-b24b-d942c0012cd4 … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-23 | ⚠ 1 коммит(ов) в areas после сверки: 0358a806 feat: add resumable legacy storage migration backend |
