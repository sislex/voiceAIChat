...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-25 | ⚠ 5 коммит(ов) в areas после сверки: f15e8c6d fix(agent): expose npm to supervised commands … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-25 | ⚠ 5 коммит(ов) в areas после сверки: f15e8c6d fix(agent): expose npm to supervised commands … |
