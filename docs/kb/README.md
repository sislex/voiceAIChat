...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 204 коммит(ов) в areas после сверки: 21a3047 fix: isolate release preflight fetch ref … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-11 | ⚠ 5 коммит(ов) в areas после сверки: 21a3047 fix: isolate release preflight fetch ref … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-08 | ⚠ 27 коммит(ов) в areas после сверки: 21a3047 fix: isolate release preflight fetch ref … |
