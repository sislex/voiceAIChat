...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-10 | ⚠ 8 коммит(ов) в areas после сверки: 0465712 CHAT-179: не сохранять пустые разговоры … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 215 коммит(ов) в areas после сверки: 0465712 CHAT-179: не сохранять пустые разговоры … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-12 | ⚠ 3 коммит(ов) в areas после сверки: 0465712 CHAT-179: не сохранять пустые разговоры … |
