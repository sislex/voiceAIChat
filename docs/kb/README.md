...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-20 | ⚠ 131 коммит(ов) в areas после сверки: 0d3fb22f fix(session): истёкшая сессия наконец обрабатывается … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 146 коммит(ов) в areas после сверки: 0d3fb22f fix(session): истёкшая сессия наконец обрабатывается … |
...
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-24 | ⚠ 92 коммит(ов) в areas после сверки: 0d3fb22f fix(session): истёкшая сессия наконец обрабатывается … |
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-08-25 | ⚠ 87 коммит(ов) в areas после сверки: 0d3fb22f fix(session): истёкшая сессия наконец обрабатывается … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 773 коммит(ов) в areas после сверки: 0d3fb22f fix(session): истёкшая сессия наконец обрабатывается … |
...
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-28 | ⚠ 44 коммит(ов) в areas после сверки: 0d3fb22f fix(session): истёкшая сессия наконец обрабатывается … |
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-08-28 | ⚠ 20 коммит(ов) в areas после сверки: 0d3fb22f fix(session): истёкшая сессия наконец обрабатывается … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-28 | ⚠ 21 коммит(ов) в areas после сверки: 0d3fb22f fix(session): истёкшая сессия наконец обрабатывается … |
...
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-27 | ⚠ 31 коммит(ов) в areas после сверки: 0d3fb22f fix(session): истёкшая сессия наконец обрабатывается … |
...
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-27 | ⚠ 27 коммит(ов) в areas после сверки: 0d3fb22f fix(session): истёкшая сессия наконец обрабатывается … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-29 | ⚠ 8 коммит(ов) в areas после сверки: 0d3fb22f fix(session): истёкшая сессия наконец обрабатывается … |
