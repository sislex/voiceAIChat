...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-26 | ⚠ 1 коммит(ов) в areas после сверки: ac0f6d6a feat(context): полный drill-in пунктов инспектора (персонализация/проект/MCP) |
