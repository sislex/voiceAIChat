...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-29 | ⚠ 51 коммит(ов) в areas после сверки: 20992d1c Merge remote-tracking branch 'origin/main' into work3 … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 890 коммит(ов) в areas после сверки: 20992d1c Merge remote-tracking branch 'origin/main' into work3 … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-30 | ⚠ 20 коммит(ов) в areas после сверки: 20992d1c Merge remote-tracking branch 'origin/main' into work3 … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-29 | ⚠ 49 коммит(ов) в areas после сверки: 20992d1c Merge remote-tracking branch 'origin/main' into work3 … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-29 | ⚠ 38 коммит(ов) в areas после сверки: 20992d1c Merge remote-tracking branch 'origin/main' into work3 … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-30 | ⚠ 5 коммит(ов) в areas после сверки: 20992d1c Merge remote-tracking branch 'origin/main' into work3 … |
