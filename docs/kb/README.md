...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1299 коммит(ов) в areas после сверки: a5b4fde6 fix(reader): support nested frame navigation and model actions (cycle 09) … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-09-10 | ⚠ 1 коммит(ов) в areas после сверки: a5b4fde6 fix(reader): support nested frame navigation and model actions (cycle 09) |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-09-09 | ⚠ 13 коммит(ов) в areas после сверки: a5b4fde6 fix(reader): support nested frame navigation and model actions (cycle 09) … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-09-09 | ⚠ 13 коммит(ов) в areas после сверки: a5b4fde6 fix(reader): support nested frame navigation and model actions (cycle 09) … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-10 | ⚠ 7 коммит(ов) в areas после сверки: a5b4fde6 fix(reader): support nested frame navigation and model actions (cycle 09) … |
