...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-09-01 | ⚠ 78 коммит(ов) в areas после сверки: b08c8536 Merge main into CHAT-439 (task bbba3ffd-e474-4e1d-92bb-27b52bbafa53) … |
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-09-09 | ⚠ 4 коммит(ов) в areas после сверки: 4391cd01 fix(reader): restore own-app preview through trusted host aliases … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-09 | ⚠ 11 коммит(ов) в areas после сверки: b08c8536 Merge main into CHAT-439 (task bbba3ffd-e474-4e1d-92bb-27b52bbafa53) … |
...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 128 коммит(ов) в areas после сверки: b08c8536 Merge main into CHAT-439 (task bbba3ffd-e474-4e1d-92bb-27b52bbafa53) … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 299 коммит(ов) в areas после сверки: b08c8536 Merge main into CHAT-439 (task bbba3ffd-e474-4e1d-92bb-27b52bbafa53) … |
...
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-09-04 | ⚠ 89 коммит(ов) в areas после сверки: 388a9c63 fix(ui): keep task chat composer docked … |
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-09-09 | ⚠ 6 коммит(ов) в areas после сверки: b08c8536 Merge main into CHAT-439 (task bbba3ffd-e474-4e1d-92bb-27b52bbafa53) … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1292 коммит(ов) в areas после сверки: 74bdd84e docs(kb): update after merge bbba3ffd-e474-4e1d-92bb-27b52bbafa53 … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-09-06 | ⚠ 51 коммит(ов) в areas после сверки: 388a9c63 fix(ui): keep task chat composer docked … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-08 | ⚠ 17 коммит(ов) в areas после сверки: b08c8536 Merge main into CHAT-439 (task bbba3ffd-e474-4e1d-92bb-27b52bbafa53) … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-05 | ⚠ 90 коммит(ов) в areas после сверки: b08c8536 Merge main into CHAT-439 (task bbba3ffd-e474-4e1d-92bb-27b52bbafa53) … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-08 | ⚠ 12 коммит(ов) в areas после сверки: b08c8536 Merge main into CHAT-439 (task bbba3ffd-e474-4e1d-92bb-27b52bbafa53) … |
| [operations-app.md](operations-app.md) | Frontend-модуль Operations: граница, store и подключение | 2026-08-19 | ⚠ 217 коммит(ов) в areas после сверки: b08c8536 Merge main into CHAT-439 (task bbba3ffd-e474-4e1d-92bb-27b52bbafa53) … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-09 | ⚠ 5 коммит(ов) в areas после сверки: b08c8536 Merge main into CHAT-439 (task bbba3ffd-e474-4e1d-92bb-27b52bbafa53) … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-09-09 | ⚠ 3 коммит(ов) в areas после сверки: 4391cd01 fix(reader): restore own-app preview through trusted host aliases … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-09-09 | ⚠ 9 коммит(ов) в areas после сверки: b08c8536 Merge main into CHAT-439 (task bbba3ffd-e474-4e1d-92bb-27b52bbafa53) … |
