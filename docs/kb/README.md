...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-09 | ⚠ 49 коммит(ов) в areas после сверки: 993d120b feat(kanban): add searchable facet filters … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1381 коммит(ов) в areas после сверки: 993d120b feat(kanban): add searchable facet filters … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-09-11 | ⚠ 22 коммит(ов) в areas после сверки: 993d120b feat(kanban): add searchable facet filters … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-10 | ⚠ 25 коммит(ов) в areas после сверки: 993d120b feat(kanban): add searchable facet filters … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-11 | ⚠ 13 коммит(ов) в areas после сверки: 993d120b feat(kanban): add searchable facet filters … |
