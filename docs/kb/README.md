...
|---|---|---|---|
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-01 | ⚠ 69 коммит(ов) в areas после сверки: e7c8311 CHAT-177 filter chat machines by access … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-06 | ⚠ 32 коммит(ов) в areas после сверки: e7c8311 CHAT-177 filter chat machines by access … |
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-08-12 | ✓ |
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-12 | ⚠ 3 коммит(ов) в areas после сверки: 8d39e1f Merge CHAT-177 … |
...
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-08-10 | ⚠ 9 коммит(ов) в areas после сверки: e7c8311 CHAT-177 filter chat machines by access … |
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-12 | ⚠ 3 коммит(ов) в areas после сверки: 8d39e1f Merge CHAT-177 … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 219 коммит(ов) в areas после сверки: 8d39e1f Merge CHAT-177 … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-12 | ⚠ 3 коммит(ов) в areas после сверки: e7c8311 CHAT-177 filter chat machines by access … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-12 | ✓ |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-11 | ⚠ 8 коммит(ов) в areas после сверки: 8d39e1f Merge CHAT-177 … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-08 | ⚠ 22 коммит(ов) в areas после сверки: e7c8311 CHAT-177 filter chat machines by access … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-08 | ⚠ 35 коммит(ов) в areas после сверки: e7c8311 CHAT-177 filter chat machines by access … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-10 | ⚠ 14 коммит(ов) в areas после сверки: e7c8311 CHAT-177 filter chat machines by access … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-10 | ⚠ 17 коммит(ов) в areas после сверки: 8d39e1f Merge CHAT-177 … |
