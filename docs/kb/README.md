...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-09-07 | ⚠ 5 коммит(ов) в areas после сверки: 7d786444 feat(admin): админка отдельным процессом — VC_ADMIN_MODE=remote; внутренний API машин общий для ядра и процесса машин … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1254 коммит(ов) в areas после сверки: 7d786444 feat(admin): админка отдельным процессом — VC_ADMIN_MODE=remote; внутренний API машин общий для ядра и процесса машин … |
