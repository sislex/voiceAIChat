...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-09-10 | ⚠ 2 коммит(ов) в areas после сверки: 3293c9ad feat(web-reader): add native layout audits (QA cycle 02) … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-09-10 | ⚠ 18 коммит(ов) в areas после сверки: 3293c9ad feat(web-reader): add native layout audits (QA cycle 02) … |
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-09-10 | ⚠ 4 коммит(ов) в areas после сверки: 3293c9ad feat(web-reader): add native layout audits (QA cycle 02) … |
