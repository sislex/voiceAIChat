...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-29 | ⚠ 29 коммит(ов) в areas после сверки: 9a4fbbef feat(ci): лента рана показывает цвет лога, а не escape-последовательности, круг 3 … |
...
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-08-24 | ⚠ 119 коммит(ов) в areas после сверки: 002085de feat(gate): одна честная команда проверки; молчаливые сбои стали заметны … |
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-24 | ⚠ 127 коммит(ов) в areas после сверки: 9a4fbbef feat(ci): лента рана показывает цвет лога, а не escape-последовательности, круг 3 … |
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-08-30 | ⚠ 3 коммит(ов) в areas после сверки: 002085de feat(gate): одна честная команда проверки; молчаливые сбои стали заметны … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 865 коммит(ов) в areas после сверки: 9a4fbbef feat(ci): лента рана показывает цвет лога, а не escape-последовательности, круг 3 … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-30 | ⚠ 3 коммит(ов) в areas после сверки: 9a4fbbef feat(ci): лента рана показывает цвет лога, а не escape-последовательности, круг 3 … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-29 | ⚠ 27 коммит(ов) в areas после сверки: 9a4fbbef feat(ci): лента рана показывает цвет лога, а не escape-последовательности, круг 3 … |
| [features/task-autopilot.md](features/task-autopilot.md) | Автопроход задачи по QA-конвейеру | 2026-08-29 | ⚠ 11 коммит(ов) в areas после сверки: 002085de feat(gate): одна честная команда проверки; молчаливые сбои стали заметны … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-29 | ⚠ 15 коммит(ов) в areas после сверки: 9a4fbbef feat(ci): лента рана показывает цвет лога, а не escape-последовательности, круг 3 … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-28 | ⚠ 52 коммит(ов) в areas после сверки: 002085de feat(gate): одна честная команда проверки; молчаливые сбои стали заметны … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-29 | ⚠ 32 коммит(ов) в areas после сверки: 9a4fbbef feat(ci): лента рана показывает цвет лога, а не escape-последовательности, круг 3 … |
...
| [testing-operations.md](testing-operations.md) | Разработка, тестирование, диагностика и эксплуатация | 2026-08-30 | ⚠ 1 коммит(ов) в areas после сверки: 002085de feat(gate): одна честная команда проверки; молчаливые сбои стали заметны |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-30 | ⚠ 1 коммит(ов) в areas после сверки: 9a4fbbef feat(ci): лента рана показывает цвет лога, а не escape-последовательности, круг 3 |
