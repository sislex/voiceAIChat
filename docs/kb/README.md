...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 50 коммит(ов) в areas после сверки: 220ecc03 feat(make): тема (prefers-color-scheme) и язык превью (п.12) … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 653 коммит(ов) в areas после сверки: 220ecc03 feat(make): тема (prefers-color-scheme) и язык превью (п.12) … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-20 | ⚠ 114 коммит(ов) в areas после сверки: 220ecc03 feat(make): тема (prefers-color-scheme) и язык превью (п.12) … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-25 | ⚠ 41 коммит(ов) в areas после сверки: 220ecc03 feat(make): тема (prefers-color-scheme) и язык превью (п.12) … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-25 | ⚠ 40 коммит(ов) в areas после сверки: 220ecc03 feat(make): тема (prefers-color-scheme) и язык превью (п.12) … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-27 | ⚠ 7 коммит(ов) в areas после сверки: 220ecc03 feat(make): тема (prefers-color-scheme) и язык превью (п.12) … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-27 | ⚠ 5 коммит(ов) в areas после сверки: 220ecc03 feat(make): тема (prefers-color-scheme) и язык превью (п.12) … |
