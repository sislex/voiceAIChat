...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-16 | ⚠ 1 коммит(ов) в areas после сверки: 63808e3c fix(cleanup): keep the temporary-resource registry free during a sweep (#202) |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1532 коммит(ов) в areas после сверки: 63808e3c fix(cleanup): keep the temporary-resource registry free during a sweep (#202) … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-16 | ⚠ 6 коммит(ов) в areas после сверки: 9e663b79 feat: configure machine command notifications … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-09-15 | ⚠ 23 коммит(ов) в areas после сверки: 63808e3c fix(cleanup): keep the temporary-resource registry free during a sweep (#202) … |
