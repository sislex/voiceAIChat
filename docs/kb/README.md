...
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-08-14 | ⚠ 11 коммит(ов) в areas после сверки: b28b8fd fix(server): cancel task preparation runs on close … |
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-15 | ✓ |
| [features/feature-preview.md](features/feature-preview.md) | Feature-preview окружения задач | 2026-08-14 | ⚠ 15 коммит(ов) в areas после сверки: 951214c Merge remote-tracking branch 'origin/main' into CHAT-224 … |
...
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-08-14 | ⚠ 5 коммит(ов) в areas после сверки: b28b8fd fix(server): cancel task preparation runs on close … |
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-14 | ⚠ 9 коммит(ов) в areas после сверки: b28b8fd fix(server): cancel task preparation runs on close … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 342 коммит(ов) в areas после сверки: 951214c Merge remote-tracking branch 'origin/main' into CHAT-224 … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-14 | ⚠ 5 коммит(ов) в areas после сверки: b28b8fd fix(server): cancel task preparation runs on close … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-14 | ⚠ 14 коммит(ов) в areas после сверки: b28b8fd fix(server): cancel task preparation runs on close … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-14 | ⚠ 31 коммит(ов) в areas после сверки: b28b8fd fix(server): cancel task preparation runs on close … |
