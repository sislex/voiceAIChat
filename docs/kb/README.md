...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 150 коммит(ов) в areas после сверки: a1b77643 fix(db): разовые миграции отмечаются в app_config … |
...
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-24 | ⚠ 96 коммит(ов) в areas после сверки: a1b77643 fix(db): разовые миграции отмечаются в app_config … |
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-08-25 | ⚠ 91 коммит(ов) в areas после сверки: a1b77643 fix(db): разовые миграции отмечаются в app_config … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 780 коммит(ов) в areas после сверки: a1b77643 fix(db): разовые миграции отмечаются в app_config … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-20 | ⚠ 195 коммит(ов) в areas после сверки: a1b77643 fix(db): разовые миграции отмечаются в app_config … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-28 | ⚠ 48 коммит(ов) в areas после сверки: a1b77643 fix(db): разовые миграции отмечаются в app_config … |
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-08-28 | ⚠ 24 коммит(ов) в areas после сверки: a1b77643 fix(db): разовые миграции отмечаются в app_config … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-28 | ⚠ 25 коммит(ов) в areas после сверки: a1b77643 fix(db): разовые миграции отмечаются в app_config … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-29 | ⚠ 1 коммит(ов) в areas после сверки: a1b77643 fix(db): разовые миграции отмечаются в app_config |
