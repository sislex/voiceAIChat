...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-06 | ⚠ 58 коммит(ов) в areas после сверки: c5cb21ec feat(ui): embed task AI chat in card tabs … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-08 | ⚠ 3 коммит(ов) в areas после сверки: c5cb21ec feat(ui): embed task AI chat in card tabs … |
