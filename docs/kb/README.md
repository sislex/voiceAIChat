...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-09-10 | ⚠ 9 коммит(ов) в areas после сверки: c40de59c feat(playwright-reader): keep a session feed and state verdicts (cycle 5) … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-09-10 | ⚠ 25 коммит(ов) в areas после сверки: c40de59c feat(playwright-reader): keep a session feed and state verdicts (cycle 5) … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1352 коммит(ов) в areas после сверки: c40de59c feat(playwright-reader): keep a session feed and state verdicts (cycle 5) … |
...
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 324 коммит(ов) в areas после сверки: c40de59c feat(playwright-reader): keep a session feed and state verdicts (cycle 5) … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-10 | ⚠ 9 коммит(ов) в areas после сверки: c40de59c feat(playwright-reader): keep a session feed and state verdicts (cycle 5) … |
...
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-09-11 | ⚠ 12 коммит(ов) в areas после сверки: c40de59c feat(playwright-reader): keep a session feed and state verdicts (cycle 5) … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-15 | ⚠ 3 коммит(ов) в areas после сверки: c40de59c feat(playwright-reader): keep a session feed and state verdicts (cycle 5) … |
