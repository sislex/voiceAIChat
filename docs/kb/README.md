...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-10 | ⚠ 7 коммит(ов) в areas после сверки: 9540f6f feat: расширить управление релизами и деплоями … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 210 коммит(ов) в areas после сверки: 9540f6f feat: расширить управление релизами и деплоями … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-08 | ⚠ 32 коммит(ов) в areas после сверки: 9540f6f feat: расширить управление релизами и деплоями … |
