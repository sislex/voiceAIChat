...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-20 | ⚠ 36 коммит(ов) в areas после сверки: 0358a806 feat: add resumable legacy storage migration backend … |
...
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-08-22 | ⚠ 6 коммит(ов) в areas после сверки: 24d67d66 Merge task 89ae3628-1eae-453c-ae39-aa45ba2addb5 … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 539 коммит(ов) в areas после сверки: 24d67d66 Merge task 89ae3628-1eae-453c-ae39-aa45ba2addb5 … |
...
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 13 коммит(ов) в areas после сверки: 0358a806 feat: add resumable legacy storage migration backend … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-24 | ✓ |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-23 | ⚠ 3 коммит(ов) в areas после сверки: 24d67d66 Merge task 89ae3628-1eae-453c-ae39-aa45ba2addb5 … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-23 | ⚠ 1 коммит(ов) в areas после сверки: 0358a806 feat: add resumable legacy storage migration backend |
| [stt-runner.md](stt-runner.md) | STT Runner: внутренний протокол, ресурсы и lifecycle | 2026-08-20 | ⚠ 25 коммит(ов) в areas после сверки: 0358a806 feat: add resumable legacy storage migration backend … |
