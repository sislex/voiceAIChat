...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-17 | ⚠ 12 коммит(ов) в areas после сверки: 69b2c8d8 Extract Voice and Image Studio into independent applications … |
...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 212 коммит(ов) в areas после сверки: 69b2c8d8 Extract Voice and Image Studio into independent applications … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 369 коммит(ов) в areas после сверки: 69b2c8d8 Extract Voice and Image Studio into independent applications … |
| [features/llm-runners.md](features/llm-runners.md) | Исполнители LLM: контейнеры с claude/codex CLI | 2026-09-12 | ⚠ 16 коммит(ов) в areas после сверки: 69b2c8d8 Extract Voice and Image Studio into independent applications … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-17 | ⚠ 9 коммит(ов) в areas после сверки: 69b2c8d8 Extract Voice and Image Studio into independent applications … |
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 377 коммит(ов) в areas после сверки: 69b2c8d8 Extract Voice and Image Studio into independent applications … |
| [kb-workflow.md](kb-workflow.md) | Как устроена и ведётся база знаний | 2026-08-31 | ⚠ 33 коммит(ов) в areas после сверки: 69b2c8d8 Extract Voice and Image Studio into independent applications … |
...
| [operations-app.md](operations-app.md) | Frontend-модуль Operations: граница, store и подключение | 2026-08-19 | ⚠ 266 коммит(ов) в areas после сверки: 69b2c8d8 Extract Voice and Image Studio into independent applications … |
...
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-09-17 | ⚠ 6 коммит(ов) в areas после сверки: 69b2c8d8 Extract Voice and Image Studio into independent applications … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-09-15 | ⚠ 55 коммит(ов) в areas после сверки: 69b2c8d8 Extract Voice and Image Studio into independent applications … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-09-20 | ⚠ 3 коммит(ов) в areas после сверки: 69b2c8d8 Extract Voice and Image Studio into independent applications … |
| [stt-runner.md](stt-runner.md) | STT Runner: внутренний протокол, ресурсы и lifecycle | 2026-08-20 | ⚠ 208 коммит(ов) в areas после сверки: 69b2c8d8 Extract Voice and Image Studio into independent applications … |
