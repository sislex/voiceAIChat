...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 158 коммит(ов) в areas после сверки: ec5d38d feat(ui): add project chat selector to assistant header … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-08 | ⚠ 1 коммит(ов) в areas после сверки: ec5d38d feat(ui): add project chat selector to assistant header |
