...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-08-19 | ⚠ 24 коммит(ов) в areas после сверки: b0a25262 feat(chat): add adaptive message composer … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-24 | ⚠ 3 коммит(ов) в areas после сверки: b0a25262 feat(chat): add adaptive message composer … |
...
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-08-19 | ⚠ 35 коммит(ов) в areas после сверки: b0a25262 feat(chat): add adaptive message composer … |
...
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-20 | ⚠ 54 коммит(ов) в areas после сверки: b0a25262 feat(chat): add adaptive message composer … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-23 | ⚠ 16 коммит(ов) в areas после сверки: b0a25262 feat(chat): add adaptive message composer … |
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-08-24 | ⚠ 7 коммит(ов) в areas после сверки: b0a25262 feat(chat): add adaptive message composer … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-24 | ⚠ 12 коммит(ов) в areas после сверки: b0a25262 feat(chat): add adaptive message composer … |
| [operations-app.md](operations-app.md) | Frontend-модуль Operations: граница, store и подключение | 2026-08-19 | ⚠ 15 коммит(ов) в areas после сверки: b0a25262 feat(chat): add adaptive message composer … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-24 | ⚠ 3 коммит(ов) в areas после сверки: b0a25262 feat(chat): add adaptive message composer … |
