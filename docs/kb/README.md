...
|---|---|---|---|
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-01 | ⚠ 17 коммит(ов) в areas после сверки: d0f1fce feat(prompt): запрашивать способ выполнения изменений … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-04 | ⚠ 1 коммит(ов) в areas после сверки: e3a1439 fix(ci): validate KB update repository root |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-03 | ⚠ 15 коммит(ов) в areas после сверки: d0f1fce feat(prompt): запрашивать способ выполнения изменений … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 35 коммит(ов) в areas после сверки: ccb5efa fix: exclude image blocks from conversation history … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-08-03 | ⚠ 12 коммит(ов) в areas после сверки: ccb5efa fix: exclude image blocks from conversation history … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-04 | ⚠ 8 коммит(ов) в areas после сверки: f9564ab feat(projects): расширить настройки задач … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-04 | ✓ |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-02 | ⚠ 19 коммит(ов) в areas после сверки: ccb5efa fix: exclude image blocks from conversation history … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-04 | ⚠ 7 коммит(ов) в areas после сверки: f9564ab feat(projects): расширить настройки задач … |
