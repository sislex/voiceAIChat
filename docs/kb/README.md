...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-09-13 | ⚠ 6 коммит(ов) в areas после сверки: f9da7180 feat(reader): круг 3 — различать одинаковое и знать состояние панели … |
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-09-10 | ⚠ 26 коммит(ов) в areas после сверки: f9da7180 feat(reader): круг 3 — различать одинаковое и знать состояние панели … |
...
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-09-12 | ⚠ 7 коммит(ов) в areas после сверки: f9da7180 feat(reader): круг 3 — различать одинаковое и знать состояние панели … |
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-13 | ⚠ 6 коммит(ов) в areas после сверки: f9da7180 feat(reader): круг 3 — различать одинаковое и знать состояние панели … |
...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 172 коммит(ов) в areas после сверки: f9da7180 feat(reader): круг 3 — различать одинаковое и знать состояние панели … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 332 коммит(ов) в areas после сверки: f9da7180 feat(reader): круг 3 — различать одинаковое и знать состояние панели … |
...
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-09-10 | ⚠ 40 коммит(ов) в areas после сверки: f9da7180 feat(reader): круг 3 — различать одинаковое и знать состояние панели … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1456 коммит(ов) в areas после сверки: f9da7180 feat(reader): круг 3 — различать одинаковое и знать состояние панели … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-09-13 | ⚠ 7 коммит(ов) в areas после сверки: f9da7180 feat(reader): круг 3 — различать одинаковое и знать состояние панели … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-12 | ⚠ 29 коммит(ов) в areas после сверки: f9da7180 feat(reader): круг 3 — различать одинаковое и знать состояние панели … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-14 | ⚠ 3 коммит(ов) в areas после сверки: f9da7180 feat(reader): круг 3 — различать одинаковое и знать состояние панели … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-09-14 | ⚠ 3 коммит(ов) в areas после сверки: f9da7180 feat(reader): круг 3 — различать одинаковое и знать состояние панели … |
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-14 | ⚠ 3 коммит(ов) в areas после сверки: f9da7180 feat(reader): круг 3 — различать одинаковое и знать состояние панели … |
| [operations-app.md](operations-app.md) | Frontend-модуль Operations: граница, store и подключение | 2026-08-19 | ⚠ 239 коммит(ов) в areas после сверки: f9da7180 feat(reader): круг 3 — различать одинаковое и знать состояние панели … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-13 | ⚠ 14 коммит(ов) в areas после сверки: f9da7180 feat(reader): круг 3 — различать одинаковое и знать состояние панели … |
...
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-09-11 | ⚠ 27 коммит(ов) в areas после сверки: f9da7180 feat(reader): круг 3 — различать одинаковое и знать состояние панели … |
