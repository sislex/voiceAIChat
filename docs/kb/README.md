...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 48 коммит(ов) в areas после сверки: 0755af28 feat(make): локальная история правок файла — «Версии» в редакторе (п.7) … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 650 коммит(ов) в areas после сверки: 0755af28 feat(make): локальная история правок файла — «Версии» в редакторе (п.7) … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-20 | ⚠ 112 коммит(ов) в areas после сверки: 0755af28 feat(make): локальная история правок файла — «Версии» в редакторе (п.7) … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-25 | ⚠ 39 коммит(ов) в areas после сверки: 0755af28 feat(make): локальная история правок файла — «Версии» в редакторе (п.7) … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-25 | ⚠ 38 коммит(ов) в areas после сверки: 0755af28 feat(make): локальная история правок файла — «Версии» в редакторе (п.7) … |
