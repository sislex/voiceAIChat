...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-06 | ⚠ 60 коммит(ов) в areas после сверки: 29dcec84 feat(reader): Web Reader отдельным процессом — VC_READER_MODE=remote (круг 2) … |
| [features/feature-preview.md](features/feature-preview.md) | Feature-preview окружения задач | 2026-08-28 | ⚠ 139 коммит(ов) в areas после сверки: 29dcec84 feat(reader): Web Reader отдельным процессом — VC_READER_MODE=remote (круг 2) … |
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 114 коммит(ов) в areas после сверки: 29dcec84 feat(reader): Web Reader отдельным процессом — VC_READER_MODE=remote (круг 2) … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 285 коммит(ов) в areas после сверки: 29dcec84 feat(reader): Web Reader отдельным процессом — VC_READER_MODE=remote (круг 2) … |
...
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-09-04 | ⚠ 63 коммит(ов) в areas после сверки: 29dcec84 feat(reader): Web Reader отдельным процессом — VC_READER_MODE=remote (круг 2) … |
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-09-04 | ⚠ 76 коммит(ов) в areas после сверки: 29dcec84 feat(reader): Web Reader отдельным процессом — VC_READER_MODE=remote (круг 2) … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1272 коммит(ов) в areas после сверки: 29dcec84 feat(reader): Web Reader отдельным процессом — VC_READER_MODE=remote (круг 2) … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-09-06 | ⚠ 37 коммит(ов) в areas после сверки: 29dcec84 feat(reader): Web Reader отдельным процессом — VC_READER_MODE=remote (круг 2) … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-05 | ⚠ 83 коммит(ов) в areas после сверки: 29dcec84 feat(reader): Web Reader отдельным процессом — VC_READER_MODE=remote (круг 2) … |
| [features/task-autopilot.md](features/task-autopilot.md) | Автопроход задачи по QA-конвейеру | 2026-09-06 | ⚠ 43 коммит(ов) в areas после сверки: 29dcec84 feat(reader): Web Reader отдельным процессом — VC_READER_MODE=remote (круг 2) … |
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-05 | ⚠ 76 коммит(ов) в areas после сверки: 29dcec84 feat(reader): Web Reader отдельным процессом — VC_READER_MODE=remote (круг 2) … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-07 | ⚠ 41 коммит(ов) в areas после сверки: 6b0928c2 feat(reader): модуль Web Reader с портом ReaderCore и подписанные токены ходов превью (круг 1) … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-08 | ⚠ 1 коммит(ов) в areas после сверки: 6b0928c2 feat(reader): модуль Web Reader с портом ReaderCore и подписанные токены ходов превью (круг 1) |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-09-08 | ⚠ 1 коммит(ов) в areas после сверки: 29dcec84 feat(reader): Web Reader отдельным процессом — VC_READER_MODE=remote (круг 2) |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-08 | ⚠ 5 коммит(ов) в areas после сверки: 29dcec84 feat(reader): Web Reader отдельным процессом — VC_READER_MODE=remote (круг 2) … |
