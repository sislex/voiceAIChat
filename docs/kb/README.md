...
|---|---|---|---|
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-01 | ⚠ 19 коммит(ов) в areas после сверки: e75e3e1 fix: show task launch dialog only on model request … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-04 | ⚠ 5 коммит(ов) в areas после сверки: e75e3e1 fix: show task launch dialog only on model request … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-04 | ⚠ 5 коммит(ов) в areas после сверки: e75e3e1 fix: show task launch dialog only on model request … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-03 | ⚠ 16 коммит(ов) в areas после сверки: e75e3e1 fix: show task launch dialog only on model request … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 39 коммит(ов) в areas после сверки: 311ca6e fix(ui): repair task launch test bridge … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-08-03 | ⚠ 13 коммит(ов) в areas после сверки: e75e3e1 fix: show task launch dialog only on model request … |
...
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-02 | ⚠ 7 коммит(ов) в areas после сверки: f1a46bf fix: align task launch contracts … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-04 | ⚠ 4 коммит(ов) в areas после сверки: e75e3e1 fix: show task launch dialog only on model request … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-04 | ✓ |
