...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1596 коммит(ов) в areas после сверки: 1a2c0702 test: move extracted application suites to owner repositories … |
...
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-20 | ⚠ 9 коммит(ов) в areas после сверки: 1a2c0702 test: move extracted application suites to owner repositories … |
...
| [operations-app.md](operations-app.md) | Frontend-модуль Operations: граница, store и подключение | 2026-08-19 | ⚠ 271 коммит(ов) в areas после сверки: 1a2c0702 test: move extracted application suites to owner repositories … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-09-22 | ⚠ 1 коммит(ов) в areas после сверки: 875dd6cc fix(admin): avoid repeated parsing in usage summaries |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-09-20 | ⚠ 4 коммит(ов) в areas после сверки: 1a2c0702 test: move extracted application suites to owner repositories … |
