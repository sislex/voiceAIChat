...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-14 | ⚠ 7 коммит(ов) в areas после сверки: 056f5c7 fix(chat): publish queued messages in turn order … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 307 коммит(ов) в areas после сверки: 056f5c7 fix(chat): publish queued messages in turn order … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-14 | ⚠ 6 коммит(ов) в areas после сверки: 056f5c7 fix(chat): publish queued messages in turn order … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-14 | ⚠ 5 коммит(ов) в areas после сверки: 056f5c7 fix(chat): publish queued messages in turn order … |
