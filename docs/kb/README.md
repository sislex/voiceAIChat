...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-22 | ⚠ 18 коммит(ов) в areas после сверки: ef86d44d feat: add versioned environment and run manifests … |
