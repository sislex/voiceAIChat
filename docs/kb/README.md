...
|---|---|---|---|
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-01 | ⚠ 91 коммит(ов) в areas после сверки: 0e16e79 Merge task a752dbf4-7431-4740-8ed3-14257b87de28 … |
...
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-08-13 | ⚠ 6 коммит(ов) в areas после сверки: 0e16e79 Merge task a752dbf4-7431-4740-8ed3-14257b87de28 … |
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-13 | ⚠ 6 коммит(ов) в areas после сверки: 0e16e79 Merge task a752dbf4-7431-4740-8ed3-14257b87de28 … |
...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-13 | ⚠ 3 коммит(ов) в areas после сверки: 0e16e79 Merge task a752dbf4-7431-4740-8ed3-14257b87de28 … |
| [features/llm-runners.md](features/llm-runners.md) | Исполнители LLM: контейнеры с claude/codex CLI | 2026-08-02 | ⚠ 41 коммит(ов) в areas после сверки: 896bab8 fix: make QA preparation failures recoverable … |
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-08-13 | ✓ |
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-13 | ⚠ 3 коммит(ов) в areas после сверки: 0e16e79 Merge task a752dbf4-7431-4740-8ed3-14257b87de28 … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 289 коммит(ов) в areas после сверки: 0e16e79 Merge task a752dbf4-7431-4740-8ed3-14257b87de28 … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-13 | ⚠ 8 коммит(ов) в areas после сверки: 0e16e79 Merge task a752dbf4-7431-4740-8ed3-14257b87de28 … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-12 | ⚠ 20 коммит(ов) в areas после сверки: 0e16e79 Merge task a752dbf4-7431-4740-8ed3-14257b87de28 … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-13 | ⚠ 23 коммит(ов) в areas после сверки: 0e16e79 Merge task a752dbf4-7431-4740-8ed3-14257b87de28 … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-12 | ⚠ 20 коммит(ов) в areas после сверки: 0e16e79 Merge task a752dbf4-7431-4740-8ed3-14257b87de28 … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-08 | ⚠ 84 коммит(ов) в areas после сверки: 0e16e79 Merge task a752dbf4-7431-4740-8ed3-14257b87de28 … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-10 | ⚠ 39 коммит(ов) в areas после сверки: 0e16e79 Merge task a752dbf4-7431-4740-8ed3-14257b87de28 … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-13 | ⚠ 3 коммит(ов) в areas после сверки: 0e16e79 Merge task a752dbf4-7431-4740-8ed3-14257b87de28 … |
