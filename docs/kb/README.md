...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 49 коммит(ов) в areas после сверки: 3d135388 feat(make): вкладка «Сеть» под превью — перехват fetch/XHR, битые запросы в чат (п.9) … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 651 коммит(ов) в areas после сверки: 3d135388 feat(make): вкладка «Сеть» под превью — перехват fetch/XHR, битые запросы в чат (п.9) … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-20 | ⚠ 113 коммит(ов) в areas после сверки: 3d135388 feat(make): вкладка «Сеть» под превью — перехват fetch/XHR, битые запросы в чат (п.9) … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-25 | ⚠ 40 коммит(ов) в areas после сверки: 3d135388 feat(make): вкладка «Сеть» под превью — перехват fetch/XHR, битые запросы в чат (п.9) … |
...
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 51 коммит(ов) в areas после сверки: fd195bb9 feat(make): поиск и замена по всему проекту со снимком перед заменой (п.1) … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-25 | ⚠ 39 коммит(ов) в areas после сверки: 3d135388 feat(make): вкладка «Сеть» под превью — перехват fetch/XHR, битые запросы в чат (п.9) … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-27 | ⚠ 5 коммит(ов) в areas после сверки: 3d135388 feat(make): вкладка «Сеть» под превью — перехват fetch/XHR, битые запросы в чат (п.9) … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-27 | ⚠ 3 коммит(ов) в areas после сверки: 3d135388 feat(make): вкладка «Сеть» под превью — перехват fetch/XHR, битые запросы в чат (п.9) … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-27 | ⚠ 9 коммит(ов) в areas после сверки: 3d135388 feat(make): вкладка «Сеть» под превью — перехват fetch/XHR, битые запросы в чат (п.9) … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-27 | ⚠ 1 коммит(ов) в areas после сверки: 3d135388 feat(make): вкладка «Сеть» под превью — перехват fetch/XHR, битые запросы в чат (п.9) |
