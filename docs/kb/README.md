...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-09 | ⚠ 67 коммит(ов) в areas после сверки: ef0005ca feat(releases): Release Center improvement cycle 3 — application releases panel … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1401 коммит(ов) в areas после сверки: ef0005ca feat(releases): Release Center improvement cycle 3 — application releases panel … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-09-11 | ⚠ 40 коммит(ов) в areas после сверки: ef0005ca feat(releases): Release Center improvement cycle 3 — application releases panel … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-12 | ⚠ 6 коммит(ов) в areas после сверки: ef0005ca feat(releases): Release Center improvement cycle 3 — application releases panel … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-12 | ⚠ 4 коммит(ов) в areas после сверки: ef0005ca feat(releases): Release Center improvement cycle 3 — application releases panel … |
