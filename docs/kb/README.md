...
|---|---|---|---|
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-01 | ⚠ 22 коммит(ов) в areas после сверки: 103017e feat(chat): persist attachment metadata and render images … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-04 | ⚠ 8 коммит(ов) в areas после сверки: 103017e feat(chat): persist attachment metadata and render images … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-05 | ⚠ 3 коммит(ов) в areas после сверки: 103017e feat(chat): persist attachment metadata and render images … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-03 | ⚠ 20 коммит(ов) в areas после сверки: 103017e feat(chat): persist attachment metadata and render images … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 46 коммит(ов) в areas после сверки: 5c5e744 Улучшить автоматическое исправление упавших тестов … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-08-03 | ⚠ 15 коммит(ов) в areas после сверки: 103017e feat(chat): persist attachment metadata and render images … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-04 | ⚠ 5 коммит(ов) в areas после сверки: 103017e feat(chat): persist attachment metadata and render images … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-05 | ✓ |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-05 | ✓ |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-04 | ⚠ 4 коммит(ов) в areas после сверки: 103017e feat(chat): persist attachment metadata and render images … |
