...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-09-08 | ⚠ 5 коммит(ов) в areas после сверки: c6945aa9 fix(releases): подготовка релиза, оборванная рестартом ядра, закрывается как failed при старте … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-06 | ⚠ 51 коммит(ов) в areas после сверки: 41ee78ca Merge main into CHAT-429 (task 4af2c395-ce53-461c-b2a7-e38d17cd4716) … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1262 коммит(ов) в areas после сверки: 5d13b2b1 docs(kb): update after merge 4af2c395-ce53-461c-b2a7-e38d17cd4716 … |
...
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-05 | ⚠ 75 коммит(ов) в areas после сверки: c6945aa9 fix(releases): подготовка релиза, оборванная рестартом ядра, закрывается как failed при старте … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-07 | ⚠ 36 коммит(ов) в areas после сверки: c6945aa9 fix(releases): подготовка релиза, оборванная рестартом ядра, закрывается как failed при старте … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-08 | ⚠ 5 коммит(ов) в areas после сверки: 41ee78ca Merge main into CHAT-429 (task 4af2c395-ce53-461c-b2a7-e38d17cd4716) … |
