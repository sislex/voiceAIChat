...
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-08-30 | ⚠ 114 коммит(ов) в areas после сверки: 105c1a04 feat(context): режим планирования честно обещает только чтение инструментов … |
