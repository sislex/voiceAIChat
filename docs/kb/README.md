...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-04 | ⚠ 6 коммит(ов) в areas после сверки: 8c4b7a8 chatai-94: compact CI test workflow … |
...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-03 | ⚠ 17 коммит(ов) в areas после сверки: 8c4b7a8 chatai-94: compact CI test workflow … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 42 коммит(ов) в areas после сверки: 4e5d05b chatai-94: update fix-loop expectations … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-04 | ⚠ 1 коммит(ов) в areas после сверки: 8c4b7a8 chatai-94: compact CI test workflow |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-04 | ⚠ 6 коммит(ов) в areas после сверки: 4e5d05b chatai-94: update fix-loop expectations … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-04 | ⚠ 1 коммит(ов) в areas после сверки: 8c4b7a8 chatai-94: compact CI test workflow |
