...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-29 | ⚠ 47 коммит(ов) в areas после сверки: 52ad69e5 fix(kanban): контраст аватара и кнопки создания на доске, цикл 3 … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 886 коммит(ов) в areas после сверки: 52ad69e5 fix(kanban): контраст аватара и кнопки создания на доске, цикл 3 … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-30 | ⚠ 16 коммит(ов) в areas после сверки: 52ad69e5 fix(kanban): контраст аватара и кнопки создания на доске, цикл 3 … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-29 | ⚠ 45 коммит(ов) в areas после сверки: 52ad69e5 fix(kanban): контраст аватара и кнопки создания на доске, цикл 3 … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-29 | ⚠ 34 коммит(ов) в areas после сверки: 52ad69e5 fix(kanban): контраст аватара и кнопки создания на доске, цикл 3 … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-30 | ⚠ 1 коммит(ов) в areas после сверки: 52ad69e5 fix(kanban): контраст аватара и кнопки создания на доске, цикл 3 |
