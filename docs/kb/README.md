...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-06 | ⚠ 57 коммит(ов) в areas после сверки: d2a953ce Merge remote-tracking branch 'origin/main' into fix/ws-backpressure … |
...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 112 коммит(ов) в areas после сверки: d2a953ce Merge remote-tracking branch 'origin/main' into fix/ws-backpressure … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 283 коммит(ов) в areas после сверки: d2a953ce Merge remote-tracking branch 'origin/main' into fix/ws-backpressure … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-05 | ⚠ 74 коммит(ов) в areas после сверки: d2a953ce Merge remote-tracking branch 'origin/main' into fix/ws-backpressure … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-08 | ⚠ 2 коммит(ов) в areas после сверки: d2a953ce Merge remote-tracking branch 'origin/main' into fix/ws-backpressure … |
