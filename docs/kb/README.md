...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-01 | ⚠ 1 коммит(ов) в areas после сверки: f15b2ba feat(server): add remote MCP file tools |
| [features/llm-runners.md](features/llm-runners.md) | Исполнители LLM: контейнеры с claude/codex CLI | 2026-08-01 | ✓ |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-01 | ⚠ 7 коммит(ов) в areas после сверки: c2f27dc chatai-54: работа CI-рана … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-08-01 | ⚠ 1 коммит(ов) в areas после сверки: f15b2ba feat(server): add remote MCP file tools |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-01 | ⚠ 1 коммит(ов) в areas после сверки: f15b2ba feat(server): add remote MCP file tools |
