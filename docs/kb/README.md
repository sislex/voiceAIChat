...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-29 | ⚠ 1 коммит(ов) в areas после сверки: 8cfdda5e fix(kanban): скрытие системной колонки переживает перезапуск сервера |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 149 коммит(ов) в areas после сверки: 8cfdda5e fix(kanban): скрытие системной колонки переживает перезапуск сервера … |
| [features/feature-preview.md](features/feature-preview.md) | Feature-preview окружения задач | 2026-08-28 | ⚠ 9 коммит(ов) в areas после сверки: 8cfdda5e fix(kanban): скрытие системной колонки переживает перезапуск сервера … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 24 коммит(ов) в areas после сверки: 8cfdda5e fix(kanban): скрытие системной колонки переживает перезапуск сервера … |
...
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-08-24 | ⚠ 86 коммит(ов) в areas после сверки: 8cfdda5e fix(kanban): скрытие системной колонки переживает перезапуск сервера … |
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-24 | ⚠ 95 коммит(ов) в areas после сверки: 8cfdda5e fix(kanban): скрытие системной колонки переживает перезапуск сервера … |
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-08-25 | ⚠ 90 коммит(ов) в areas после сверки: 8cfdda5e fix(kanban): скрытие системной колонки переживает перезапуск сервера … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 779 коммит(ов) в areas после сверки: 8cfdda5e fix(kanban): скрытие системной колонки переживает перезапуск сервера … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-20 | ⚠ 194 коммит(ов) в areas после сверки: 8cfdda5e fix(kanban): скрытие системной колонки переживает перезапуск сервера … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-28 | ⚠ 47 коммит(ов) в areas после сверки: 8cfdda5e fix(kanban): скрытие системной колонки переживает перезапуск сервера … |
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-08-28 | ⚠ 23 коммит(ов) в areas после сверки: 8cfdda5e fix(kanban): скрытие системной колонки переживает перезапуск сервера … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-28 | ⚠ 24 коммит(ов) в areas после сверки: 8cfdda5e fix(kanban): скрытие системной колонки переживает перезапуск сервера … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-27 | ⚠ 33 коммит(ов) в areas после сверки: 8cfdda5e fix(kanban): скрытие системной колонки переживает перезапуск сервера … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-29 | ⚠ 11 коммит(ов) в areas после сверки: 8cfdda5e fix(kanban): скрытие системной колонки переживает перезапуск сервера … |
