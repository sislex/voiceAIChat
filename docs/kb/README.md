...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-09-10 | ⚠ 39 коммит(ов) в areas после сверки: f77c97c5 feat(reader): круг 16 — место вместо селектора и привычки браузера телефона … |
...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 341 коммит(ов) в areas после сверки: db7be8e4 feat(reader): круг 14 — осторожность как у человека … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1469 коммит(ов) в areas после сверки: f77c97c5 feat(reader): круг 16 — место вместо селектора и привычки браузера телефона … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-14 | ⚠ 12 коммит(ов) в areas после сверки: db7be8e4 feat(reader): круг 14 — осторожность как у человека … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-09-14 | ⚠ 12 коммит(ов) в areas после сверки: db7be8e4 feat(reader): круг 14 — осторожность как у человека … |
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-14 | ⚠ 12 коммит(ов) в areas после сверки: db7be8e4 feat(reader): круг 14 — осторожность как у человека … |
| [operations-app.md](operations-app.md) | Frontend-модуль Operations: граница, store и подключение | 2026-08-19 | ⚠ 248 коммит(ов) в areas после сверки: db7be8e4 feat(reader): круг 14 — осторожность как у человека … |
...
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-09-15 | ⚠ 1 коммит(ов) в areas после сверки: 0b7c9dad feat(reader): круг 6 — проверки как у тестировщика и лицо страницы во вкладке |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-09-15 | ⚠ 1 коммит(ов) в areas после сверки: a6143646 feat(reader): круг 2 — модель видит экран пользователя, телефон видит модель |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-09-11 | ⚠ 40 коммит(ов) в areas после сверки: f77c97c5 feat(reader): круг 16 — место вместо селектора и привычки браузера телефона … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-15 | ⚠ 1 коммит(ов) в areas после сверки: f77c97c5 feat(reader): круг 16 — место вместо селектора и привычки браузера телефона |
