...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 652 коммит(ов) в areas после сверки: f7190d96 feat(make): сохранение скролла и якоря превью между перезагрузками (п.11) … |
...
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-27 | ⚠ 6 коммит(ов) в areas после сверки: f7190d96 feat(make): сохранение скролла и якоря превью между перезагрузками (п.11) … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-27 | ⚠ 4 коммит(ов) в areas после сверки: f7190d96 feat(make): сохранение скролла и якоря превью между перезагрузками (п.11) … |
