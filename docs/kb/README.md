...
| [conventions.md](conventions.md) | Конвенции: код, тесты, гейты, коммиты | 2026-09-11 | ⚠ 2 коммит(ов) в areas после сверки: 2a7c249e Extract Sislexa tools into independently released repositories … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-17 | ⚠ 10 коммит(ов) в areas после сверки: 2a7c249e Extract Sislexa tools into independently released repositories … |
...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 210 коммит(ов) в areas после сверки: a6be15b4 Merge remote-tracking branch 'origin/main' into CHAT-490 … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 367 коммит(ов) в areas после сверки: a6be15b4 Merge remote-tracking branch 'origin/main' into CHAT-490 … |
...
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-09-20 | ⚠ 1 коммит(ов) в areas после сверки: 2a7c249e Extract Sislexa tools into independently released repositories |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1576 коммит(ов) в areas после сверки: 2a7c249e Extract Sislexa tools into independently released repositories … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-09-13 | ⚠ 43 коммит(ов) в areas после сверки: 2a7c249e Extract Sislexa tools into independently released repositories … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-20 | ⚠ 1 коммит(ов) в areas после сверки: 2a7c249e Extract Sislexa tools into independently released repositories |
...
| [kb-workflow.md](kb-workflow.md) | Как устроена и ведётся база знаний | 2026-08-31 | ⚠ 31 коммит(ов) в areas после сверки: 2a7c249e Extract Sislexa tools into independently released repositories … |
...
| [operations-app.md](operations-app.md) | Frontend-модуль Operations: граница, store и подключение | 2026-08-19 | ⚠ 265 коммит(ов) в areas после сверки: 2a7c249e Extract Sislexa tools into independently released repositories … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-17 | ⚠ 1 коммит(ов) в areas после сверки: 2a7c249e Extract Sislexa tools into independently released repositories |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-09-17 | ⚠ 4 коммит(ов) в areas после сверки: 2a7c249e Extract Sislexa tools into independently released repositories … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-09-15 | ⚠ 53 коммит(ов) в areas после сверки: 2a7c249e Extract Sislexa tools into independently released repositories … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-20 | ⚠ 1 коммит(ов) в areas после сверки: 2a7c249e Extract Sislexa tools into independently released repositories |
