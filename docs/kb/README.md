...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-20 | ⚠ 60 коммит(ов) в areas после сверки: 3d3dc92e feat(ui): самодиагностика чата (команда в композере) … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 6 коммит(ов) в areas после сверки: 3d3dc92e feat(ui): самодиагностика чата (команда в композере) … |
...
| [features/llm-runners.md](features/llm-runners.md) | Исполнители LLM: контейнеры с claude/codex CLI | 2026-08-18 | ⚠ 42 коммит(ов) в areas после сверки: 92e42b00 feat(playwright-reader): связка панели с browser-runner (оркестрация + Chromium) … |
...
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-24 | ⚠ 8 коммит(ов) в areas после сверки: 3d3dc92e feat(ui): самодиагностика чата (команда в композере) … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 607 коммит(ов) в areas после сверки: 3d3dc92e feat(ui): самодиагностика чата (команда в композере) … |
...
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-23 | ⚠ 48 коммит(ов) в areas после сверки: 3d3dc92e feat(ui): самодиагностика чата (команда в композере) … |
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-08-25 | ⚠ 5 коммит(ов) в areas после сверки: 3d3dc92e feat(ui): самодиагностика чата (команда в композере) … |
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 35 коммит(ов) в areas после сверки: 3d3dc92e feat(ui): самодиагностика чата (команда в композере) … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-25 | ⚠ 2 коммит(ов) в areas после сверки: 105ddfbd fix(releases): bootstrap не пишет environment.json managed-окружений … |
