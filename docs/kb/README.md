...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-08-19 | ⚠ 100 коммит(ов) в areas после сверки: 7858ddbd feat(machines): уведомления о завершении долгих команд — WS machine.command, тост, лог команды из чата в artifacts (roadmap п.17) … |
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-20 | ⚠ 111 коммит(ов) в areas после сверки: 7858ddbd feat(machines): уведомления о завершении долгих команд — WS machine.command, тост, лог команды из чата в artifacts (roadmap п.17) … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 112 коммит(ов) в areas после сверки: cfaee2db feat(machines): индикатор здоровья машины хода в шапке чата и предупреждения перед ходом (roadmap п.2) … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 739 коммит(ов) в areas после сверки: cfaee2db feat(machines): индикатор здоровья машины хода в шапке чата и предупреждения перед ходом (roadmap п.2) … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-20 | ⚠ 168 коммит(ов) в areas после сверки: cfaee2db feat(machines): индикатор здоровья машины хода в шапке чата и предупреждения перед ходом (roadmap п.2) … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-28 | ⚠ 10 коммит(ов) в areas после сверки: cfaee2db feat(machines): индикатор здоровья машины хода в шапке чата и предупреждения перед ходом (roadmap п.2) … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-25 | ⚠ 100 коммит(ов) в areas после сверки: cfaee2db feat(machines): индикатор здоровья машины хода в шапке чата и предупреждения перед ходом (roadmap п.2) … |
...
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-27 | ⚠ 9 коммит(ов) в areas после сверки: cfaee2db feat(machines): индикатор здоровья машины хода в шапке чата и предупреждения перед ходом (roadmap п.2) … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-27 | ⚠ 12 коммит(ов) в areas после сверки: cfaee2db feat(machines): индикатор здоровья машины хода в шапке чата и предупреждения перед ходом (roadmap п.2) … |
...
- [2026-08-28-alexeys-macbook-air-2-machines-roadmap-1.md](log/2026-08-28-alexeys-macbook-air-2-machines-roadmap-1.md) — machines-roadmap-1
