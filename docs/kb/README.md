...
|---|---|---|---|
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-01 | ⚠ 87 коммит(ов) в areas после сверки: d30596d fix(releases): использовать машину проекта по умолчанию … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-13 | ⚠ 8 коммит(ов) в areas после сверки: d30596d fix(releases): использовать машину проекта по умолчанию … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 278 коммит(ов) в areas после сверки: 5fa3d61 fix(CHAT-194): validate production release version … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-12 | ⚠ 16 коммит(ов) в areas после сверки: d30596d fix(releases): использовать машину проекта по умолчанию … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-13 | ⚠ 17 коммит(ов) в areas после сверки: d30596d fix(releases): использовать машину проекта по умолчанию … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-12 | ⚠ 16 коммит(ов) в areas после сверки: d30596d fix(releases): использовать машину проекта по умолчанию … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-08 | ⚠ 77 коммит(ов) в areas после сверки: 5fa3d61 fix(CHAT-194): validate production release version … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-10 | ⚠ 35 коммит(ов) в areas после сверки: d30596d fix(releases): использовать машину проекта по умолчанию … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-13 | ⚠ 17 коммит(ов) в areas после сверки: d30596d fix(releases): использовать машину проекта по умолчанию … |
...
- [2026-08-13-2470-com-merge-runner-safe-text-conflicts.md](log/2026-08-13-2470-com-merge-runner-safe-text-conflicts.md) — merge-runner-safe-text-conflicts
