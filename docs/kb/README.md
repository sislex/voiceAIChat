...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-09-01 | ⚠ 100 коммит(ов) в areas после сверки: 515502f7 feat(releases): Release Center improvement cycle 6 — production readiness, filters, ETA … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-09 | ⚠ 70 коммит(ов) в areas после сверки: 515502f7 feat(releases): Release Center improvement cycle 6 — production readiness, filters, ETA … |
...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 152 коммит(ов) в areas после сверки: 515502f7 feat(releases): Release Center improvement cycle 6 — production readiness, filters, ETA … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 315 коммит(ов) в areas после сверки: 515502f7 feat(releases): Release Center improvement cycle 6 — production readiness, filters, ETA … |
...
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-09-10 | ⚠ 18 коммит(ов) в areas после сверки: 515502f7 feat(releases): Release Center improvement cycle 6 — production readiness, filters, ETA … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1404 коммит(ов) в areas после сверки: 515502f7 feat(releases): Release Center improvement cycle 6 — production readiness, filters, ETA … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-09-11 | ⚠ 43 коммит(ов) в areas после сверки: 515502f7 feat(releases): Release Center improvement cycle 6 — production readiness, filters, ETA … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-11 | ⚠ 5 коммит(ов) в areas после сверки: 515502f7 feat(releases): Release Center improvement cycle 6 — production readiness, filters, ETA … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-09-12 | ⚠ 4 коммит(ов) в areas после сверки: 515502f7 feat(releases): Release Center improvement cycle 6 — production readiness, filters, ETA … |
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-10 | ⚠ 14 коммит(ов) в areas после сверки: 515502f7 feat(releases): Release Center improvement cycle 6 — production readiness, filters, ETA … |
| [operations-app.md](operations-app.md) | Frontend-модуль Operations: граница, store и подключение | 2026-08-19 | ⚠ 226 коммит(ов) в areas после сверки: 515502f7 feat(releases): Release Center improvement cycle 6 — production readiness, filters, ETA … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-12 | ⚠ 2 коммит(ов) в areas после сверки: 515502f7 feat(releases): Release Center improvement cycle 6 — production readiness, filters, ETA … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-12 | ⚠ 7 коммит(ов) в areas после сверки: 515502f7 feat(releases): Release Center improvement cycle 6 — production readiness, filters, ETA … |
