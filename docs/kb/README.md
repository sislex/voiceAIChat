...
|---|---|---|---|
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-01 | ⚠ 100 коммит(ов) в areas после сверки: 1168c74 Merge task f2659ed3-a453-443d-b68c-1dd6242c2da5 … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-14 | ⚠ 15 коммит(ов) в areas после сверки: 1168c74 Merge task f2659ed3-a453-443d-b68c-1dd6242c2da5 … |
...
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-08-14 | ⚠ 6 коммит(ов) в areas после сверки: 1168c74 Merge task f2659ed3-a453-443d-b68c-1dd6242c2da5 … |
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-14 | ⚠ 8 коммит(ов) в areas после сверки: 1168c74 Merge task f2659ed3-a453-443d-b68c-1dd6242c2da5 … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 315 коммит(ов) в areas после сверки: 1168c74 Merge task f2659ed3-a453-443d-b68c-1dd6242c2da5 … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-14 | ⚠ 14 коммит(ов) в areas после сверки: 1168c74 Merge task f2659ed3-a453-443d-b68c-1dd6242c2da5 … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-12 | ⚠ 29 коммит(ов) в areas после сверки: 1168c74 Merge task f2659ed3-a453-443d-b68c-1dd6242c2da5 … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-14 | ⚠ 3 коммит(ов) в areas после сверки: 1168c74 Merge task f2659ed3-a453-443d-b68c-1dd6242c2da5 … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-12 | ⚠ 27 коммит(ов) в areas после сверки: 1168c74 Merge task f2659ed3-a453-443d-b68c-1dd6242c2da5 … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-14 | ⚠ 12 коммит(ов) в areas после сверки: 1168c74 Merge task f2659ed3-a453-443d-b68c-1dd6242c2da5 … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-10 | ⚠ 47 коммит(ов) в areas после сверки: 1168c74 Merge task f2659ed3-a453-443d-b68c-1dd6242c2da5 … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-14 | ⚠ 5 коммит(ов) в areas после сверки: 1168c74 Merge task f2659ed3-a453-443d-b68c-1dd6242c2da5 … |
...
- [2026-08-14-alexeys-macbook-air-2-feature-preview-tunnel-access.md](log/2026-08-14-alexeys-macbook-air-2-feature-preview-tunnel-access.md) — feature-preview-tunnel-access
- [2026-08-14-alexeys-macbook-air-2-chat-scroll-follow.md](log/2026-08-14-alexeys-macbook-air-2-chat-scroll-follow.md) — chat-scroll-follow
- [2026-08-14-alexeys-macbook-air-2-chat-context-inspector.md](log/2026-08-14-alexeys-macbook-air-2-chat-context-inspector.md) — chat-context-inspector
