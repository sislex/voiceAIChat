...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-08-19 | ⚠ 40 коммит(ов) в areas после сверки: 407b2a41 Merge task 002ad131-c455-4fb3-bc0d-cde80e4ff042 … |
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-20 | ⚠ 54 коммит(ов) в areas после сверки: e91c96d4 web reader … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-24 | ⚠ 13 коммит(ов) в areas после сверки: 407b2a41 Merge task 002ad131-c455-4fb3-bc0d-cde80e4ff042 … |
