...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-18 | ⚠ 1 коммит(ов) в areas после сверки: 3aa5164 fix: allow choosing LLM for task preparation |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-17 | ⚠ 28 коммит(ов) в areas после сверки: 8255db1 Merge CHAT-274 into main … |
...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-16 | ⚠ 31 коммит(ов) в areas после сверки: 8255db1 Merge CHAT-274 into main … |
...
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-08-17 | ⚠ 14 коммит(ов) в areas после сверки: 8255db1 Merge CHAT-274 into main … |
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-17 | ⚠ 8 коммит(ов) в areas после сверки: 8255db1 Merge CHAT-274 into main … |
...
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-16 | ⚠ 33 коммит(ов) в areas после сверки: 8255db1 Merge CHAT-274 into main … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-08-18 | ⚠ 4 коммит(ов) в areas после сверки: 8255db1 Merge CHAT-274 into main … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-18 | ⚠ 6 коммит(ов) в areas после сверки: 8255db1 Merge CHAT-274 into main … |
