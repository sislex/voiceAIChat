...
|---|---|---|---|
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-01 | ⚠ 82 коммит(ов) в areas после сверки: f544eda feat: add project role authorization … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-13 | ⚠ 3 коммит(ов) в areas после сверки: f544eda feat: add project role authorization … |
...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-13 | ⚠ 1 коммит(ов) в areas после сверки: f544eda feat: add project role authorization |
...
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-08-10 | ⚠ 30 коммит(ов) в areas после сверки: f544eda feat: add project role authorization … |
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-13 | ⚠ 4 коммит(ов) в areas после сверки: f544eda feat: add project role authorization … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 268 коммит(ов) в areas после сверки: f544eda feat: add project role authorization … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-12 | ⚠ 28 коммит(ов) в areas после сверки: f544eda feat: add project role authorization … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-08-08 | ⚠ 6 коммит(ов) в areas после сверки: f544eda feat: add project role authorization … |
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-12 | ⚠ 11 коммит(ов) в areas после сверки: f544eda feat: add project role authorization … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-13 | ⚠ 12 коммит(ов) в areas после сверки: f544eda feat: add project role authorization … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-12 | ⚠ 10 коммит(ов) в areas после сверки: f544eda feat: add project role authorization … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-08 | ⚠ 69 коммит(ов) в areas после сверки: f544eda feat: add project role authorization … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-10 | ⚠ 30 коммит(ов) в areas после сверки: f544eda feat: add project role authorization … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-13 | ⚠ 12 коммит(ов) в areas после сверки: f544eda feat: add project role authorization … |
