...
| [features/feature-preview.md](features/feature-preview.md) | Feature-preview окружения задач | 2026-08-17 | ⚠ 41 коммит(ов) в areas после сверки: bfe01606 fix(merge): restore current database implementation … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-16 | ⚠ 67 коммит(ов) в areas после сверки: bfe01606 fix(merge): restore current database implementation … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-21 | ⚠ 13 коммит(ов) в areas после сверки: bfe01606 fix(merge): restore current database implementation … |
