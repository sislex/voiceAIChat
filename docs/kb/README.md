...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-09 | ⚠ 34 коммит(ов) в areas после сверки: 316c0227 feat(kanban): add column navigator … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1359 коммит(ов) в areas после сверки: 6e243af8 feat(web-reader): add searchable assistant action history (#145) … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-11 | ⚠ 1 коммит(ов) в areas после сверки: e873c8db fix(web-reader): bound navigation preparation and isolate saves (#144) |
