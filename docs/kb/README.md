...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-17 | ⚠ 9 коммит(ов) в areas после сверки: 5685b72 feat: create task launch proposals in preparation … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-17 | ⚠ 12 коммит(ов) в areas после сверки: 085932f Merge task b506722d-246c-4cfd-bd01-e1d2cc806180 … |
| [features/feature-preview.md](features/feature-preview.md) | Feature-preview окружения задач | 2026-08-17 | ⚠ 3 коммит(ов) в areas после сверки: 5685b72 feat: create task launch proposals in preparation … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-16 | ⚠ 20 коммит(ов) в areas после сверки: 5685b72 feat: create task launch proposals in preparation … |
...
| [features/manual-qa.md](features/manual-qa.md) | Структурированное ручное QA | 2026-08-17 | ⚠ 3 коммит(ов) в areas после сверки: 5685b72 feat: create task launch proposals in preparation … |
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-17 | ⚠ 19 коммит(ов) в areas после сверки: 5685b72 feat: create task launch proposals in preparation … |
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-08-16 | ⚠ 22 коммит(ов) в areas после сверки: 085932f Merge task b506722d-246c-4cfd-bd01-e1d2cc806180 … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 409 коммит(ов) в areas после сверки: 085932f Merge task b506722d-246c-4cfd-bd01-e1d2cc806180 … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-16 | ⚠ 22 коммит(ов) в areas после сверки: 5685b72 feat: create task launch proposals in preparation … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-17 | ⚠ 1 коммит(ов) в areas после сверки: 5685b72 feat: create task launch proposals in preparation |
| [operations-app.md](operations-app.md) | Frontend-модуль Operations: граница, store и подключение | 2026-08-17 | ⚠ 3 коммит(ов) в areas после сверки: 085932f Merge task b506722d-246c-4cfd-bd01-e1d2cc806180 … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-17 | ✓ |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-17 | ⚠ 1 коммит(ов) в areas после сверки: 5685b72 feat: create task launch proposals in preparation |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-17 | ⚠ 5 коммит(ов) в areas после сверки: 085932f Merge task b506722d-246c-4cfd-bd01-e1d2cc806180 … |
