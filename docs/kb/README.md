...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-12 | ⚠ 14 коммит(ов) в areas после сверки: b526c09 CHAT-187 add shared sidebar toggle to kanban … |
...
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-12 | ⚠ 16 коммит(ов) в areas после сверки: b526c09 CHAT-187 add shared sidebar toggle to kanban … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-11 | ⚠ 28 коммит(ов) в areas после сверки: b526c09 CHAT-187 add shared sidebar toggle to kanban … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-08 | ⚠ 60 коммит(ов) в areas после сверки: 6066439 fix: number release deploy retries from the branch max attempt … |
