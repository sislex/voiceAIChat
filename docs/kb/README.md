...
|---|---|---|---|
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-01 | ⚠ 86 коммит(ов) в areas после сверки: a69c7a4 fix(merge): разрешить конфликты CHAT-184 с main … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-13 | ⚠ 7 коммит(ов) в areas после сверки: a69c7a4 fix(merge): разрешить конфликты CHAT-184 с main … |
...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-13 | ⚠ 5 коммит(ов) в areas после сверки: a69c7a4 fix(merge): разрешить конфликты CHAT-184 с main … |
...
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-13 | ⚠ 8 коммит(ов) в areas после сверки: a69c7a4 fix(merge): разрешить конфликты CHAT-184 с main … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 273 коммит(ов) в areas после сверки: a69c7a4 fix(merge): разрешить конфликты CHAT-184 с main … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-12 | ⚠ 15 коммит(ов) в areas после сверки: a69c7a4 fix(merge): разрешить конфликты CHAT-184 с main … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-13 | ⚠ 16 коммит(ов) в areas после сверки: a69c7a4 fix(merge): разрешить конфликты CHAT-184 с main … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-12 | ⚠ 14 коммит(ов) в areas после сверки: a69c7a4 fix(merge): разрешить конфликты CHAT-184 с main … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-08 | ⚠ 73 коммит(ов) в areas после сверки: a69c7a4 fix(merge): разрешить конфликты CHAT-184 с main … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-10 | ⚠ 34 коммит(ов) в areas после сверки: a69c7a4 fix(merge): разрешить конфликты CHAT-184 с main … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-13 | ⚠ 16 коммит(ов) в areas после сверки: a69c7a4 fix(merge): разрешить конфликты CHAT-184 с main … |
