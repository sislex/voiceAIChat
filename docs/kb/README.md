...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-29 | ⚠ 20 коммит(ов) в areas после сверки: 708fb486 fix(caddy): адрес стенда переменной, внутреннее имя для браузерного раннера … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 851 коммит(ов) в areas после сверки: bd6c540e docs(kb): на проде COMPOSE_FILE-override подменял Caddyfile мимо репозитория … |
...
| [stt-runner.md](stt-runner.md) | STT Runner: внутренний протокол, ресурсы и lifecycle | 2026-08-20 | ⚠ 93 коммит(ов) в areas после сверки: 708fb486 fix(caddy): адрес стенда переменной, внутреннее имя для браузерного раннера … |
...
| [testing-operations.md](testing-operations.md) | Разработка, тестирование, диагностика и эксплуатация | 2026-08-29 | ⚠ 9 коммит(ов) в areas после сверки: 708fb486 fix(caddy): адрес стенда переменной, внутреннее имя для браузерного раннера … |
