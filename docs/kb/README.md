...
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-13 | ⚠ 2 коммит(ов) в areas после сверки: 9c8c654 CHAT-199 reset knowledge usage badge on view … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 282 коммит(ов) в areas после сверки: 9c8c654 CHAT-199 reset knowledge usage badge on view … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-08 | ⚠ 80 коммит(ов) в areas после сверки: 9c8c654 CHAT-199 reset knowledge usage badge on view … |
