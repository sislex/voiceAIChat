...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-09-01 | ⚠ 22 коммит(ов) в areas после сверки: 8213b2b9 feat: студия картинок — итерация улучшений 6 (буфер, сравнение, мультивыбор) … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-03 | ⚠ 7 коммит(ов) в areas после сверки: 8213b2b9 feat: студия картинок — итерация улучшений 6 (буфер, сравнение, мультивыбор) … |
...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 11 коммит(ов) в areas после сверки: 8213b2b9 feat: студия картинок — итерация улучшений 6 (буфер, сравнение, мультивыбор) … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 195 коммит(ов) в areas после сверки: 8213b2b9 feat: студия картинок — итерация улучшений 6 (буфер, сравнение, мультивыбор) … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-02 | ⚠ 27 коммит(ов) в areas после сверки: 8213b2b9 feat: студия картинок — итерация улучшений 6 (буфер, сравнение, мультивыбор) … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-31 | ⚠ 102 коммит(ов) в areas после сверки: a4284163 feat: студия картинок — итерация улучшений 8 (валидация и черновики) … |
