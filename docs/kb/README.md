...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-17 | ⚠ 15 коммит(ов) в areas после сверки: c1e8525b Enforce personal tenant tariffs across applications … |
...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 215 коммит(ов) в areas после сверки: c1e8525b Enforce personal tenant tariffs across applications … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 371 коммит(ов) в areas после сверки: c1e8525b Enforce personal tenant tariffs across applications … |
| [features/llm-runners.md](features/llm-runners.md) | Исполнители LLM: контейнеры с claude/codex CLI | 2026-09-12 | ⚠ 18 коммит(ов) в areas после сверки: c1e8525b Enforce personal tenant tariffs across applications … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1587 коммит(ов) в areas после сверки: 840bee48 feat: define stable accounting identity and billing contracts … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-17 | ⚠ 12 коммит(ов) в areas после сверки: c1e8525b Enforce personal tenant tariffs across applications … |
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 380 коммит(ов) в areas после сверки: c1e8525b Enforce personal tenant tariffs across applications … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-09-14 | ⚠ 44 коммит(ов) в areas после сверки: c1e8525b Enforce personal tenant tariffs across applications … |
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-16 | ⚠ 19 коммит(ов) в areas после сверки: c1e8525b Enforce personal tenant tariffs across applications … |
| [operations-app.md](operations-app.md) | Frontend-модуль Operations: граница, store и подключение | 2026-08-19 | ⚠ 268 коммит(ов) в areas после сверки: c1e8525b Enforce personal tenant tariffs across applications … |
...
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-09-20 | ⚠ 1 коммит(ов) в areas после сверки: 840bee48 feat: define stable accounting identity and billing contracts |
...
| [tts-runner.md](tts-runner.md) | TTS Runner: ресурсный API, движки и жизненный цикл WAV | 2026-08-26 | ⚠ 162 коммит(ов) в areas после сверки: c1e8525b Enforce personal tenant tariffs across applications … |
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-20 | ⚠ 3 коммит(ов) в areas после сверки: c1e8525b Enforce personal tenant tariffs across applications … |
