...
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-08-28 | ⚠ 1 коммит(ов) в areas после сверки: 43f3b3c7 chore(compose): проброс VC_SMTP_URL/VC_MAIL_FROM/VC_PUBLIC_URL в server для регистрации по email |
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 102 коммит(ов) в areas после сверки: 43f3b3c7 chore(compose): проброс VC_SMTP_URL/VC_MAIL_FROM/VC_PUBLIC_URL в server для регистрации по email … |
...
| [stt-runner.md](stt-runner.md) | STT Runner: внутренний протокол, ресурсы и lifecycle | 2026-08-20 | ⚠ 60 коммит(ов) в areas после сверки: 43f3b3c7 chore(compose): проброс VC_SMTP_URL/VC_MAIL_FROM/VC_PUBLIC_URL в server для регистрации по email … |
...
| [tts-runner.md](tts-runner.md) | TTS Runner: ресурсный API, движки и жизненный цикл WAV | 2026-08-26 | ⚠ 13 коммит(ов) в areas после сверки: 43f3b3c7 chore(compose): проброс VC_SMTP_URL/VC_MAIL_FROM/VC_PUBLIC_URL в server для регистрации по email … |
