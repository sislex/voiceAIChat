...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-09-01 | ⚠ 32 коммит(ов) в areas после сверки: 19385fa0 fix(ui): invalidate stale Mac artifact responses … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-03 | ⚠ 23 коммит(ов) в areas после сверки: 19385fa0 fix(ui): invalidate stale Mac artifact responses … |
...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 22 коммит(ов) в areas после сверки: 19385fa0 fix(ui): invalidate stale Mac artifact responses … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 199 коммит(ов) в areas после сверки: 19385fa0 fix(ui): invalidate stale Mac artifact responses … |
...
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-09-03 | ⚠ 16 коммит(ов) в areas после сверки: 19385fa0 fix(ui): invalidate stale Mac artifact responses … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1127 коммит(ов) в areas после сверки: 300c1846 docs(kb): update after merge 62924b76-03c6-4cb4-9655-0beb657de2be … |
...
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-29 | ⚠ 211 коммит(ов) в areas после сверки: 19385fa0 fix(ui): invalidate stale Mac artifact responses … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-09-02 | ⚠ 38 коммит(ов) в areas после сверки: 19385fa0 fix(ui): invalidate stale Mac artifact responses … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-09-03 | ✓ |
| [operations-app.md](operations-app.md) | Frontend-модуль Operations: граница, store и подключение | 2026-08-19 | ⚠ 188 коммит(ов) в areas после сверки: 19385fa0 fix(ui): invalidate stale Mac artifact responses … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-03 | ⚠ 25 коммит(ов) в areas после сверки: 19385fa0 fix(ui): invalidate stale Mac artifact responses … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-09-03 | ⚠ 4 коммит(ов) в areas после сверки: 59d8d553 feat: студия картинок — итерация улучшений 34 (метрики и прозрачность) … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-03 | ⚠ 3 коммит(ов) в areas после сверки: 3e7a63ae Merge task 62924b76-03c6-4cb4-9655-0beb657de2be … |
