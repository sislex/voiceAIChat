...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-09 | ⚠ 55 коммит(ов) в areas после сверки: b7dfaea4 feat(kanban): clarify stale board errors … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1387 коммит(ов) в areas после сверки: b7dfaea4 feat(kanban): clarify stale board errors … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-09-11 | ⚠ 28 коммит(ов) в areas после сверки: b7dfaea4 feat(kanban): clarify stale board errors … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-10 | ⚠ 30 коммит(ов) в areas после сверки: b7dfaea4 feat(kanban): clarify stale board errors … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-11 | ⚠ 19 коммит(ов) в areas после сверки: b7dfaea4 feat(kanban): clarify stale board errors … |
