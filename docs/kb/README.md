...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-09-10 | ⚠ 10 коммит(ов) в areas после сверки: 316139ed feat(playwright-reader): read the page's own data (cycle 6) … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-09-10 | ⚠ 26 коммит(ов) в areas после сверки: 316139ed feat(playwright-reader): read the page's own data (cycle 6) … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1353 коммит(ов) в areas после сверки: 316139ed feat(playwright-reader): read the page's own data (cycle 6) … |
...
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 325 коммит(ов) в areas после сверки: 316139ed feat(playwright-reader): read the page's own data (cycle 6) … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-10 | ⚠ 10 коммит(ов) в areas после сверки: 316139ed feat(playwright-reader): read the page's own data (cycle 6) … |
...
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-09-11 | ⚠ 13 коммит(ов) в areas после сверки: 316139ed feat(playwright-reader): read the page's own data (cycle 6) … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-15 | ⚠ 4 коммит(ов) в areas после сверки: 316139ed feat(playwright-reader): read the page's own data (cycle 6) … |
