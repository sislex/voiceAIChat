...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-16 | ⚠ 1 коммит(ов) в areas после сверки: 4e73cbf fix(ui): allow machine selection for merge retry |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 371 коммит(ов) в areas после сверки: 4e73cbf fix(ui): allow machine selection for merge retry … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-12 | ⚠ 52 коммит(ов) в areas после сверки: 4e73cbf fix(ui): allow machine selection for merge retry … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-16 | ✓ |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-12 | ⚠ 46 коммит(ов) в areas после сверки: 4e73cbf fix(ui): allow machine selection for merge retry … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-15 | ⚠ код изменён 2026-08-16, сверка 2026-08-15 (по датам: правки того же дня не видны — поставь checked) |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-16 | ⚠ 1 коммит(ов) в areas после сверки: 4e73cbf fix(ui): allow machine selection for merge retry |
