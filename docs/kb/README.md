...
|---|---|---|---|
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-07-27 | ⚠ 18 коммит(ов) в areas после сверки: b9ce02c feat(kanban): режим план/разработка, вопросы модели в ране и связка задача↔чат … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-07-27 | ⚠ 20 коммит(ов) в areas после сверки: bfe973e feat(kanban): подсветка карточки по состоянию CI-рана и блокировка повторного запуска … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-07-30 | ✓ |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-07-30 | ✓ |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-07-27 | ⚠ 30 коммит(ов) в areas после сверки: bfe973e feat(kanban): подсветка карточки по состоянию CI-рана и блокировка повторного запуска … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-07-27 | ⚠ 14 коммит(ов) в areas после сверки: bfe973e feat(kanban): подсветка карточки по состоянию CI-рана и блокировка повторного запуска … |
| [stt-tts.md](stt-tts.md) | Речь: Whisper (STT) и Piper/say (TTS) | 2026-07-26 | ✓ |
| [testing-operations.md](testing-operations.md) | Разработка, тестирование, диагностика и эксплуатация | 2026-07-27 | ✓ |
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-07-29 | ⚠ 18 коммит(ов) в areas после сверки: bfe973e feat(kanban): подсветка карточки по состоянию CI-рана и блокировка повторного запуска … |
