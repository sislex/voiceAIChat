...
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-08-13 | ⚠ 7 коммит(ов) в areas после сверки: de5a825 feat: prepare release checkout automatically … |
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-13 | ⚠ 10 коммит(ов) в areas после сверки: 7447d37 feat(ui): improve releases page states and layout … |
...
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-13 | ⚠ 6 коммит(ов) в areas после сверки: 234cf72 Merge task a6c710e5-42eb-49de-8ac1-bde7558ac718 … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-13 | ⚠ 25 коммит(ов) в areas после сверки: 7447d37 feat(ui): improve releases page states and layout … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-13 | ⚠ 7 коммит(ов) в areas после сверки: 7447d37 feat(ui): improve releases page states and layout … |
