...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-08-19 | ⚠ 206 коммит(ов) в areas после сверки: 913a9e62 Merge branch 'feat/context-inspector-round-4': журнал контекста, правка на месте и доступность … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-31 | ⚠ 4 коммит(ов) в areas после сверки: 913a9e62 Merge branch 'feat/context-inspector-round-4': журнал контекста, правка на месте и доступность … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-29 | ⚠ 138 коммит(ов) в areas после сверки: 913a9e62 Merge branch 'feat/context-inspector-round-4': журнал контекста, правка на месте и доступность … |
...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-08-31 | ⚠ 17 коммит(ов) в areas после сверки: 913a9e62 Merge branch 'feat/context-inspector-round-4': журнал контекста, правка на месте и доступность … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 135 коммит(ов) в areas после сверки: 913a9e62 Merge branch 'feat/context-inspector-round-4': журнал контекста, правка на месте и доступность … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 978 коммит(ов) в areas после сверки: 913a9e62 Merge branch 'feat/context-inspector-round-4': журнал контекста, правка на месте и доступность … |
...
| [features/task-preparation.md](features/task-preparation.md) | Интерактивная подготовка задачи и Development Brief | 2026-08-28 | ⚠ 142 коммит(ов) в areas после сверки: 913a9e62 Merge branch 'feat/context-inspector-round-4': журнал контекста, правка на месте и доступность … |
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 179 коммит(ов) в areas после сверки: 913a9e62 Merge branch 'feat/context-inspector-round-4': журнал контекста, правка на месте и доступность … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-31 | ⚠ 8 коммит(ов) в areas после сверки: 913a9e62 Merge branch 'feat/context-inspector-round-4': журнал контекста, правка на месте и доступность … |
