...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-17 | ⚠ 11 коммит(ов) в areas после сверки: faabf49f feat: configure versioned component dependencies and scoped provider tokens … |
...
| [features/kanban-assistant.md](features/kanban-assistant.md) | Канбан-ассистент: инструменты проекта, управление UI и оркестрация задач | 2026-09-02 | ⚠ 211 коммит(ов) в areas после сверки: faabf49f feat: configure versioned component dependencies and scoped provider tokens … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 368 коммит(ов) в areas после сверки: faabf49f feat: configure versioned component dependencies and scoped provider tokens … |
| [features/llm-runners.md](features/llm-runners.md) | Исполнители LLM: контейнеры с claude/codex CLI | 2026-09-12 | ⚠ 15 коммит(ов) в areas после сверки: faabf49f feat: configure versioned component dependencies and scoped provider tokens … |
...
| [kb-workflow.md](kb-workflow.md) | Как устроена и ведётся база знаний | 2026-08-31 | ⚠ 32 коммит(ов) в areas после сверки: faabf49f feat: configure versioned component dependencies and scoped provider tokens … |
...
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-09-17 | ⚠ 5 коммит(ов) в areas после сверки: faabf49f feat: configure versioned component dependencies and scoped provider tokens … |
