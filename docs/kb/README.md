...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-09 | ⚠ 47 коммит(ов) в areas после сверки: d3df2615 feat(kanban): add keyboard shortcut help … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1379 коммит(ов) в areas после сверки: d3df2615 feat(kanban): add keyboard shortcut help … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-09-11 | ⚠ 20 коммит(ов) в areas после сверки: d3df2615 feat(kanban): add keyboard shortcut help … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-10 | ⚠ 23 коммит(ов) в areas после сверки: d3df2615 feat(kanban): add keyboard shortcut help … |
| [features/task-autopilot.md](features/task-autopilot.md) | Автопроход задачи по QA-конвейеру | 2026-09-11 | ⚠ 9 коммит(ов) в areas после сверки: c1910313 feat(kanban): add due date windows … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-11 | ⚠ 11 коммит(ов) в areas после сверки: d3df2615 feat(kanban): add keyboard shortcut help … |
