...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-09 | ⚠ 60 коммит(ов) в areas после сверки: ea4c1e13 feat(kanban): copy the visible board view … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1392 коммит(ов) в areas после сверки: ea4c1e13 feat(kanban): copy the visible board view … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-09-11 | ⚠ 33 коммит(ов) в areas после сверки: ea4c1e13 feat(kanban): copy the visible board view … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-10 | ⚠ 34 коммит(ов) в areas после сверки: ea4c1e13 feat(kanban): copy the visible board view … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-11 | ⚠ 24 коммит(ов) в areas после сверки: ea4c1e13 feat(kanban): copy the visible board view … |
