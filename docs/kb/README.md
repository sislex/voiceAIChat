...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1441 коммит(ов) в areas после сверки: 5d1e1a59 Merge main into CHAT-460 (task d97b6730-116b-40ac-bef0-16d73ee33009) … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-09-13 | ⚠ 6 коммит(ов) в areas после сверки: 5d1e1a59 Merge main into CHAT-460 (task d97b6730-116b-40ac-bef0-16d73ee33009) … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-09-13 | ⚠ 6 коммит(ов) в areas после сверки: 5d1e1a59 Merge main into CHAT-460 (task d97b6730-116b-40ac-bef0-16d73ee33009) … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-13 | ⚠ 2 коммит(ов) в areas после сверки: 5d1e1a59 Merge main into CHAT-460 (task d97b6730-116b-40ac-bef0-16d73ee33009) … |
