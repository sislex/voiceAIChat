...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-06 | ⚠ 11 коммит(ов) в areas после сверки: afd9eb4 feat(ui): integrate preview element context … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-08 | ⚠ 6 коммит(ов) в areas после сверки: afd9eb4 feat(ui): integrate preview element context … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 129 коммит(ов) в areas после сверки: afd9eb4 feat(ui): integrate preview element context … |
...
| [llm.md](llm.md) | LLM: claude/codex CLI, ходы, stream-json, gateway | 2026-08-07 | ⚠ 2 коммит(ов) в areas после сверки: afd9eb4 feat(ui): integrate preview element context … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-07 | ⚠ 4 коммит(ов) в areas после сверки: afd9eb4 feat(ui): integrate preview element context … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-08 | ⚠ 2 коммит(ов) в areas после сверки: afd9eb4 feat(ui): integrate preview element context … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-08 | ⚠ 2 коммит(ов) в areas после сверки: afd9eb4 feat(ui): integrate preview element context … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-07 | ⚠ 15 коммит(ов) в areas после сверки: afd9eb4 feat(ui): integrate preview element context … |
