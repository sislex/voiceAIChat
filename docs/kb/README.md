...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 686 коммит(ов) в areas после сверки: 3602d00b feat(make): история публикаций с откатом на прежний снимок (roadmap-2 п.11) … |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-27 | ⚠ 17 коммит(ов) в areas после сверки: 3602d00b feat(make): история публикаций с откатом на прежний снимок (roadmap-2 п.11) … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-27 | ⚠ 28 коммит(ов) в areas после сверки: 3602d00b feat(make): история публикаций с откатом на прежний снимок (roadmap-2 п.11) … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-27 | ⚠ 1 коммит(ов) в areas после сверки: 3602d00b feat(make): история публикаций с откатом на прежний снимок (roadmap-2 п.11) |
