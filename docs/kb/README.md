...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-29 | ⚠ 44 коммит(ов) в areas после сверки: 67c5d979 Merge remote-tracking branch 'origin/main' into work3 … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 883 коммит(ов) в areas после сверки: 67c5d979 Merge remote-tracking branch 'origin/main' into work3 … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-08-30 | ⚠ 14 коммит(ов) в areas после сверки: 67c5d979 Merge remote-tracking branch 'origin/main' into work3 … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-08-29 | ⚠ 42 коммит(ов) в areas после сверки: 67c5d979 Merge remote-tracking branch 'origin/main' into work3 … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-29 | ⚠ 31 коммит(ов) в areas после сверки: 67c5d979 Merge remote-tracking branch 'origin/main' into work3 … |
