...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 66 коммит(ов) в areas после сверки: 10b9c5fc feat(make): ревизия стилей — меню «⋯» в шапке, отступы диалогов, мобильная вёрстка … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-27 | ⚠ 1 коммит(ов) в areas после сверки: 10b9c5fc feat(make): ревизия стилей — меню «⋯» в шапке, отступы диалогов, мобильная вёрстка |
