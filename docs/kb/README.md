...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-09 | ⚠ 48 коммит(ов) в areas после сверки: 62cad05c feat(kanban): explain search matches … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1380 коммит(ов) в areas после сверки: 62cad05c feat(kanban): explain search matches … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-09-11 | ⚠ 21 коммит(ов) в areas после сверки: 62cad05c feat(kanban): explain search matches … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-10 | ⚠ 24 коммит(ов) в areas после сверки: 62cad05c feat(kanban): explain search matches … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-11 | ⚠ 12 коммит(ов) в areas после сверки: 62cad05c feat(kanban): explain search matches … |
