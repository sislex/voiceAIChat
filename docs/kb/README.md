...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-07-30 | ✓ |
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-07-30 | ✓ |
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-07-30 | ⚠ 2 коммит(ов) в areas после сверки: a2c30d6 chore(ui): убрать упоминание нативного диалога из комментариев в src … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-07-27 | ⚠ 4 коммит(ов) в areas после сверки: 343ef28 fix(llm): подсказать модели timeout_ms у remote-bash … |
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-07-30 | ⚠ 4 коммит(ов) в areas после сверки: 8b0871a feat(ui): тосты и ConfirmDialog вместо window.confirm … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-07-30 | ✓ |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-07-27 | ⚠ 33 коммит(ов) в areas после сверки: 343ef28 fix(llm): подсказать модели timeout_ms у remote-bash … |
