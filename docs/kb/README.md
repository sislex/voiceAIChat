...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-09 | ⚠ 44 коммит(ов) в areas после сверки: 30a67c22 feat(kanban): add priority overview … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1376 коммит(ов) в areas после сверки: 30a67c22 feat(kanban): add priority overview … |
| [features/qa-stage-runs.md](features/qa-stage-runs.md) | Раны QA-этапов: отдельные сущности и вкладки карточки | 2026-09-11 | ⚠ 17 коммит(ов) в areas после сверки: 30a67c22 feat(kanban): add priority overview … |
| [features/releases.md](features/releases.md) | Версионные release-ветки и публикация в production | 2026-09-10 | ⚠ 20 коммит(ов) в areas после сверки: 30a67c22 feat(kanban): add priority overview … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-11 | ⚠ 8 коммит(ов) в areas после сверки: 30a67c22 feat(kanban): add priority overview … |
