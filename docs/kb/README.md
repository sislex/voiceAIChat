...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-07-29 | ⚠ 19 коммит(ов) в areas после сверки: 66f6b1e feat(ci): резюме рана отдельным сообщением в связанном чате задачи … |
