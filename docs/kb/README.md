...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1605 коммит(ов) в areas после сверки: b4b59b3e perf(test): scope development gates and isolate parallel browser suites … |
...
| [kb-workflow.md](kb-workflow.md) | Как устроена и ведётся база знаний | 2026-08-31 | ⚠ 40 коммит(ов) в areas после сверки: b4b59b3e perf(test): scope development gates and isolate parallel browser suites … |
