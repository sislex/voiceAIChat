...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-08-19 | ⚠ 49 коммит(ов) в areas после сверки: aecf49ec perf(kanban): лёгкая доска + точечные WS-обновления подготовки … |
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-20 | ⚠ 63 коммит(ов) в areas после сверки: aecf49ec perf(kanban): лёгкая доска + точечные WS-обновления подготовки … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-18 | ⚠ 53 коммит(ов) в areas после сверки: aecf49ec perf(kanban): лёгкая доска + точечные WS-обновления подготовки … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-25 | ⚠ 11 коммит(ов) в areas после сверки: 002a4e5d Merge task 00329756-6f21-4fe8-8251-9823a6f5337d … |
| [features/feature-preview.md](features/feature-preview.md) | Feature-preview окружения задач | 2026-08-23 | ⚠ 16 коммит(ов) в areas после сверки: aecf49ec perf(kanban): лёгкая доска + точечные WS-обновления подготовки … |
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-16 | ⚠ 107 коммит(ов) в areas после сверки: aecf49ec perf(kanban): лёгкая доска + точечные WS-обновления подготовки … |
| [features/llm-runners.md](features/llm-runners.md) | Исполнители LLM: контейнеры с claude/codex CLI | 2026-08-18 | ⚠ 45 коммит(ов) в areas после сверки: aecf49ec perf(kanban): лёгкая доска + точечные WS-обновления подготовки … |
...
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 38 коммит(ов) в areas после сверки: aecf49ec perf(kanban): лёгкая доска + точечные WS-обновления подготовки … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-25 | ⚠ 11 коммит(ов) в areas после сверки: aecf49ec perf(kanban): лёгкая доска + точечные WS-обновления подготовки … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-25 | ✓ |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-25 | ⚠ 6 коммит(ов) в areas после сверки: aecf49ec perf(kanban): лёгкая доска + точечные WS-обновления подготовки … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-25 | ⚠ 5 коммит(ов) в areas после сверки: aecf49ec perf(kanban): лёгкая доска + точечные WS-обновления подготовки … |
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-24 | ⚠ 22 коммит(ов) в areas после сверки: aecf49ec perf(kanban): лёгкая доска + точечные WS-обновления подготовки … |
