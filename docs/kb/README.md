...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-20 | ⚠ 181 коммит(ов) в areas после сверки: 7cb57b15 feat: select project when creating conversation … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-08-31 | ⚠ 14 коммит(ов) в areas после сверки: 14747e24 Merge task 51777218-343c-4313-94f4-9379625af31d … |
...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-29 | ⚠ 116 коммит(ов) в areas после сверки: 14747e24 Merge task 51777218-343c-4313-94f4-9379625af31d … |
...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-28 | ⚠ 115 коммит(ов) в areas после сверки: 14747e24 Merge task 51777218-343c-4313-94f4-9379625af31d … |
...
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 163 коммит(ов) в areas после сверки: 14747e24 Merge task 51777218-343c-4313-94f4-9379625af31d … |
...
| [machines.md](machines.md) | Машины: компаньон-агент, политика, PTY, проводник | 2026-08-28 | ⚠ 109 коммит(ов) в areas после сверки: 14747e24 Merge task 51777218-343c-4313-94f4-9379625af31d … |
...
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-31 | ⚠ 2 коммит(ов) в areas после сверки: 7cb57b15 feat: select project when creating conversation … |
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-08-31 | ⚠ 2 коммит(ов) в areas после сверки: 14747e24 Merge task 51777218-343c-4313-94f4-9379625af31d … |
