...
|---|---|---|---|
| [admin-app.md](admin-app.md) | Frontend-модуль Administration: граница, store и подключение | 2026-08-19 | ⚠ 58 коммит(ов) в areas после сверки: a6eea46e feat(make): загрузка файлов с диска и просмотр бинарников в режиме «Код» … |
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-08-20 | ⚠ 74 коммит(ов) в areas после сверки: a6eea46e feat(make): загрузка файлов с диска и просмотр бинарников в режиме «Код» … |
...
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 628 коммит(ов) в areas после сверки: a6eea46e feat(make): загрузка файлов с диска и просмотр бинарников в режиме «Код» … |
...
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-08-26 | ⚠ 1 коммит(ов) в areas после сверки: a6eea46e feat(make): загрузка файлов с диска и просмотр бинарников в режиме «Код» |
...
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-08-26 | ⚠ 7 коммит(ов) в areas после сверки: a6eea46e feat(make): загрузка файлов с диска и просмотр бинарников в режиме «Код» … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-08-26 | ⚠ 1 коммит(ов) в areas после сверки: a6eea46e feat(make): загрузка файлов с диска и просмотр бинарников в режиме «Код» |
