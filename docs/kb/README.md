...
| [features/kb-usage.md](features/kb-usage.md) | Использование базы знаний (телеметрия и панель) | 2026-08-13 | ⚠ 1 коммит(ов) в areas после сверки: da2bff7 Merge task 4637c3a0-b042-48f4-a1b0-d572315f0b86 |
...
| [features/merge-runner.md](features/merge-runner.md) | Merge-ран задачи: безопасное слияние в main | 2026-08-13 | ⚠ 2 коммит(ов) в areas после сверки: da2bff7 Merge task 4637c3a0-b042-48f4-a1b0-d572315f0b86 … |
