...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-09-09 | ⚠ 62 коммит(ов) в areas после сверки: 4fd080ff feat(kanban): add board diagnostics snapshot … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-12 | ⚠ 1 коммит(ов) в areas после сверки: 4fd080ff feat(kanban): add board diagnostics snapshot |
