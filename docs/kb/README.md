...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-09-15 | ⚠ 22 коммит(ов) в areas после сверки: 9e663b79 feat: configure machine command notifications … |
