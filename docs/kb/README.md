...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-08-24 | ⚠ 6 коммит(ов) в areas после сверки: 4a7c3b1c merge: resolve CHAT-340 conflicts with current main … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-08-24 | ⚠ 5 коммит(ов) в areas после сверки: 4a7c3b1c merge: resolve CHAT-340 conflicts with current main … |
