...
| [architecture.md](architecture.md) | Архитектура: кто с кем разговаривает | 2026-09-10 | ⚠ 3 коммит(ов) в areas после сверки: d8ea3831 feat(web-reader): add read-only control probes (QA cycle 05) … |
...
| [data-auth.md](data-auth.md) | Данные и доступ: SQLite, пользователи, роли | 2026-09-10 | ⚠ 19 коммит(ов) в areas после сверки: d8ea3831 feat(web-reader): add read-only control probes (QA cycle 05) … |
| [deploy.md](deploy.md) | Деплой: Docker, HTTPS, прод-сервер, env | 2026-09-10 | ⚠ 5 коммит(ов) в areas после сверки: d8ea3831 feat(web-reader): add read-only control probes (QA cycle 05) … |
...
| [features/playwright-reader.md](features/playwright-reader.md) | Playwright Reader и browser-runner | 2026-09-10 | ⚠ 7 коммит(ов) в areas после сверки: e84b2176 feat(web-reader): add focus and keyboard diagnostics (QA cycle 07) … |
| [features/project-knowledge-base.md](features/project-knowledge-base.md) | База знаний проекта | 2026-08-02 | ⚠ 1345 коммит(ов) в areas после сверки: e84b2176 feat(web-reader): add focus and keyboard diagnostics (QA cycle 07) … |
...
| [image-retouch.md](image-retouch.md) | Локальная AI-ретушь изображений | 2026-08-22 | ⚠ 318 коммит(ов) в areas после сверки: d8ea3831 feat(web-reader): add read-only control probes (QA cycle 05) … |
...
| [projects.md](projects.md) | Проекты и канбан-доска | 2026-09-10 | ⚠ 3 коммит(ов) в areas после сверки: d8ea3831 feat(web-reader): add read-only control probes (QA cycle 05) … |
| [protocol.md](protocol.md) | Контракт клиент↔сервер (REST, WS, мосты) | 2026-09-10 | ⚠ 4 коммит(ов) в areas после сверки: d8ea3831 feat(web-reader): add read-only control probes (QA cycle 05) … |
...
| [shared.md](shared.md) | Общий пакет: типы, контракты и чистая логика | 2026-09-11 | ⚠ 6 коммит(ов) в areas после сверки: d8ea3831 feat(web-reader): add read-only control probes (QA cycle 05) … |
...
| [testing-operations.md](testing-operations.md) | Разработка, тестирование, диагностика и эксплуатация | 2026-09-11 | ⚠ 4 коммит(ов) в areas после сверки: d8ea3831 feat(web-reader): add read-only control probes (QA cycle 05) … |
...
| [ui.md](ui.md) | Интерфейс: React, store, remote-мосты и голосовой UX | 2026-09-11 | ⚠ 4 коммит(ов) в areas после сверки: d8ea3831 feat(web-reader): add read-only control probes (QA cycle 05) … |
