...
| [features/ci-runner.md](features/ci-runner.md) | CI-раннер канбана (Авто-подготовка окружения для таска) | 2026-07-31 | ⚠ 1 коммит(ов) в areas после сверки: 21ea991 feat(ci): выполненный, но не вмерженный ран уводит карточку в «Ожидает мержа» |
...
| [server-internals.md](server-internals.md) | Backend изнутри: сборка, маршруты, сессии и сервисы | 2026-07-27 | ⚠ 39 коммит(ов) в areas после сверки: 21ea991 feat(ci): выполненный, но не вмерженный ран уводит карточку в «Ожидает мержа» … |
