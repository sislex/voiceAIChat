...
другая ветка, offline-машина и ошибка fetch блокируют ход вместо работы по
устаревшему коду. Уже созданный `task_workspace` не переключается на main: его
feature-веткой управляет CI lifecycle.
