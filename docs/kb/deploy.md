...
не зависит от наличия Git-тега на выбранном SHA. Для обычного production deploy
...
Эти же скрипты экспортируют `VC_RELEASE_COMMIT` с 12-символьным SHA. Из темы
