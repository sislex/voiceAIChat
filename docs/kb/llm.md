...
ключ в настройках = включено, поэтому старые конфиги ведут себя как раньше. Парсеры
блоков включённость не проверяют — вырезание из TTS и рендер работают всегда.
