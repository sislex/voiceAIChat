...
- Прогон на копии прод-БД четырьмя процессами сделан (см. план, круг 3 п. 4); PR этапа 3 — #114.
- Долг: перекат отдельных сервисов в Release Center; `ptyBufferText` у ядра в remote — с момента подписки.
