...
- Реестра исполнителей ещё нет: текущий срез работает только с адресами исполнителя из env и не закрывает файловые API, вложения и резолв `cwd` на стороне runner.
