import { startReaderDiagnosticsFixture } from '@sislexa/playwright-reader/browser-runner/testing/readerDiagnostics'
...
import { startReaderFramesFixture } from '@sislexa/playwright-reader/browser-runner/testing/readerFrames'
import { startReaderDownloadsFixture } from '@sislexa/playwright-reader/browser-runner/testing/readerDownloads'
import { startReaderDialogsFixture } from '@sislexa/playwright-reader/browser-runner/testing/readerDialogs'
import { startReaderInputFixture } from '@sislexa/playwright-reader/browser-runner/testing/readerInput'
import { startReaderProfileFixture } from '@sislexa/playwright-reader/browser-runner/testing/readerProfile'
import { startReaderFormsFixture } from '@sislexa/playwright-reader/browser-runner/testing/readerForms'
import { BROWSER_UPLOAD_LIMIT_BYTES } from '@voicechat/browser-contracts/browserLimits'
import { runScenarioStep, type ScenarioSend, type BrowserSelectorResult } from '@voicechat/shared'
