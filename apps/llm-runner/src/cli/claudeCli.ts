...
export function claudeArgs(req: LlmRequest): string[] {
  ...
  if (req.previewMcpUrl) {
    ...
    if (req.remote || process.env.VC_KB_TOOL_ALLOWLIST === '1') {
      ...
      allowed.push('mcp__browser__frames', 'mcp__browser__styles', 'mcp__browser__tabs', 'mcp__browser__new-tab', 'mcp__browser__select-tab', 'mcp__browser__close-tab', 'mcp__browser__reload', 'mcp__browser__stop-loading')
