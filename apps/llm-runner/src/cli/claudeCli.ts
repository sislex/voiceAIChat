...
export function claudeArgs(req: LlmRequest): string[] {
  ...
  if (req.previewMcpUrl) {
    ...
    if (req.remote || process.env.VC_KB_TOOL_ALLOWLIST === '1') {
      ...
      allowed.push('mcp__browser__downloads', 'mcp__browser__read-download', 'mcp__browser__cancel-download', 'mcp__browser__delete-download', 'mcp__browser__dialogs', 'mcp__browser__handle-dialog', 'mcp__browser__reset-session', 'mcp__browser__frames', 'mcp__browser__styles', 'mcp__browser__tabs', 'mcp__browser__new-tab', 'mcp__browser__select-tab', 'mcp__browser__close-tab', 'mcp__browser__reload', 'mcp__browser__stop-loading')
