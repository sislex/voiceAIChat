// SSRF-гард для исходящих запросов сервера: Web Reader (прокси превью) и импорт в Make
// ходят только на публичные адреса — ни loopback, ни приватных сетей, ни link-local.
// Живёт отдельно от роутов превью, потому что нужен обоим и ни одному из них не принадлежит.
