...
const ALLOWED_REGISTRY_IMPORTERS = new Set(['machines/module.ts', 'machines/service.ts', 'agents/wsAgent.ts', 'routes/agents.ts', 'routes/restHarness.ts', 'server.ts', 'kanban/core.ts'])
