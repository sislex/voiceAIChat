...
export const TABLE_OWNER: Record<RepoDomain, readonly string[]> = {
  ...
  machines: ['agents', 'machine_commands', 'machine_events', 'machine_storages', 'chat_storage_bindings', 'generated_cleanup_retry', 'login_enrollments', 'machine_project_shares', 'machine_project_share_audit', 'project_machines', 'user_project_machine_defaults', 'user_project_release_machines', 'git_workspace_locks'],
