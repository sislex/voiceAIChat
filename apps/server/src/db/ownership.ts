...
export const TABLE_OWNER: Record<RepoDomain, readonly string[]> = {
  ...
  releases: ['project_releases', 'project_release_steps', 'project_release_events', 'release_notifications', 'application_releases', 'application_environments', 'application_deployments'],
