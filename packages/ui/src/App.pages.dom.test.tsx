...
describe('App — утилиты как страницы по URL', () => {
  ...
  it('пункт «История LLM» в сайдбаре ведёт на #/claude-code, «Закрыть» возвращает чат', async () => {
    await renderApp()
    await userEvent.click(await screen.findByRole('button', { name: 'История LLM' }))
