...
//
// Нужен почти каждому экранному тесту: window.confirm больше нет, подтверждение
// приходит из ConfirmProvider — то есть в тестах его кликают, а не мокают. Чтобы
// не повторять обёртку в каждом файле, экраны рендерим отсюда:
//
