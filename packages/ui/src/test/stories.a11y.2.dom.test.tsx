// Прогон витрины через axe, шард 2 из 3. Разбит на шарды, потому что Vitest
...
describeStoryShard('сториз, шард 2/3', await collectShard(modules, { index: 2, total: 3 }), 40)
