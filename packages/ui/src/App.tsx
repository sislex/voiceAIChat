...
function AppBody({ api = window.api, now }: AppProps = {}): JSX.Element {
  ...
  useEffect(() => { setPreviewElement(null); setReaderActions([]); setReaderPageError(null); setReaderPendingAction(null); setSplitAttention(null); setReaderPageTitle(null); setReaderActionError(null); setReaderManual(false); setReaderPageErrorCount(0) }, [chat.activeId])
