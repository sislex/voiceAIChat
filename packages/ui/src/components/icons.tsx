...
export function DiagonalResizeIcon({ expanded = false }: { expanded?: boolean } = {}): JSX.Element {
  return (
    ...
    >
      <path d="M16 3 L21 3 L21 8" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M8 21 L3 21 L3 16" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
