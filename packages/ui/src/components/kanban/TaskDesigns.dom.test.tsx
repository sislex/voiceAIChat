...
describe('TaskDesigns — секция «Дизайн» карточки', () => {
  it('связывает карточку со страницей Make-проекта и показывает её в списке', async () => {
    ...
    await userEvent.selectOptions(await screen.findByLabelText('Страница дизайна'), 'pay.html')
    ...
    // Превью адресует живой Make-проект, а не снимок: макет правится дальше.
