  ...
  return (
    <div className="proj-detail" data-testid="project-settings">
      ...
      {activeTab === 'workflow' && <div className="proj-section feature-policy">
        ...
        <label>CI: шаблон ветки<input className="login-input" disabled={!isOwner} value={detail.ciBranchTemplate ?? ''} onChange={(e) => props.onUpdate(detail.id, { ciBranchTemplate: e.target.value })} placeholder="feature/{task_number}" /></label>
