...
export interface LlmSettingsEditorProps {
  ...
  /** Показывать селектор исполнителя даже без доступных персональных engine. */
  showEngine?: boolean
...
export function LlmSettingsEditor({ value, inherited, overridden = true, engines = [], llmAccess = [], editable = true, labels, showEngine = false, onChange, onReset }: LlmSettingsEditorProps): JSX.Element {
