...
export const READER_CORE_RPC_METHODS = ['context', 'canUseMachine', 'machineOnline', 'machineHttp', 'projectResource', 'previewAction', 'issuePreviewRunKey', 'listPreviews', 'logBrowserShot', 'logBrowserEvidence'] as const
