...
describe('admin routes', () => {
  it.each(['#/users/alice/sessions', '#/users?state=inactive&sort=login', '#/users', '#/users/alice', '#/users/alice/overview', '#/users/alice/access', '#/users/alice/machines', '#/users/alice/usage', '#/users/alice/history', '#/users/engines', '#/users/prices', '#/users/project-types', '#/users/system'])(
    'round trips %s',
    (hash) => {
