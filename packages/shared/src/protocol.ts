...
export const REST = {
  ...
  loginApplicationArtifacts: '/api/login-application/artifacts',
  loginApplicationDownload: '/api/login-application/download',
  loginEnrollmentIssue: '/api/login-application/enrollments',
  loginEnrollmentRedeem: '/api/login-application/enrollments/redeem',
  loginEnrollmentStatus: (id: string) => `/api/login-application/enrollments/${encodeURIComponent(id)}`,
  ...
  agentsExecBatch: '/api/agents/exec-batch',
  ...
  adminCommandPolicy: '/api/admin/command-policy',
  ...
  projectBrowserUiReleases: (id: string) => `/api/projects/${encodeURIComponent(id)}/application-releases/browser-ui`,
  projectBrowserUiReleaseActions: (id: string) => `/api/projects/${encodeURIComponent(id)}/application-releases/browser-ui/actions`,
