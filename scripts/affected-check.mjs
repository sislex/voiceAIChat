...
export const PACKAGES = [
  ...
  { id: 'tts-runner', path: 'apps/tts-runner', workspace: '@voicechat/tts-runner', dependsOn: ['component-runtime', 'shared'] },
  { id: 'stt-runner', path: 'apps/stt-runner', workspace: '@voicechat/stt-runner', dependsOn: ['component-runtime', 'shared'] },
  ...
  { id: 'web-reader-service', path: 'apps/web-reader', workspace: '@voicechat/web-reader', dependsOn: ['shared', 'browser-contracts', 'playwright-reader-contracts', 'web-reader-contracts', 'web-recorder', 'component-runtime'] },
